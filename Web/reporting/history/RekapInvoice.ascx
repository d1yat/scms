<%@ Control Language="C#" AutoEventWireup="true" CodeFile="RekapInvoice.ascx.cs" Inherits="reporting_history_RekapInvoice" %>
    ...
    <ext:FormPanel ID="frmReportKriteria" runat="server" Padding="5" Frame="True" 
      ...
      <Items>
        <ext:RadioGroup ID="rdgTipeReport" runat="server" ColumnsNumber="1" FieldLabel="Tipe Laporan">
          <Items>
            <ext:Radio ID="rdgInternal" runat="server" BoxLabel="Internal" Checked="true" InputValue="01" />
            <ext:Radio ID="rdgEksternal" runat="server" BoxLabel="Eksternal" InputValue="02" />
          </Items>
        </ext:RadioGroup>
        ...
        <ext:CompositeField ID="CompositeField1" runat="server" FieldLabel="No. IE">
          <Items>
