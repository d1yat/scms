<%@ Control Language="C#" AutoEventWireup="true" CodeFile="BlockItem.ascx.cs" Inherits="reporting_history_BlockItem" %>
  ...
  <Items>
    ...
    <ext:FormPanel ID="frmReportKriteria" runat="server" Padding="5" Frame="True" Layout="Form">
      <Items>
        ...
        <ext:RadioGroup ID="rdgStatusReport" runat="server" ColumnsNumber="1" FieldLabel="Tipe Laporan">
          <Items>
            <ext:Radio ID="rdSRAktif" runat="server" BoxLabel="Aktif" Tag="Aktif" />
            <ext:Radio ID="rdSRNonAktif" runat="server" BoxLabel="Non-Aktif" Checked="true" Tag="Non" />
          </Items>
        </ext:RadioGroup>
        <ext:SelectBox ID="cbRptTypeOutput" runat="server" FieldLabel="Outpust" SelectedIndex="1"
          AllowBlank="false">
          <Items>
