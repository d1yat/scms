<%@ Control Language="C#" AutoEventWireup="true" CodeFile="POTransaksi.ascx.cs" Inherits="reporting_history_POTransaksi" %>
    ...
    <ext:FormPanel ID="frmReportKriteria" runat="server" Padding="5" Frame="True" Layout="Form">
      <Items>
        ...
        <ext:CompositeField runat="server" FieldLabel="Batasan PO">
          <Items>
            <ext:TextField ID="txPO1" runat="server" AllowBlank="true" />
            <ext:Label runat="server" Text="-" />
            <ext:TextField ID="txPO2" runat="server" AllowBlank="true" />
          </Items>
        </ext:CompositeField>
        ...
        <ext:Checkbox ID="chkPhar" runat="server" FieldLabel="Pharmanet" Checked="false" />
