<%@ Control Language="C#" AutoEventWireup="true" CodeFile="SuratPesananGudang.ascx.cs"
  Inherits="reporting_history_SuratPesananGudang" %>
  ...
  <Items>
    ...
    <ext:FormPanel ID="frmReportKriteria" runat="server" Padding="5" Frame="True" Layout="Form">
      <Items>
        ...
        <ext:CompositeField runat="server" FieldLabel="Batasan SPG">
          <Items>
            <ext:TextField ID="txSPG1" runat="server" AllowBlank="true" />
            <ext:Label runat="server" Text="-" />
            <ext:TextField ID="txSPG2" runat="server" AllowBlank="true" />
          </Items>
        </ext:CompositeField>
        ...
        <ext:ComboBox ID="cbSuplier" runat="server" FieldLabel="Pemasok" ValueField="c_nosup"
          DisplayField="v_nama" Width="400" ListWidth="400" PageSize="10"
        ...
        <ext:ComboBox ID="cbDivPrinsipal" runat="server" FieldLabel="Divisi Pemasok" ValueField="c_kddivpri"
          DisplayField="v_nmdivpri" Width="400" ListWidth="400" 
        ...
        <ext:ComboBox ID="cbItems" runat="server" FieldLabel="Produk" ValueField="c_iteno"
          DisplayField="v_itnam" Width="400" ListWidth="400" 
          PageSize="10" ItemSelector="tr.search-item" AllowBlank="true" ForceSelection="false">
          <CustomConfig>
            <ext:ConfigItem Name="allowBlank" Value="true" />
          </CustomConfig>
