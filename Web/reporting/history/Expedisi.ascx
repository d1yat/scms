<%@ Control Language="C#" AutoEventWireup="true" CodeFile="Expedisi.ascx.cs" Inherits="reporting_history_Expedisi" %>
    ...
    <ext:FormPanel ID="frmReportKriteria" runat="server" Padding="5" Frame="True" Layout="Form">
      <Items>
        ...
        <ext:ComboBox ID="cbCustomer" runat="server" DisplayField="v_cunam" ValueField="c_cusno"
          Width="500" ItemSelector="tr.search-item" PageSize="10" ListWidth="500" MinChars="3"
          FieldLabel="Cabang" AllowBlank="true">
          <CustomConfig>
            <ext:ConfigItem Name="allowBlank" Value="true" />
          </CustomConfig>
          <Store>
        ...
        <ext:CompositeField runat="server" FieldLabel="Batasan No. Resi">
          <Items>
            <ext:TextField ID="txResi1" runat="server" />
            <ext:Label runat="server" Text="-" />
            <ext:TextField ID="txResi2" runat="server" />
          </Items>
        </ext:CompositeField>
