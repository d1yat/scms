<%@ Control Language="C#" AutoEventWireup="true" CodeFile="Combo.ascx.cs" Inherits="reporting_history_Combo" %>
<ext:Panel runat="server">
  <Items>
    ...
    <ext:FormPanel ID="frmReportKriteria" runat="server" Padding="5" Frame="True" Layout="Form">
      <Items>
        <ext:CompositeField runat="server" FieldLabel="Batasan Memo Combo">
          <Items>
            <ext:TextField ID="txMemoCombo1" runat="server" AllowBlank="false" />
            <ext:Label runat="server" Text="-" />
            <ext:TextField ID="txMemoCombo2" runat="server" AllowBlank="false" />
          </Items>
        </ext:CompositeField>
          ...
          <Store>
            <ext:Store runat="server">
              ...
              <BaseParams>
                ...
                <ext:Parameter Name="parameters" Value="[['l_combo = @0', true, 'System.Boolean'],
        ...
        <ext:TextField ID="txMemoNo" runat="server" FieldLabel="No. Memo" />
