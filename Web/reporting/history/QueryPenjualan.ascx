<%@ Control Language="C#" AutoEventWireup="true" CodeFile="QueryPenjualan.ascx.cs"
  Inherits="reporting_history_QueryPenjualan" %>
  
  
  
  <script type="text/javascript">

    var validateRadio = function(rdHeaderJava, cbgTipeFilterJava, chkFltFJ1, chkFltFJPri2, chkFltFJAms3) {
...
<ext:Panel runat="server">
  <Items>
    ...
    <ext:FormPanel ID="frmReportQueryPenjualan" runat="server" Padding="5" Frame="True"
      Layout="Form">
      <Items>
       ...
       <%-- ------%>
         ...
         <ext:RadioGroup ID="rdgView" runat="server" ColumnsNumber="1" FieldLabel="View">
          ...
          <Listeners>
               ...
               <Change Handler="validateRadio(#{rdHeader}.getValue(), #{cbgTipeFilter}, #{chkFltFJ}, #{chkFltFJPri}, #{chkFltFJAms});" />
        ...
        <ext:RadioGroup ID="cbgTipeFilter" runat="server" ColumnsNumber="1" FieldLabel="Filter">
          <Items>
            <ext:Radio ID="chkFltFJ" runat="server" BoxLabel="Nomor Faktur Jual" Checked="true" Tag="FilFJ" />
            <ext:Radio ID="chkFltFJPri" runat="server" BoxLabel="Custommer" Checked="false" Tag="FilFJPri" />
            <ext:Radio ID="chkFltFJAms" runat="server" BoxLabel="Divisi Ams" Checked="false" Tag="FilFJAms" />
          </Items>
        </ext:RadioGroup>
        ...
        <ext:RadioGroup ID="cbgTipeReport" runat="server" ColumnsNumber="1" FieldLabel="Tipe Report">
          <Items>
            <ext:Radio ID="chkJual" runat="server" BoxLabel="Penjualan" Checked="true" Tag="tipeJual" />
            <ext:Radio ID="chkRetur" runat="server" BoxLabel="Retur Penjualan" Checked="false"
              Tag="tipeRetur" />
          </Items>
        </ext:RadioGroup>
  ...
  <Buttons>
    <ext:Button runat="server" Icon="ReportGo" Text="Generate">
      <DirectEvents>
        <Click OnEvent="Report_OnGenerate" Before="return isValidForm(#{frmReportQueryPenjualan});">
    ...
    <ext:Button runat="server" Icon="Reload" Text="Bersihkan">
      <Listeners>
        <Click Handler="initializePanel(#{frmReportQueryPenjualan}, #{chkAsync}, #{txPeriode1}, #{txPeriode2});" />
      </Listeners>
    </ext:Button>
  </Buttons>
  <Listeners>
    <AfterRender Handler="initializePanel(#{frmReportQueryPenjualan}, #{chkAsync}, #{txPeriode1}, #{txPeriode2});" />
  </Listeners>
</ext:Panel>
