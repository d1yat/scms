<%@ Control Language="C#" AutoEventWireup="true" CodeFile="QueryClaim.ascx.cs" Inherits="reporting_history_QueryClaim" %>
<ext:Panel runat="server">
  <Items>
    <ext:Hidden ID="hidWndDown" runat="server" />
    <ext:FormPanel ID="frmReportQueryClaim" runat="server" Padding="5" Frame="True" Layout="Form">
      <Items>
        ...
        <ext:SelectBox ID="cbTipeReport" runat="server" FieldLabel="Output" SelectedIndex="0"
          AllowBlank="false">
          <Items>
            <ext:ListItem Value="itm" Text="Per Produk" />
            <ext:ListItem Value="sup" Text="Per Pemasok" />
            <ext:ListItem Value="div" Text="Per Divisi AMS" />
          </Items>
        </ext:SelectBox>
  ...
  <Buttons>
    <ext:Button runat="server" Icon="ReportGo" Text="Generate">
      <DirectEvents>
        <Click OnEvent="Report_OnGenerate" Before="return isValidForm(#{frmReportQueryClaim});">
    ...
    <ext:Button runat="server" Icon="Reload" Text="Bersihkan">
      <Listeners>
        <Click Handler="initializePanel(#{frmReportQueryClaim}, #{chkAsync}, #{txPeriode1}, #{txPeriode2});" />
      </Listeners>
    </ext:Button>
  </Buttons>
  <Listeners>
    <AfterRender Handler="initializePanel(#{frmReportQueryClaim}, #{chkAsync}, #{txPeriode1}, #{txPeriode2});" />
  </Listeners>
</ext:Panel>
