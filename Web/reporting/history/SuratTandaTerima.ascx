<%@ Control Language="C#" AutoEventWireup="true" CodeFile="SuratTandaTerima.ascx.cs"
  Inherits="reporting_history_SuratTandaTerima" %>
<ext:Panel runat="server">
  <Items>
    ...
    <ext:FormPanel ID="frmReportKriteria" runat="server" Padding="5" Frame="True" 
      Layout="Form">
      <Items>
        <ext:CompositeField runat="server" FieldLabel="Batasan Memo STT">
          <Items>
            <ext:TextField ID="txMemoSTT1" runat="server" AllowBlank="false" />
            <ext:Label runat="server" Text="-" />
            <ext:TextField ID="txMemoSTT2" runat="server" AllowBlank="false" />
          </Items>
        </ext:CompositeField>
