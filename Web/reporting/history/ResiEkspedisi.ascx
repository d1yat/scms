<%@ Control Language="C#" AutoEventWireup="true" CodeFile="ResiEkspedisi.ascx.cs" Inherits="reporting_history_ResiEkspedisi" %>
  ...
  <Items>
    ...
    <ext:FormPanel ID="frmReportKriteria" runat="server" Padding="5" Frame="True" 
      ...
      <Items>
        ...
        <ext:CompositeField ID="CompositeField1" runat="server" FieldLabel="No. DO">
          <Items>
