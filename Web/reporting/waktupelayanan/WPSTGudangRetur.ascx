<%@ Control Language="C#" AutoEventWireup="true" CodeFile="WPSTGudangRetur.ascx.cs" Inherits="reporting_waktupelayanan_WPSTGudangRetur" %>
    ...
    <ext:FormPanel ID="frmReportKriteria" runat="server" Padding="5" Frame="True" 
      ...
      <Items>
        ...
        <ext:SelectBox ID="cbTipeTransaksi" runat="server" AllowBlank="false" SelectedIndex="0"
          Width="250">
          <Items>
            <ext:ListItem Text="PBB/PBR" Value="PBBR" />
            <ext:ListItem Text="KPR" Value="CPR" />
            <ext:ListItem Text="BASPB" Value="BASPB" />
          </Items>
        </ext:SelectBox>
