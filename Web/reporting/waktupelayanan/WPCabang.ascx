<%@ Control Language="C#" AutoEventWireup="true" CodeFile="WPCabang.ascx.cs" Inherits="reporting_konsolidasi_WPCabang" %>
  ...
  <Items>
    ...
    <ext:FormPanel ID="frmReportKriteria" runat="server" Padding="5" Frame="True" 
      ...
      <Items>
        ...
        <ext:ComboBox ID="cbCustomer2" runat="server" DisplayField="v_cunam" ValueField="c_cusno"
          Width="500" ItemSelector="tr.search-item" PageSize="10" ListWidth="500" MinChars="3"
          FieldLabel="Cabang">
          <CustomConfig>
            <ext:ConfigItem Name="allowBlank" Value="true" />
          ...
          <Store>
            <ext:Store runat="server">
              ...
              <BaseParams>
                ...
                <ext:Parameter Name="limit" Value="={10}" /> 
                <ext:Parameter Name="model" Value="2011" />
                <ext:Parameter Name="parameters" Value="[['@contains.c_cusno.Contains(@0) || @contains.v_cunam.Contains(@0)', paramTextGetter(#{cbCustomer}), ''],
                  ['l_cabang == @0', true, 'System.Boolean']]" Mode="Raw" />
                <ext:Parameter Name="sort" Value="v_cunam" />
                <ext:Parameter Name="dir" Value="ASC" />
              </BaseParams>
              <Reader>
        ...
        <ext:SelectBox ID="cbTipeTransaksi" runat="server" AllowBlank="false" SelectedIndex="0"
          ...
          <Items>
            ...
            <ext:ListItem Text="Expedisi vs RN Cabang" Value="15" />
            <ext:ListItem Text="DO Principal  vs Antrian Terima DO di AMS" Value="16" />
          </Items>
        </ext:SelectBox>
        <ext:SelectBox ID="cbTipeTransaksiSup" runat="server" AllowBlank="false" SelectedIndex="0"
          Width="250">
          <Items>
            <ext:ListItem Text="Surat Pesanan vs Packing List Confirm" Value="02" />
            <ext:ListItem Text="Packing List vs Delivery Order" Value="06" />
