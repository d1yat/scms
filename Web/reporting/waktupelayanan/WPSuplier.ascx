<%@ Control Language="C#" AutoEventWireup="true" CodeFile="WPSuplier.ascx.cs" Inherits="reporting_konsolidasi_WPSuplier" %>
    ...
    <ext:FormPanel ID="frmReportKriteria" runat="server" Padding="5" Frame="True" 
      ...
      <Items>
        ...
        <ext:ComboBox ID="cbGudang" runat="server" FieldLabel="Gudang" ValueField="c_gdg"
          DisplayField="v_gdgdesc" Width="175" AllowBlank="true" ForceSelection="false">
          <CustomConfig>
        ...
        <%--<ext:SelectBox ID="cbTipeTransaksi" runat="server" AllowBlank="false" SelectedIndex="0"
          Width="250">
          <Items>
            <ext:ListItem Text="Purchase Order vs Receive Note" Value="01" />
            <ext:ListItem Text="Retur Suplier vs Receive Note Retur Suplier" Value="02" />
            <ext:ListItem Text="Surat Pesanan vs Purchase Order" Value="03" />
            <ext:ListItem Text="Surat Pesanan vs Delivery Order Pharos" Value="04" />
          </Items>
        </ext:SelectBox>--%>
        <ext:RadioGroup ID="rbgTipeTransaksi" runat="server" ColumnsNumber="1" FieldLabel="Tipe Transaksi" AllowBlank="false">
          <Items>
            <ext:Radio ID="rdTTPO_RN" runat="server" BoxLabel="Purchase Order vs Receive Note" Tag="01" Checked="true" />
            <ext:Radio ID="rdTTRS_RNRS" runat="server" BoxLabel="Retur Suplier vs Receive Note Retur Suplier" Tag="01" />
            <ext:Radio ID="rdTTSP_PO" runat="server" BoxLabel="Surat Pesanan vs Purchase Order" Tag="01" />
            <ext:Radio ID="rdTTSP_DOP" runat="server" BoxLabel="Surat Pesanan vs Delivery Order Pharos" Tag="01" />
          </Items>
        </ext:RadioGroup>
          ...
          <Store>
            <ext:Store runat="server">
              ...
              <BaseParams>
                ...
                <ext:Parameter Name="parameters" Value="[['c_nosup = @0', paramValueGetter(#{cbSuplier}), 'System.String']]" Mode="Raw" />
        ...
        <ext:ComboBox ID="cbItem" runat="server" FieldLabel="Produk" ValueField="c_iteno"
            ...
            <ext:Store runat="server">
              ...
              <BaseParams>
                ...
                <ext:Parameter Name="parameters" Value="[['c_nosup = @0', paramValueGetter(#{cbSuplier}), 'System.String'],
                  ['c_kddivpri = @0', paramValueGetter(#{cbDivPrinsipal}), 'System.String']]" Mode="Raw" />
        ...
        <ext:RadioGroup ID="rbgTipeReport" runat="server" ColumnsNumber="1" FieldLabel="Tipe Laporan" AllowBlank="false">
          <Items>
            ...
            <ext:Radio ID="rbgTRSDP" runat="server" BoxLabel="Summary Divisi Principal" Tag="02" />
            <ext:Radio ID="rbgTRSC" runat="server" BoxLabel="Summary Cabang" Tag="03" />
          </Items>
        </ext:RadioGroup>
