<%@ Control Language="C#" AutoEventWireup="true" CodeFile="WPSerahTerima.ascx.cs" Inherits="reporting_waktupelayanan_WPSerahTerima" %>
    ...
    <ext:FormPanel ID="frmReportKriteria" runat="server" Padding="5" Frame="True" 
      ...
      <Items>
        ...
        <ext:SelectBox ID="cbTipeTransaksi" runat="server" AllowBlank="false" SelectedIndex="0"
          Width="250">
          <Items>
            <ext:ListItem Text="PPIC" Value="01" />
            <ext:ListItem Text="Picker" Value="02" />
            <ext:ListItem Text="Inkjet" Value="IJ" />
            ...
            <ext:ListItem Text="Full" Value="06" />
          </Items>
        </ext:SelectBox>
