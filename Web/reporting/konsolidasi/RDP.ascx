<%@ Control Language="C#" AutoEventWireup="true" CodeFile="RDP.ascx.cs" Inherits="reporting_konsolidasi_RDP" %>
    ...
    <ext:FormPanel ID="frmReportKriteria" runat="server" Padding="5" Frame="True" 
      ...
      <Items>
        ...
        <ext:ComboBox ID="cbCustomer" runat="server" DisplayField="v_cunam" ValueField="c_cusno"
          Width="500" ItemSelector="tr.search-item" PageSize="10" ListWidth="500" MinChars="3"
          FieldLabel="Cabang" ForceSelection="false">
          <CustomConfig>
            <ext:ConfigItem Name="allowBlank" Value="true" />
          </CustomConfig>
          <Store>
        ...
        <ext:RadioGroup ID="rbgTipeReport" runat="server" ColumnsNumber="1" FieldLabel="Tipe Laporan" AllowBlank="false">
          <Items>
            <ext:Radio ID="rbgTRRDP" runat="server" BoxLabel="R D P" Checked="true" Tag="01" />
            <ext:Radio ID="rbgTRRRDP" runat="server" BoxLabel="Ril R D P" Tag="02" />
            <ext:Radio ID="rbgTRPLL" runat="server" BoxLabel="Penerimaan Lain-lain" Tag="03" />
            <ext:Radio ID="rbgTRSELI" runat="server" BoxLabel="Selisih" Tag="04" />
            <ext:Radio ID="rbgTRRSC" runat="server" BoxLabel="RS Cabang" Tag="05" />
            <ext:Radio ID="rbgTRRSCS" runat="server" BoxLabel="RS Cabang Selisih Quantity" Tag="06" />
            <ext:Radio ID="rbgTRPEND" runat="server" BoxLabel="Pending" Tag="07" />
          </Items>
        </ext:RadioGroup>
