...
public partial class reporting_financial_ARFakturPending : System.Web.UI.UserControl
{
  ...
  protected void Report_OnGenerate(object sender, DirectEventArgs e)
  {
    ...
    {
      DataType = typeof(string).FullName,
      ParameterName = "Temp_LGJual6.c_user",
      ParameterValue = pag.Nip
    });
    ...
    if (!string.IsNullOrEmpty(Cus))
    {
      ...
      {
        DataType = typeof(string).FullName,
        ParameterName = "Temp_LGJual6.c_cusno",
        ParameterValue = Cus
      });
    }
    ...
    {
      DataType = typeof(string).FullName,
      ParameterName = "Temp_LGJual6.c_typeF",
    ...
    else
    {
      if (rptResult.IsSuccess)
      {
        ...
        {
          string rptName = string.Concat("AR_Faktur_pending_", pag.Nip, ".", rptResult.Extension);
