...
public partial class reporting_financial_BeaKirim : System.Web.UI.UserControl
{
  ...
  protected void Report_OnGenerate(object sender, DirectEventArgs e)
  {
    ...
    if (tmp.Equals("det"))
    {
      rptParse.ReportingID = "20406-1";
    }
    else if (tmp.Equals("sum"))
    {
      rptParse.ReportingID = "20406-2";
    }
    else if (tmp.Equals("srt"))
    {
      rptParse.ReportingID = "20406-3";
    }
      ...
      if (rptResult.IsSuccess)
      {
        ...
        else
        {
          ...
          string tmpUri = Functional.UriDownloadGenerator(pag,
            rptResult.OutputFile, "Financial_BEA_Kirim_", rptResult.Extension);
