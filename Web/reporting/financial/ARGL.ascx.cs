...
public partial class reporting_financial_ARGL : System.Web.UI.UserControl
{
  ...
  protected void Report_OnGenerate(object sender, DirectEventArgs e)
  {
    ...
    {
      DataType = typeof(string).FullName,
      ParameterName = "TEMP_LGJual1.c_user",
      ParameterValue = pag.Nip
    });
    ...
    {
      DataType = typeof(string).FullName,
      ParameterName = "TEMP_LGJual1.c_typeF",
      ParameterValue = rdgTipeFak.CheckedItems[0].Flex.ToString("00")
    });
    ...
    else
    {
      if (rptResult.IsSuccess)
      {
        ...
        {
          string rptName = string.Concat("AR_GL_", pag.Nip, ".", rptResult.Extension);
