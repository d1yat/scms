<%@ Control Language="C#" AutoEventWireup="true" CodeFile="BeaKirim.ascx.cs" Inherits="reporting_financial_BeaKirim" %>
<ext:Panel runat="server">
  <Items>
    <ext:Hidden ID="hidWndDown" runat="server" />
    <ext:FormPanel ID="frmReportBeaKirim" runat="server" Padding="5" Frame="True" Layout="Form">
      <Items>
        ...
        <ext:RadioGroup ID="rdgTipe" runat="server" ColumnsNumber="1" FieldLabel="Tipe Laporan"
          ...
          <Items>
            ...
            <ext:Radio ID="rdSum" runat="server" BoxLabel="Per Faktur" InputValue="sum" />
            <ext:Radio ID="rdSrt" runat="server" BoxLabel="Summary" InputValue="srt" />
          </Items>
        </ext:RadioGroup>
          ...
          <Store>
            <ext:Store ID="Store3" runat="server">
              ...
              <BaseParams>
                ...
                <ext:Parameter Name="parameters" Value="[['l_import == @0', true, 'System.Boolean'],
  ...
  <Buttons>
    <ext:Button runat="server" Icon="ReportGo" Text="Generate">
      <DirectEvents>
        <Click OnEvent="Report_OnGenerate" Before="return isValidForm(#{frmReportBeaKirim});">
    ...
    <ext:Button runat="server" Icon="Reload" Text="Bersihkan">
      <Listeners>
        <Click Handler="initializePanel(#{frmReportBeaKirim}, #{chkAsync}, #{txPeriode1}, #{txPeriode2});" />
      </Listeners>
    </ext:Button>
  </Buttons>
  <Listeners>
    <AfterRender Handler="initializePanel(#{frmReportBeaKirim}, #{chkAsync}, #{txPeriode1}, #{txPeriode2});" />
  </Listeners>
</ext:Panel>
