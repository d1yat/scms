...
public partial class reporting_financial_APListBayar : System.Web.UI.UserControl
{
  ...
  protected void Report_OnGenerate(object sender, DirectEventArgs e)
  {
    ...
    if (tmp.Equals("rdA"))
    {
      rptParse.ReportingID = "20401-4-1";
      mode = "rdA";
    }
    else if(tmp.Equals("rdB"))
    {
      rptParse.ReportingID = "20401-4-2";
      mode = "rdB";
    }
      ...
      case "rdA":
        {
          ...
          {
            DataType = typeof(string).FullName,
            ParameterName = "Temp_LGBeli8.c_user",
            ParameterValue = pag.Nip
          });
        }
        break;
      case "rdB":
        {
          ...
          {
            DataType = typeof(string).FullName,
            ParameterName = "Temp_LGBeli7.c_user",
            ParameterValue = pag.Nip
          });
        }
        break;
    ...
    else
    {
      if (rptResult.IsSuccess)
      {
        ...
        {
          string rptName = string.Concat("AP_List_Bayar_", pag.Nip, ".", rptResult.Extension);
