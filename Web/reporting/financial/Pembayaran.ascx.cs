...
public partial class reporting_financial_Pembayaran : System.Web.UI.UserControl
{
  ...
  protected void Report_OnGenerate(object sender, DirectEventArgs e)
  {
    ...
    //if (txFB1.Text.Length > 0)
    //{
    //  if (txFB2.Text.Length > 0)
    //  {
    //    lstRptParam.Add(new ReportParameter()
    //    {
    ...
    else
    {
      if (rptResult.IsSuccess)
      {
        ...
        {
          string rptName = string.Concat("Financial_Pembayaran_", pag.Nip, ".", rptResult.Extension);
