...
public partial class reporting_Inventory_IndekStock : System.Web.UI.UserControl
{
  ...
  protected void Report_OnGenerate(object sender, DirectEventArgs e)
  {
    ...
    lstRptParam.Add(new ReportParameter()
    {
      ...
      ParameterName = "tahun",
      IsSqlParameter = true,
      ParameterValue = (cbPeriode1.SelectedItem == null ? "????" : cbPeriode1.SelectedItem.Value)
    });
    ...
    lstRptParam.Add(new ReportParameter()
    {
      ...
      ParameterName = "bulan",
      IsSqlParameter = true,
      ParameterValue = (cbPeriode2.SelectedItem == null ? "??" : cbPeriode2.SelectedItem.Value)
    });
    ...
    lstRptParam.Add(new ReportParameter()
    {
      ...
      ParameterName = "type",
      IsSqlParameter = true,
      ParameterValue = cbType.SelectedItem.Value.ToString()
    });
    ...
    {
      DataType = typeof(string).FullName,
      ParameterName = "Temp_LGIndexStock.c_user",
      ParameterValue = pag.Nip
    });
    ...
    {
      DataType = typeof(string).FullName,
      ParameterName = "Temp_LGIndexStock.c_gdg",
    ...
    if (!string.IsNullOrEmpty(cbItems.SelectedItem.Value))
    {
      ...
      {
        DataType = typeof(string).FullName,
        ParameterName = "Temp_LGIndexStock.c_iteno",
    ...
    //  {
    //    DataType = typeof(string).FullName,
    //    ParameterName = string.Format("({{Temp_LGIndexStock.c_iteno}} IN [{0}])", string.Join(",", lstData.ToArray())),
    //    IsReportDirectValue = true
    //  });
    ...
    else
    {
      if (rptResult.IsSuccess)
      {
        ...
        {
          string rptName = string.Concat("Report_IndexStock_", pag.Nip, ".", rptResult.Extension);
