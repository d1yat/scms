<%@ Control Language="C#" AutoEventWireup="true" CodeFile="MonitoringExpiredCtrl.ascx.cs"
  Inherits="reporting_Inventory_MonitoringEDCtrl" %>
            ...
            <ext:FormPanel ID="frmpnlDetailEntry" runat="server" Frame="True" Border="false"
              ...
              <%--Pemasok--%>  
                ...
                <%--Type Stock--%>
                 ...
                 <ext:SelectBox ID="SelectBoxTipeStock" runat="server" FieldLabel="Type Stock" SelectedIndex="0" AllowBlank="false">
                  <Items>  
            ...
            <ext:Panel ID="Panel2" runat="server" Layout="FitLayout">
              ...
              <ext:Store ID="storeGridItem" runat="server" RemoteSort="true" SkinID="OriginalExtStore">
                ...
                <BaseParams>
                  ...
                  <ext:Parameter Name="model" Value="10011-x" />
                  ...
                  <ext:JsonReader TotalProperty="d.totalRows" Root="d.records" SuccessProperty="d.success"
                    ...
                    <Fields>
                      ...
                      <ext:RecordField Name="v_itnam" />
                       ...
                       <ext:RecordField Name="n_salpri" />
                       <ext:RecordField Name="n_gsisa" />
                       <ext:RecordField Name="valueGood" />   
                       <ext:RecordField Name="n_bsisa" /> 
                       <ext:RecordField Name="valueBad" /> 
            ...
            <ColumnModel>
              <Columns>
                ...
                <ext:Column ColumnID="v_nama" DataIndex="v_nama" Header="Nama Supplier" Width="150" />
                 ...
                 <ext:Column ColumnID="c_batch" DataIndex="c_batch" Header="Nomor Batch" Width="100" />
                 <ext:Column ColumnID="d_expired" DataIndex="d_expired" Header="Tgl Expired" Width="100" />
                 <ext:Column ColumnID="n_salpri" DataIndex="n_salpri" Header="Harga" Width="100" />
                 <ext:Column ColumnID="n_gsisa" DataIndex="n_gsisa" Header="Soh Good" Width="100" />
                 <ext:Column ColumnID="valueGood" DataIndex="valueGood" Header="Good Value" Width="100" />
                 <ext:Column ColumnID="n_bsisa" DataIndex="n_bsisa" Header="Soh Bad" Width="100" />
                 <ext:Column ColumnID="valueBad" DataIndex="valueBad" Header="Bad value" Width="100" />
                    ...
                    <ext:Toolbar ID="Toolbar2" runat="server">
                        <Items>                           
                          ...
                          <%--Catak--%>
                              ...
                              <ext:button id="Button7" runat="server" icon="printer" text="cetak">
                                  <directevents>
                          ...
                          <%--Segarkan--%>
                                ...
                                <ext:Button ID="Button2" runat="server" Text="Segarkan" Icon="ArrowRefresh">
                                <Listeners>
