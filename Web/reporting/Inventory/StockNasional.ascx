<%@ Control Language="C#" AutoEventWireup="true" CodeFile="StockNasional.ascx.cs"
  Inherits="reporting_Inventory_StockNasional" %>
<ext:Panel ID="Panel1" runat="server">
  <Items>
    <ext:Hidden ID="hidWndDown" runat="server" />
    <ext:FormPanel ID="frmStokNasional" runat="server" Padding="5" Frame="True" Layout="Form">
      <Items>
        ...
        <ext:ComboBox ID="cbDivAms" runat="server" FieldLabel="Divisi Ams" ValueField="c_kddivams"
            ...
            <ext:ComboBox ID="cbDivPrincipal" runat="server" FieldLabel="Divisi Pemasok" ValueField="c_kddivpri"
                ...
                <ext:Store ID="Store4" runat="server">
                  ...
                  <BaseParams>
                    ...
                    <ext:Parameter Name="parameters" Value="[['@in.c_nosup', paramValueMultiGetter(#{cbSuplier}), 'System.String[]'],
                      ['@contains.c_kddivpri.Contains(@0) || @contains.v_nmdivpri.Contains(@0)', paramTextGetter(#{cbDivPrincipal}), '']]" Mode="Raw" />
                ...
                <ext:Store ID="Store5" runat="server">
                  ...
                  <BaseParams>
                    ...
                    <ext:Parameter Name="parameters" Value="[['@in.c_kddivams', paramValueMultiGetter(#{cbDivAms}), 'System.String[]'],
                      ...
                      ['@in.c_kddivpri', paramValueMultiGetter(#{cbDivPrincipal}), 'System.String[]'],
        ...
        <ext:RadioGroup ID="rdgTipe" runat="server" ColumnsNumber="1" FieldLabel="Tipe Laporan">
          <Items>
            <ext:Radio ID="rdBatch" runat="server" BoxLabel="Batch" />
            <ext:Radio ID="rdTotal" runat="server" BoxLabel="Total" Checked="true" />
          </Items>
        </ext:RadioGroup>
  ...
  <Buttons>
    <ext:Button ID="Button1" runat="server" Icon="Report" Text="Generate">
      <DirectEvents>
        <Click OnEvent="Report_OnGenerate" Before="return isValidForm(#{frmStokNasional});">
    ...
    <ext:Button ID="Button2" runat="server" Icon="Reload" Text="Bersihkan">
      <Listeners>
        <Click Handler="initializePanel(#{frmStokNasional}, #{chkAsync}, #{txPeriode1}, #{txPeriode2});" />
      </Listeners>
    </ext:Button>
  </Buttons>
  <Listeners>
    <AfterRender Handler="initializePanel(#{frmStokNasional}, #{chkAsync}, #{txPeriode1}, #{txPeriode2});" />
  </Listeners>
</ext:Panel>
