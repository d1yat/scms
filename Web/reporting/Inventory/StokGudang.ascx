<%@ Control Language="C#" AutoEventWireup="true" CodeFile="StokGudang.ascx.cs" Inherits="reporting_Inventory_StokGudang" %>
<ext:Panel runat="server">
  <Items>
    <ext:Hidden ID="hidWndDown" runat="server" />
    <ext:FormPanel ID="frmStokGudang" runat="server" Padding="5" Frame="True" Layout="Form">
      <Items>
