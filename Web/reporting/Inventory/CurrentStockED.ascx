<%@ Control Language="C#" AutoEventWireup="true" CodeFile="CurrentStockED.ascx.cs"
  Inherits="reporting_Inventory_CurrentStockED" %>
<ext:Viewport ID="vwGudang" runat="server" Layout="Fit">
    ...
    <ext:Panel runat="server">
      ...
      <Buttons>
        ...
        <ext:Button runat="server" Icon="Reload" Text="Bersihkan">
          <Listeners>
            <Click Handler="initializePanel(#{frmKartuGudang}, #{chkAsync}, #{txPeriode1});" />
          </Listeners>
        </ext:Button>
      </Buttons>
    </ext:Panel>
  ...
  <Listeners>
    <AfterRender Handler="initializePanel(#{frmKartuGudang}, #{chkAsync}, #{txPeriode1});" />
  </Listeners>
</ext:Viewport>
