<%@ Control Language="C#" AutoEventWireup="true" CodeFile="SPPLDO.ascx.cs"
  Inherits="reporting_Inventory_SPPLDO" %>
        ...
        switch (comName) {
            case 'SoT':
                if ((!Ext.isEmpty(wndSoT)) && (!Ext.isEmpty(gridSoT))) {
                    hidSoT.setValue(itm);
                    wndSoT.setTitle(String.format('Pending Stok in Transit - {0}', rec.get('c_no')));
                    wndSoT.hide = false;
                    wndSoT.show();


                    switch (rec.get('MOVETYPE')) {
                        case 'PL':
                            gridSoT.colModel.setHidden(6, 1);
                            break;
                        case 'DO':
                            gridSoT.colModel.setHidden(6, 1);
                            break;
                        case 'SP':
                            gridSoT.colModel.setHidden(6, 0);
                            break;
                    }
    ...
    <ext:Panel ID="Panel1" runat="server">
      ...
      <Items>
        ...
        <ext:BorderLayout ID="bllayout" runat="server">
          <North MinHeight="50" MaxHeight="50" Collapsible="false">
            <ext:FormPanel ID="frmpnlDetailEntry" runat="server" Frame="True" Border="false"
              Padding="5" Height="50">
              <Items>
              <%--Posisi Stock--%>
                <ext:ComboBox ID="cbPosisiStok" runat="server" FieldLabel="Gudang" ValueField="c_gdg"
              ...
              <%--Pemasok--%>  
                <ext:ComboBox ID="cbSuplier" runat="server" FieldLabel="Pemasok" ValueField="c_nosup" Hidden="true"
                  ...
                  <Store>
                    <ext:Store ID="store1" runat="server" RemoteSort="true" SkinID="OriginalExtStore">
                      ...
                      <BaseParams>
                        ...
                        <ext:Parameter Name="model" Value="100060-a" />
                        <ext:Parameter Name="parameters" Value="[['gdgStok', paramValueGetter(#{cbPosisiStok}, '0') , 'System.Char'],
                          ...
                          ['cab', paramValueMultiGetter(#{txcabangfilter}) , 'System.String[]'],
                  ...
                  <ColumnModel>
                    <Columns>
                     <ext:CommandColumn Width="25" Resizable="false">
                      ...
                      <ext:Column ColumnID="Movetype" DataIndex="MOVETYPE" Header="MoveMent Type" Width="85" Sortable="false" />
                      <ext:Column ColumnID="PIC" DataIndex="PIC" Header="PIC" Width="100" Sortable="false" />
                      <ext:Column ColumnID="c_no" DataIndex="c_no" Header="No Transaksi" Width="150" Sortable="false" >
                        <Commands>
                          <ext:ImageCommand Icon="BookGo" CommandName="SoT" ToolTip-Text="Rincian item"
                            ToolTip-Title="Command" />
                        </Commands>
                      </ext:Column>
                      <ext:DateColumn ColumnID="d_date" DataIndex="d_date" Header="Tanggal Entry" Width="100" Sortable="false" Format="dd-MM-yyyy" />
                      <ext:DateColumn ColumnID="d_etdsp" DataIndex="d_etdsp" Header="ETD SP" Format="dd-MM-yyyy" Sortable="false" />
                      <ext:DateColumn ColumnID="d_etasp" DataIndex="d_etasp" Header="ETA SP" Format="dd-MM-yyyy" Sortable="false" />
                      <ext:Column ColumnID="c_cab_dcore" DataIndex="c_cab_dcore" Header="Cabang Pembuat / Tujuan" Width="100" Sortable="false" />
                      <ext:Column ColumnID="overdue" DataIndex="overdue" Header="OverDue" Width="80" Sortable="false" />
                      <ext:Column ColumnID="v_ket" DataIndex="v_ket" Header="Keterangan" Sortable="false" />
                    </Columns>
                  </ColumnModel>
                  <TopBar>
                  ...
                  <View>
                    <ext:GridView ID="gvFilter" runat="server" StandardHeaderRow="true">
                      ...
                      <ext:HeaderColumn />
                            ...
                            <ext:HeaderColumn>
                                <Component>
                                    <ext:TextField ID="txcabangfilter" runat="server" EnableKeyEvents="true" AllowBlank="true">
                                        <Listeners>
                                            <KeyUp Handler="reloadFilterGrid(#{gridMain})" Buffer="700" Delay="700" />
                                        </Listeners>
                                    </ext:TextField>
    ...
    <ext:GridPanel ID="gpDetailSoT" runat="server" Layout="Fit">
      ...
      <Store>
        <ext:Store ID="store10" runat="server" RemoteSort="true">
          ...
          <BaseParams>
            ...
            <ext:Parameter Name="model" Value="100060-b" />
          ...
          <Reader>
            <ext:JsonReader TotalProperty="d.totalRows" Root="d.records" SuccessProperty="d.success"
              ...
              <Fields>
                ...
                <ext:RecordField Name="ATP" Type="Float" />
              </Fields>
            </ext:JsonReader>
          </Reader>
      ...
      <ColumnModel>
        <Columns>
          ...
          <ext:Column DataIndex="c_no" Header="No Transaksi" Width="80" />
          <ext:DateColumn DataIndex="d_date" Header="Tanggal Entry" Width="80" Format="dd-MM-yyyy"  />
          <ext:Column DataIndex="c_iteno" Header="Kode Item" />
          <ext:Column DataIndex="v_itnam" Header="Nama Barang" />
          <ext:Column DataIndex="c_batch" Header="Batch" />
          <ext:NumberColumn DataIndex="n_qty" Header="Qty" Format="0.000,00/i" />
          <ext:NumberColumn DataIndex="ATP" Header="ATP" Format="0.000,00/i" />
        </Columns>
      </ColumnModel>
      <TopBar>
