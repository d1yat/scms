<%@ Control Language="C#" AutoEventWireup="true" CodeFile="KartuBarangNasional.ascx.cs"
  Inherits="reporting_Inventory_KartuBarangNasional" %>
<ext:Panel ID="Panel1" runat="server">
  <Items>
    <ext:Hidden ID="hidWndDown" runat="server" />
    <ext:FormPanel ID="frmKartuBarangNasional" runat="server" Padding="5" Frame="True"
      Layout="Form">
      <Items>
        ...
        <ext:ComboBox ID="cbDivAms" runat="server" FieldLabel="Divisi Ams" ValueField="c_kddivams"
          DisplayField="v_nmdivams" Width="500" ListWidth="500" WrapBySquareBrackets="true"
  ...
  <Buttons>
    <ext:Button ID="Button1" runat="server" Icon="Report" Text="Generate">
      <DirectEvents>
        <Click OnEvent="Report_OnGenerate" Before="return isValidForm(#{frmKartuBarangNasional});">
    ...
    <ext:Button ID="Button2" runat="server" Icon="Reload" Text="Bersihkan">
      <Listeners>
        <Click Handler="initializePanel(#{frmKartuBarangNasional}, #{chkAsync}, #{txPeriode1}, #{txPeriode2});" />
      </Listeners>
    </ext:Button>
  </Buttons>
  <Listeners>
    <AfterRender Handler="initializePanel(#{frmKartuBarangNasional}, #{chkAsync}, #{txPeriode1}, #{txPeriode2});" />
  </Listeners>
</ext:Panel>
