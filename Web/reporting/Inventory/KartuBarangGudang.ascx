<%@ Control Language="C#" AutoEventWireup="true" CodeFile="KartuBarangGudang.ascx.cs"
  Inherits="reporting_Inventory_KartuBarangGudang" %>
<ext:Viewport ID="vwGudang" runat="server" Layout="Fit">
  <Items>
    <ext:Panel runat="server">
      <Items>
        ...
        <ext:FormPanel ID="frmKartuGudang" runat="server" Padding="5" Frame="True"
          Layout="Form">
          <Items>
      ...
      <Buttons>
        <ext:Button runat="server" Icon="Report" Text="Generate">
          <DirectEvents>
            <Click OnEvent="Report_OnGenerate" Before="return isValidForm(#{frmKartuGudang});">
        ...
        <ext:Button runat="server" Icon="Reload" Text="Bersihkan">
          <Listeners>
            <Click Handler="initializePanel(#{frmKartuGudang}, #{chkAsync}, #{rdTotal}, #{txPeriode1}, #{txPeriode2});" />
          </Listeners>
        </ext:Button>
      </Buttons>
    </ext:Panel>
  ...
  <Listeners>
    <AfterRender Handler="initializePanel(#{frmKartuGudang}, #{chkAsync}, #{rdTotal}, #{txPeriode1}, #{txPeriode2});" />
  </Listeners>
</ext:Viewport>
