<%@ Control Language="C#" AutoEventWireup="true" CodeFile="StockIntegrity.ascx.cs" Inherits="reporting_Inventory_StockIntegrity" %>


<ext:Panel ID="Panel1" runat="server">
  <Items>
    <ext:Hidden ID="hidWndDown" runat="server" />
    <ext:FormPanel ID="frmStokOpname" runat="server" Padding="5" Frame="True" Layout="Form">
      <Items>
        ...
        <ext:RadioGroup ID="rdgTipe" runat="server" ColumnsNumber="1" FieldLabel="Tipe Laporan">
          <Items>
            <ext:Radio ID="rdDetail" runat="server" BoxLabel="Detail" />
        ...
        <%--<ext:Checkbox ID="rdBad" runat="server" FieldLabel="Bad" />--%>
        <%--<ext:RadioGroup ID="rdgTipe" runat="server" ColumnsNumber="1" FieldLabel="Tipe Laporan">
          <Items>
  ...
  <Buttons>
    <ext:Button runat="server" Icon="Report" Text="Generate">
      <DirectEvents>
        <Click OnEvent="Report_OnGenerate" Before="return isValidForm(#{frmStokOpname});">
    ...
    <ext:Button ID="Button1" runat="server" Icon="Reload" Text="Bersihkan">
      <Listeners>
        <Click Handler="initializePanel(#{frmStokOpname}, #{chkAsync}, #{txPeriode1}, #{txPeriode2});" />
      </Listeners>
    </ext:Button>
  </Buttons>
  <Listeners>
    <AfterRender Handler="initializePanel(#{frmStokOpname}, #{chkAsync}, #{txPeriode1}, #{txPeriode2});" />
  </Listeners>
</ext:Panel>
