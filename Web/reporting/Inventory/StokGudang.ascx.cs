...
public partial class reporting_Inventory_StokGudang : System.Web.UI.UserControl
{
  ...
  protected void Report_OnGenerate(object sender, DirectEventArgs e)
  {
    ...
    if (rdBatch.Checked)
    {
      rptParse.ReportingID = "10001-a";
    }
    else
    {
      rptParse.ReportingID = "10001-b";
    }
    ...
    else
    {
      if (rptResult.IsSuccess)
      {
        ...
        {
          string rptName = string.Concat("Inventory_StokGudang_", pag.Nip, ".", rptResult.Extension);
