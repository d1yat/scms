<%@ Control Language="C#" AutoEventWireup="true" CodeFile="SalesNasional.ascx.cs" Inherits="reporting_salesnasional" %>
...
<ext:Panel ID="Panel1" runat="server">
  <Items>
    ...
    <ext:FormPanel ID="frmReportKriteria" runat="server" Padding="5" Frame="True" 
      Layout="Form">
      <Items>
        <ext:CompositeField ID="cfPeriodeGrp" runat="server" FieldLabel="Periode">
          <Items>
