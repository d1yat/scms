<%@ Control Language="C#" AutoEventWireup="true" CodeFile="SendReturCustomer.ascx.cs" 
Inherits="reporting_monitoring_SendReturCustomer" %>

<ext:Panel ID="Panel1" runat="server">
  <Items>
    <ext:Hidden ID="hidWndDown" runat="server" />
    
    <ext:FormPanel ID="frmSendReturCustomer" runat="server" Padding="5" Frame="True" 
      Layout="Form">
      <Items>
        ...
        <ext:CompositeField runat="server" FieldLabel="Jarak RC">
          <Items>
            <ext:TextField ID="txNoRC1" runat="server" AllowBlank="true">
            </ext:TextField>
            <ext:Label ID="Label2" runat="server" Text="-" />
            <ext:TextField ID="txNoRC2" runat="server" AllowBlank="true">
            </ext:TextField>
          </Items>
        </ext:CompositeField>
  ...
  <Buttons>
    <ext:Button runat="server" Icon="ReportGo" Text="Generate">
      <DirectEvents>
        <Click OnEvent="Report_OnGenerate" Before="return isValidForm(#{frmSendReturCustomer});">
    ...
    <ext:Button runat="server" Icon="Reload" Text="Bersihkan">
      <Listeners>
        <Click Handler="initializePanel(#{frmSendReturCustomer}, #{chkAsync}, #{txPeriode1}, #{txPeriode2});" />
      </Listeners>
    </ext:Button>
  </Buttons>
  <Listeners>
    <AfterRender Handler="initializePanel(#{frmSendReturCustomer}, #{chkAsync}, #{txPeriode1}, #{txPeriode2});" />
  </Listeners>
</ext:Panel>
