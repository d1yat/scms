<%@ Control Language="C#" AutoEventWireup="true" CodeFile="MONITORINGPRODUKTIFITASDC.ascx.cs" Inherits="REPORTING_MONITORING_MONITORINGPRODUKTIFITASDC" %>
    ...
    <ext:FormPanel ID="frmReportKriteria" runat="server" Padding="5" Frame="True" 
      ...
      <Items>
        ...
        <ext:ComboBox ID="cbCustomer" runat="server" DisplayField="v_cunam" ValueField="c_cusno"
          ...
          --%>
        <%--Hafizh--%>
        <ext:SelectBox ID="cbTipeTransaksi" runat="server" FieldLabel="Devisis" AllowBlank="false" SelectedIndex="0"
          Width="250">
          <Items>
            <ext:ListItem Text="Picker" Value="02" />
            <ext:ListItem Text="Checker" Value="03" />
            <ext:ListItem Text="Packer" Value="04" />
            <ext:ListItem Text="Admin DO" Value="DO" />
            <ext:ListItem Text="Transportasi" Value="05" />
