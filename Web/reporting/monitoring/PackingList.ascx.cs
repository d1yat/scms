...
public partial class reporting_monitoring_PackingList : System.Web.UI.UserControl
{
  ...
  protected void Report_OnGenerate(object sender, DirectEventArgs e)
  {
    ...
    lstData = rdgTipePL.CheckedTags;

    if (lstData.Count > 0)
    {
      if (lstData.Contains("prn"))
      {
        lstRptParam.Add(new ReportParameter()
        {
          DataType = typeof(bool).FullName,
          ParameterName = "LG_PLH.l_print",
          ParameterValue = "True"
        });
      }
    ...
    else
    {
      if (rptResult.IsSuccess)
      {
        ...
        {
          string rptName = string.Concat("Monitoring_PackingList", pag.Nip, ".", rptResult.Extension);
