...
public partial class reporting_monitoring_PackingListConf : System.Web.UI.UserControl
{
  ...
  protected void Report_OnGenerate(object sender, DirectEventArgs e)
  {
    ...
    lstData = rdgTipeConf.CheckedTags;

    if (lstData.Count > 0)
    {
      if (lstData.Contains("cnf"))
      {
        lstRptParam.Add(new ReportParameter()
        {
          DataType = typeof(bool).FullName,
          ParameterName = "LG_PLH.l_confirm",
          ParameterValue = "True"
        });
      }
    ...
    else
    {
      if (rptResult.IsSuccess)
      {
        ...
        {
          string rptName = string.Concat("Monitoring_PackingList_Conf", pag.Nip, ".", rptResult.Extension);
