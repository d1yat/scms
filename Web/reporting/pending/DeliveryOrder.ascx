<%@ Control Language="C#" AutoEventWireup="true" CodeFile="DeliveryOrder.ascx.cs" Inherits="reporting_pending_DeliveryOrder" %>
  ...
  <Items>
    ...
    <ext:FormPanel ID="frmReportKriteria" runat="server" Padding="5" Frame="True" 
      ...
      <Items>
        ...
        <ext:CompositeField ID="CompositeField2" runat="server" FieldLabel="Batasan DO">
          <Items>
            <ext:TextField ID="txDO1" runat="server" />
            <ext:Label ID="Label2" runat="server" Text="-" />
            <ext:TextField ID="txDO2" runat="server" />
          </Items>
        </ext:CompositeField>
        <%--report type--%>
                    <ext:SelectBox ID="cbRptType" runat="server" FieldLabel="Output" SelectedIndex="0" AllowBlank="false">
                      <Items>
                        <ext:ListItem Value="All" Text="Select All" />
                        <ext:ListItem Value="Lunas" Text="Lunas" />
