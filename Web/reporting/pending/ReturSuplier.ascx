<%@ Control Language="C#" AutoEventWireup="true" CodeFile="ReturSuplier.ascx.cs" Inherits="reporting_pending_ReturSuplier" %>

<script type="text/javascript">
    var cekPilihan = function(rdsum, cbitems) {
        if (rdsum) {
...
<ext:Panel runat="server">
  <Items>
    ...
    <ext:FormPanel ID="frmReportKriteria" runat="server" Padding="5" Frame="True" 
      Layout="Form">
      <Items>
        <ext:RadioGroup ID="rdgRptType" runat="server" FieldLabel="Tipe Report" ColumnsNumber="1" AllowBlank="false">
            <Items>
                <ext:Radio ID="rdSum" runat="server" BoxLabel="Summary" Checked="true" />
                <ext:Radio ID="rdDet" runat="server" BoxLabel="Detail" />
            </Items>
            <Listeners>
                <Change Handler="cekPilihan(#{rdSum}.getValue(), #{cbItems});" />
            </Listeners>
        </ext:RadioGroup>
        ...
        <ext:CompositeField ID="CompositeField2" runat="server" FieldLabel="Batasan RS">
          <Items>
            <ext:TextField ID="txRS1" runat="server" />
            <ext:Label ID="Label2" runat="server" Text="-" />
            <ext:TextField ID="txRS2" runat="server" />
          </Items>
        </ext:CompositeField>
        ...
        <ext:SelectBox ID="cbReportType" runat="server" FieldLabel="Tipe Report" SelectedIndex="0"
          AllowBlank="false">
          <Items>
            <ext:ListItem Value="00" Text="Select All" />
            <ext:ListItem Value="01" Text="Lunas" />
            <ext:ListItem Value="02" Text="Pending" />
          </Items>
          </ext:SelectBox>
