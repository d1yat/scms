<%@ Control Language="C#" AutoEventWireup="true" CodeFile="Combo.ascx.cs" Inherits="reporting_pending_Combo" %>
  ...
  <Items>
    ...
    <ext:FormPanel ID="frmReportKriteria" runat="server" Padding="5" Frame="True" Layout="Form">
      <Items>
        ...
        <ext:SelectBox ID="cbComboType" runat="server" FieldLabel="Tipe Report" SelectedIndex="0"
          AllowBlank="false">
          <Items>
            <ext:ListItem Value="01" Text="Select All" />
            <ext:ListItem Value="02" Text="Conf" />
            <ext:ListItem Value="03" Text="UnConf" />
          </Items>
        </ext:SelectBox>
