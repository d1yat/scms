<%@ Control Language="C#" AutoEventWireup="true" CodeFile="PendingDOBelumRN.ascx.cs" Inherits="reporting_pending_PendingDOBelumRN" %>
            ...
            <Items>
                <ext:CompositeField ID="CompositeField2" runat="server" FieldLabel="Periode">
                  <Items>
                    ...
                    <ext:DateField ID="txPeriode2" runat="server" Vtype="daterange" Format="dd-MM-yyyy" AllowBlank="false">
                      <CustomConfig>
