<%@ Control Language="C#" AutoEventWireup="true" CodeFile="PurchaseOrderLogistik.ascx.cs" Inherits="reporting_pending_PurchaseOrderLogistik" %>
    ...
    <ext:FormPanel ID="frmReportKriteria" runat="server" Padding="5" Frame="True" 
      ...
      <Items>
        ...
        <ext:RadioGroup ID="rdgTipeReport" runat="server" ColumnsNumber="1" FieldLabel="Tipe Laporan" AllowBlank="false">
          <Items>
            <ext:Radio ID="rdDetail" runat="server" BoxLabel="Detail" InputValue="01"/>
            <ext:Radio ID="rdTotal" runat="server" BoxLabel="Total" InputValue="02" Checked="true" />
          </Items>
        </ext:RadioGroup>
