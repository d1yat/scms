<%@ Control Language="C#" AutoEventWireup="true" CodeFile="Enapzaold.ascx.cs" Inherits="reporting_history_Enapzaold" %>
  ...
  <Items>
    ...
    <ext:FormPanel ID="frmReportKriteria" runat="server" Padding="5" Frame="True" 
      ...
      <Items>
        ...
        <%--Indra 20170927 Penambahan parameter Item--%>
        ...
        <ext:RadioGroup ID="rdgTipeReport" runat="server" ColumnsNumber="1" FieldLabel="Tipe Laporan">
          <Items>
            ...
            <ext:Radio ID="rdgOOT" runat="server" BoxLabel="OOT" InputValue="03" /> <%--Indra 20170529--%>
          </Items>
        </ext:RadioGroup>
