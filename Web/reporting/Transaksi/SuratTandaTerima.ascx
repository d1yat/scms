<%@ Control Language="C#" AutoEventWireup="true" CodeFile="SuratTandaTerima.ascx.cs" 
Inherits="reporting_Transaksi_SuratTandaTerima" %>

<ext:Panel runat="server">
  <Items>
    <ext:Hidden ID="hidWndDown" runat="server" />
    
    <ext:FormPanel ID="frmReportSTT" runat="server" Padding="5" Frame="True" 
      Layout="Form">
      <Items>
        ...
        <ext:CompositeField runat="server" FieldLabel="Jarak STT">
          <Items>
            <ext:TextField ID="txSTT1" runat="server" AllowBlank="true" />
            <ext:Label ID="Label2" runat="server" Text="-" AllowBlank="true" />
            <ext:TextField ID="txSTT2" runat="server" />
          </Items>
        </ext:CompositeField>
        ...
        <ext:RadioGroup ID="rdgTipeReport" runat="server" ColumnsNumber="1" FieldLabel="Tipe">
          <Items>
            <ext:Radio ID="rdgTRAll" runat="server" BoxLabel="Semua" InputValue="01" Checked="true" />
            <ext:Radio ID="rdgTRDonasi" runat="server" BoxLabel="STT Donasi" InputValue="02" />
            <ext:Radio ID="rdgTRSample" runat="server" BoxLabel="STT Sample" InputValue="03" />
          </Items>
        </ext:RadioGroup>
  ...
  <Buttons>
    <ext:Button runat="server" Icon="ReportGo" Text="Generate">
      <DirectEvents>
        <Click OnEvent="Report_OnGenerate" Before="return isValidForm(#{frmReportSTT});">
    ...
    <ext:Button runat="server" Icon="Reload" Text="Bersihkan">
      <Listeners>
        <Click Handler="initializePanel(#{frmReportSTT}, #{chkAsync}, #{txPeriode1}, #{txPeriode2});" />
      </Listeners>
    </ext:Button>
  </Buttons>
  <Listeners>
    <AfterRender Handler="initializePanel(#{frmReportSTT}, #{chkAsync}, #{txPeriode1}, #{txPeriode2});" />
  </Listeners>
</ext:Panel>