<%@ Control Language="C#" AutoEventWireup="true" CodeFile="AdjustSuratPesanan.ascx.cs" 
Inherits="reporting_Transaksi_AdjustSuratPesanan" %>
...
<ext:Panel runat="server">
  ...
  <Buttons>
    ...
    <ext:Button runat="server" Icon="Reload" Text="Bersihkan">
      <Listeners>
        <Click Handler="initializePanel(#{frmReportSP}, #{chkAsync});" />
      </Listeners>
    </ext:Button>
  </Buttons>
  <Listeners>
    <AfterRender Handler="initializePanel(#{frmReportSP}, #{chkAsync});" />
  </Listeners>
</ext:Panel>
