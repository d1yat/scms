...
public partial class reporting_Transaksi_SPExpedisi : System.Web.UI.UserControl
{
  ...
  protected void Report_OnGenerate(object sender, DirectEventArgs e)
  {
    ...
    if (!string.IsNullOrEmpty(cbCustomer.SelectedItem.Value))
    {
      lstRptParam.Add(new ReportParameter()
      {
        ...
        ParameterName = "Temp_LGSPEXP.c_cusno",
    ...
    //  {
    //    DataType = typeof(string).FullName,
    //    ParameterName = string.Format("({{Temp_LGSPEXP.c_cusno}} IN [{0}])", string.Join(",", lstData.ToArray())),
    ...
    else
    {
      if (rptResult.IsSuccess)
      {
        ...
        {
          string rptName = string.Concat("Transaksi_SPExpedisi_", pag.Nip, ".", rptResult.Extension);
