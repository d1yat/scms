<%@ Control Language="C#" AutoEventWireup="true" CodeFile="EreportAlkes.ascx.cs" Inherits="reporting_ealkes" %>
    ...
    <ext:FormPanel ID="frmReportKriteria" runat="server" Padding="5" Frame="True" 
      ...
      <Items>
        ...
        <ext:RadioGroup ID="rdgTipeReport" runat="server" ColumnsNumber="1" FieldLabel="Tipe Laporan">
          <Items>
            <ext:Radio ID="rdgIn" runat="server" BoxLabel="Data Masuk" Checked="true" InputValue="01" />
            <ext:Radio ID="rdgOut" runat="server" BoxLabel="Data Keluar" InputValue="02" />
            <ext:Radio ID="rdgInRetur" runat="server" BoxLabel="Data Retur Masuk" InputValue="03" />
            <ext:Radio ID="rdgOutRetur" runat="server" BoxLabel="Data Retur Keluar" InputValue="04" />
          </Items>
        </ext:RadioGroup>
