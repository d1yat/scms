<%@ Control Language="C#" AutoEventWireup="true" CodeFile="Pembelian.ascx.cs" 
Inherits="reporting_Transaksi_Pembelian" %>

<ext:Panel runat="server">
  <Items>
    <ext:Hidden ID="hidWndDown" runat="server" />
    
    <ext:FormPanel ID="frmReportSP" runat="server" Padding="5" Frame="True" 
      Layout="Form">
      <Items>
        ...
        <ext:CompositeField runat="server" FieldLabel="Nomor RN">
          <Items>
            <ext:TextField ID="txRN1" runat="server" AllowBlank="true" />
            <ext:Label ID="Label2" runat="server" Text="-" AllowBlank="true" />
            <ext:TextField ID="txRN2" runat="server" />
          </Items>
        </ext:CompositeField>
        <ext:CompositeField ID="CompositeField1" runat="server" FieldLabel="DO Principal">
          <Items>
            <ext:TextField ID="txDO1" runat="server" AllowBlank="true" />
            <ext:Label ID="Label4" runat="server" Text="-" AllowBlank="true" />
            <ext:TextField ID="txDO2" runat="server" />
          </Items>
        </ext:CompositeField>
        ...
        <ext:SelectBox ID="cbRptType" runat="server" FieldLabel="Type" SelectedIndex="0"
          AllowBlank="false">
          <Items>
            <ext:ListItem Value="00" Text="--Select All--" />
            <ext:ListItem Value="01" Text="Pembelian" />
            <ext:ListItem Value="02" Text="Retur" />
            <ext:ListItem Value="03" Text="Claim" />
            <ext:ListItem Value="04" Text="Repack" />
            <ext:ListItem Value="05" Text="Transfer" />
          </Items>
        </ext:SelectBox>
  ...
  <Buttons>
    <ext:Button runat="server" Icon="ReportGo" Text="Generate">
      <DirectEvents>
        <Click OnEvent="Report_OnGenerate" Before="return isValidForm(#{frmReportSP});">
    ...
    <ext:Button runat="server" Icon="Reload" Text="Bersihkan">
      <Listeners>
        <Click Handler="initializePanel(#{frmReportSP}, #{chkAsync}, #{txPeriode1}, #{txPeriode2});" />
      </Listeners>
    </ext:Button>
  </Buttons>
  <Listeners>
    <AfterRender Handler="initializePanel(#{frmReportSP}, #{chkAsync}, #{txPeriode1}, #{txPeriode2});" />
  </Listeners>
</ext:Panel>
