<%@ Control Language="C#" AutoEventWireup="true" CodeFile="ListSP.ascx.cs" 
Inherits="reporting_Transaksi_ListSP" %>
  ...
  <Items>
    ...
    <ext:FormPanel ID="frmReportSP" runat="server" Padding="5" Frame="True" 
      ...
      <Items>
        ...
        <ext:CompositeField runat="server" FieldLabel="Nomor SP">
          <Items>
            <ext:TextField ID="txSPHO1" runat="server" AllowBlank="true" />
            <ext:Label ID="Label2" runat="server" Text="-" AllowBlank="true" />
            <ext:TextField ID="txSPHO2" runat="server" />
          </Items>
        </ext:CompositeField>
        <%--<ext:CompositeField runat="server" FieldLabel="Nomor SP Biasa">
          <Items>
            <ext:TextField ID="txSPB1" runat="server" AllowBlank="true" />
            <ext:Label ID="Label4" runat="server" Text="-" AllowBlank="true" />
            <ext:TextField ID="txSPB2" runat="server" />
          </Items>
        </ext:CompositeField>--%>
        ...
        <ext:RadioGroup ID="rdgJenisSP" runat="server" ColumnsNumber="1" FieldLabel="Jenis SP">
          <Items>
            ...
            <ext:Radio ID="rdSPO" runat="server" BoxLabel="SPO" />
            <ext:Radio ID="rdSPM" runat="server" BoxLabel="SPM" />
            <ext:Radio ID="rdSPHO" runat="server" BoxLabel="SP HO" />
            <ext:Radio ID="rdSPAdj" runat="server" BoxLabel="SP Adj" />
            <ext:Radio ID="rdSPDrop" runat="server" BoxLabel="SP Droping" /> <%--20170515 Indra--%>
          </Items>
        </ext:RadioGroup>
