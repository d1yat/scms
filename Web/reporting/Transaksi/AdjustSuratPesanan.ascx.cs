...
public partial class reporting_Transaksi_AdjustSuratPesanan : System.Web.UI.UserControl
{
  ...
  protected void Report_OnGenerate(object sender, DirectEventArgs e)
  {
    ...
    {
      DataType = typeof(string).FullName,
      ParameterName = "({LG_adjustTransH.c_type} = '08')",
      IsReportDirectValue = true
    });
    ...
    else
    {
      if (rptResult.IsSuccess)
      {
        ...
        {
          string rptName = string.Concat("Transaksi_Adjust_SP_", pag.Nip, ".", rptResult.Extension);
