<%@ Control Language="C#" AutoEventWireup="true" CodeFile="ReceiveNote.ascx.cs" 
Inherits="reporting_Transaksi_ReceiveNote" %>
<ext:Panel ID="Panel1" runat="server">
  <Items>
    <ext:Hidden ID="hidWndDown" runat="server" />
    
    <ext:FormPanel ID="frmReportRN" runat="server" Padding="5" Frame="True" 
      Layout="Form">
      <Items>
        ...
        <ext:CompositeField runat="server" FieldLabel="Batasan RN">
          <Items>
        ...
        <ext:CompositeField runat="server" FieldLabel="Batasan DO Pemasok">
          <Items>
            <ext:TextField ID="txDOS1" runat="server" AllowBlank="true" />
            <ext:Label runat="server" Text="-" AllowBlank="true" />
            <ext:TextField ID="txDOS2" runat="server" />
          </Items>
        </ext:CompositeField>
        ...
        <ext:SelectBox ID="cbTipeRN" runat="server" FieldLabel="Tipe PO" SelectedIndex="0"
          AllowBlank="false">
          <Items>
  ...
  <Buttons>
    <ext:Button runat="server" Icon="ReportGo" Text="Generate">
      <DirectEvents>
        <Click OnEvent="Report_OnGenerate" Before="return isValidForm(#{frmReportRN});">
    ...
    <ext:Button runat="server" Icon="Reload" Text="Bersihkan">
      <Listeners>
        <Click Handler="initializePanel(#{frmReportRN}, #{chkAsync}, #{txPeriode1}, #{txPeriode2});" />
      </Listeners>
    </ext:Button>
  </Buttons>
  <Listeners>
    <AfterRender Handler="initializePanel(#{frmReportRN}, #{chkAsync}, #{txPeriode1}, #{txPeriode2});" />
  </Listeners>
</ext:Panel>
