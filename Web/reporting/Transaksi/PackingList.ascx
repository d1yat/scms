...
Inherits="reporting_Transaksi_PackingList" %>
  ...
  <Items>
    ...
    <ext:FormPanel ID="frmReportPL" runat="server" Padding="5" Frame="True" 
      ...
      <Items>
        ...
        <ext:CompositeField runat="server" FieldLabel="Batasan PL">
          <Items>
            <ext:TextField ID="txPL1" runat="server" AllowBlank="true" />
            <ext:Label ID="Label2" runat="server" Text="-" AllowBlank="true" />
            <ext:TextField ID="txPL2" runat="server" />
          </Items>
        </ext:CompositeField>
