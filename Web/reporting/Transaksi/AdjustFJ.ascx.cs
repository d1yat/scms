...
public partial class reporting_Transaksi_AdjustFJ : System.Web.UI.UserControl
{
  ...
  protected void Report_OnGenerate(object sender, DirectEventArgs e)
  {
    ...
    {
      DataType = typeof(string).FullName,
      ParameterName = "({LG_adjustTransH.c_type} = '05')",
      IsReportDirectValue = true
    });
    ...
    else
    {
      if (rptResult.IsSuccess)
      {
        ...
        {
          string rptName = string.Concat("Transaksi_Adjust_FJ_", pag.Nip, ".", rptResult.Extension);
