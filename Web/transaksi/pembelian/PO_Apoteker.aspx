<%@ Page Title="" Language="C#" MasterPageFile="~/Master.master" AutoEventWireup="true"
  CodeFile="PO_Apoteker.aspx.cs" Inherits="transaksi_pembelian_PO_Apoteker" %>

<%@ Register Src="PO_ApotekerCtrl.ascx" TagName="PO_ApotekerCtrl" TagPrefix="uc" %>
            ...
            ShowAsk('Alasan ?', 'Masukkan alasan kenapa harus dibatalkan.',
              function(btnP, txt) {
                if (btnP == 'ok') {
                  ...
                  Ext.net.DirectMethods.DeleteMethod(rec.get('c_pono'), txt);
                }
              });
          }
        });
...
<asp:Content ID="Content2" ContentPlaceHolderID="cphContent" runat="Server">
  ...
  <ext:Hidden ID="hfTypePO" runat="server" />
            ...
            <Store>
              <ext:Store ID="storeGridPO" runat="server" RemoteSort="true" SkinID="OriginalExtStore">
                ...
                <BaseParams>
                  ...
                  <ext:Parameter Name="model" Value="0022" />
                  <ext:Parameter Name="parameters" Value="[['type', paramValueGetter(#{hfTypePO}), ''],
                    ...
                    ['l_revisi = @0', paramValueGetter(#{sbRevFltr}) , 'System.Boolean'],
                    ['l_print = @0', paramValueGetter(#{sbPrintFltr}) , 'System.Boolean'],
                    ['l_status_pok = @0', paramValueGetter(#{sbStatFltr}) , 'System.Boolean'],
                ...
                <Reader>
                  <ext:JsonReader TotalProperty="d.totalRows" Root="d.records" SuccessProperty="d.success"
                    ...
                    <Fields>
                      ...
                      <ext:RecordField Name="c_poktno" />
                      <ext:RecordField Name="v_nama" />
                      <ext:RecordField Name="l_revisi" Type="Boolean" />
                      <ext:RecordField Name="l_print" Type="Boolean" />
                      <ext:RecordField Name="l_status_pok" Type="Boolean" />
                    </Fields>
                  </ext:JsonReader>
                </Reader>
                <SortInfo Field="c_pono" Direction="DESC" />
              </ext:Store>
            </Store>
            <ColumnModel>
              <Columns>
                ...
                <ext:Column ColumnID="c_pono" DataIndex="c_pono" Header="Nomor PO" />
                <ext:DateColumn ColumnID="d_podate" DataIndex="d_podate" Header="Tanggal" Format="dd-MM-yyyy" />
                <ext:Column ColumnID="c_poktno" DataIndex="c_poktno" Header="No. PO OKT" Width="200" />
                ...
                <ext:CheckColumn ColumnID="l_status_pok" DataIndex="l_status_pok" Header="Submit" Width="50" />
              </Columns>
            </ColumnModel>
            <View>
                ...
                <HeaderRows>
                  <ext:HeaderRow>
                    <Columns>
                      <ext:HeaderColumn Cls="x-small-editor" AutoWidthElement="false">
                        <Component>
                          <ext:Button ID="ClearFilterButton" runat="server" Icon="Cancel" ToolTip="Clear filter">
                            <Listeners>
                              <Click Handler="clearFilterGridHeader(#{gridMain}, #{txPOFltr}, #{txDateFltr}, #{cbSuplierFltr}, #{sbRevFltr}, #{sbPrintFltr}, #{sbStatFltr});reloadFilterGrid(#{gridMain});"
                      ...
                      <ext:HeaderColumn>
                        <Component>
                          <ext:SelectBox ID="sbRevFltr" runat="server" ListWidth="50">
                            <Items>
                      ...
                      <ext:HeaderColumn>
                        <Component>
                          <ext:SelectBox ID="sbPrintFltr" runat="server" ListWidth="50">
                            <Items>
                              <ext:ListItem Text="&nbsp;" Value="" />
                              <ext:ListItem Text="Ya" Value="true" />
                              <ext:ListItem Text="Tdk" Value="false" />
                      ...
                      <ext:HeaderColumn>
                        <Component>
                          <ext:SelectBox ID="sbStatFltr" runat="server" ListWidth="50">
                            <Items>
                              <ext:ListItem Text="&nbsp;" Value="" />
                              <ext:ListItem Text="Ya" Value="true" />
                              <ext:ListItem Text="Tdk" Value="false" />
  ...
  <uc:PO_ApotekerCtrl ID="PO_ApotekerCtrl1" runat="server" />
</asp:Content>
