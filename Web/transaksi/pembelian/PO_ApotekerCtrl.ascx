<%@ Control Language="C#" AutoEventWireup="true" CodeFile="PO_ApotekerCtrl.ascx.cs"
  Inherits="transaksi_pembelian_PO_ApotekerCtrl" %>
      ...
      <DirectEvents>
        <Click OnEvent="SaveBtn_Click">
          ...
          <ExtraParams>
            ...
            <ext:Parameter Name="typePO" Value="#{hfTypePO}.getValue()" Mode="Raw" />
