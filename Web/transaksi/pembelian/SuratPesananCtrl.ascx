<%@ Control Language="C#" AutoEventWireup="true" CodeFile="SuratPesananCtrl.ascx.cs"
  Inherits="transaksi_pembelian_SuratPesananCtrl" %>

<script type="text/javascript">
  var storeToDetailGrid = function(frm, grid, item, quantity, acceptance, ketDtl) {
        ...
        <ext:FormPanel ID="frmHeaders" runat="server" Title="Header" Height="195" Padding="10">
          <Items>
            ...
            <ext:TextField ID="txKeterangan" runat="server" FieldLabel="Keterangan" MaxLength="100"
              Width="400" />
              <ext:CompositeField runat="server" FieldLabel="Tgl ETD Cabang">
                <Items>
                    <ext:DateField ID="dtEtdCab" runat="server" AllowBlank="false" Format="dd-MM-yyyy" EnableKeyEvents="false" />
                </Items>
              </ext:CompositeField>
              <ext:CompositeField runat="server" FieldLabel="Tgl ETA Cabang">
                <Items>
                    <ext:DateField ID="dtEtaCab" runat="server" AllowBlank="false" Format="dd-MM-yyyy" EnableKeyEvents="false" />
                </Items>
              </ext:CompositeField>
                ...
                <ext:FormPanel ID="frmpnlDetailEntry" runat="server" Frame="True" Layout="Table"
                 ...
                 <ext:TextField ID="txKetDtl" runat="server" FieldLabel="Keterangan" AllowBlank="true"
                    ...
                    <ext:Button ID="btnAdd" runat="server" FieldLabel="&nbsp;" LabelSeparator=" " ToolTip="Add"
                      Icon="Add">
                      <Listeners>
                        <Click Handler="storeToDetailGrid(#{frmpnlDetailEntry}, #{gridDetail}, #{cbItemDtl}, #{txQtyDtl}, #{txAccDtl}, #{txKetDtl});" />
                      </Listeners>
                    </ext:Button>
              ...
              <ColumnModel>
                <Columns>
                  <ext:CommandColumn Width="50">
                    <Commands>
                      <ext:GridCommand CommandName="Delete" Icon="Decline" ToolTip-Title="Command" ToolTip-Text="Hapus entry" Hidden="true" />
                      <ext:GridCommand CommandName="Void" Icon="Cross" ToolTip-Title="Command" ToolTip-Text="Void Entry" Hidden="true" />
                      <ext:GridCommand CommandName="Reset" Icon="BasketRemove" ToolTip-Title="Command" ToolTip-Text="Reset Sisa Menjadi 0" Hidden="true" />
                    </Commands>
