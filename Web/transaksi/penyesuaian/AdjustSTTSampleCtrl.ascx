<%@ Control Language="C#" AutoEventWireup="true" CodeFile="AdjustSTTSampleCtrl.ascx.cs" 
Inherits="transaksi_penyesuaian_AdjustSTTSampleCtrl" %>
...
<script type="text/javascript">
  ...
  var onChangeAdjSTT = function(o, valu, tQty) {
  ...
  var storeToDetailGrid = function(frm, grid, NoRef, item, batch, Quantity) {
  ...
  var resetEntryWhenChangeInt = function(g) {
    var item = Ext.getCmp('<%= cbItemDtl.ClientID %>'),
      NoRef = Ext.getCmp('<%= cbNoRefDtl.ClientID %>'),
...
<ext:Window ID="winDetail" runat="server" Height="480" Width="1000" Hidden="true"
  ...
  <Content>
    <ext:Hidden ID="hfADJSTTSample" runat="server" />
    ...
    <ext:BorderLayout ID="bllayout" runat="server">
     <North MinHeight="130" MaxHeight="130" Collapsible="false">
        <ext:FormPanel ID="frmHeaders" runat="server" Title="Header" Height="130" Padding="10">
          <Items>
            <ext:ComboBox ID="cbGudangHdr" runat="server" FieldLabel="Gudang" ValueField="c_gdg"
            ...
            <ext:Toolbar runat="server">
               <Items>
                <ext:FormPanel ID="frmpnlDetailEntry" runat="server" Frame="True" Layout="Table"
                  ...
                  <Items>
                    <ext:ComboBox ID="cbNoRefDtl" runat="server" FieldLabel="No STT Sample" DisplayField="c_noref"
                      ...
                      <Store>
                        <ext:Store runat="server" >
                          ...
                          <BaseParams>
                            ...
                            <ext:Parameter Name="parameters" Value="[['c_gdg', paramValueGetter(#{cbGudangHdr}), 'System.Char'],
                                                                     ['c_type', paramValueGetter(#{hfType}), 'System.String'],
                                                                     ['@contains.c_noref.Contains(@0)', paramTextGetter(#{cbNoRefDtl}), '']]" Mode="Raw" />
                        ...
                        <ext:Store runat="server">
                          ...
                          <BaseParams>
                            ...
                            <ext:Parameter Name="parameters" Value="[['l_aktif = @0', true, 'System.Boolean'],
                                                                     ...
                                                                     ['c_stno', #{cbNoRefDtl}.getValue(), 'System.String'],
                    ...
                    <ext:ComboBox ID="cbBatDtl" runat="server" FieldLabel="Batch" ItemSelector="tr.search-item"
                      ...
                      <Listeners>
                        <TriggerClick Handler="if(index == 0) { reloadData(this); }" />
                        <Change Handler="onChangeAdjSTT(this, newValue, #{txQtyDtl});" />
                      </Listeners>
                    </ext:ComboBox>
                    ...
                    <ext:Button ID="btnAdd" runat="server" FieldLabel="&nbsp;" LabelSeparator=" " ToolTip="Add"
                      Icon="Add">
                      <Listeners>
                        <Click Handler="storeToDetailGrid(#{frmpnlDetailEntry}, #{gridDetail}, #{cbNoRefDtl}, #{cbItemDtl}, #{cbBatDtl}, #{txQtyDtl});" />
                      </Listeners>
                    </ext:Button>
              ...
              <Store>
                <ext:Store runat="server" RemotePaging="false" RemoteSort="false">
                  ...
                  <BaseParams>
                    ...
                    <ext:Parameter Name="parameters" Value="[['c_adjno = @0', #{hfADJSTTSample}.getValue(), 'System.String']]"
                      Mode="Raw" />
                  </BaseParams>
                  <Reader>
              ...
              <ColumnModel>
                <Columns>
                  <ext:CommandColumn Width="25">
                    ...
                    <PrepareToolbar Handler="prepareCommands(record, toolbar, #{hfADJSTTSample}.getValue());" />
                  </ext:CommandColumn>
    ...
    <ext:Button ID="btnPrint" runat="server" Icon="Printer" Text="Cetak">
      <DirectEvents>
        <Click OnEvent="Report_OnGenerate" Before="return verifyHeaderAndDetail(#{frmHeaders},#{gridDetail});">
          ...
          <ExtraParams>
            <ext:Parameter Name="NumberID" Value="#{hfADJSTTSample}.getValue()" Mode="Raw" />
          </ExtraParams>
        </Click>
      </DirectEvents>
    </ext:Button>
        ...
        <Click OnEvent="SaveBtn_Click" Before="return verifyHeaderAndDetail(#{frmHeaders},#{gridDetail});">
          ...
          <ExtraParams>
            <ext:Parameter Name="gridValues" Value="saveStoreToServer(#{gridDetail}.getStore())"
              Mode="Raw" />
            <ext:Parameter Name="NumberID" Value="#{hfADJSTTSample}.getValue()" Mode="Raw" />
            <ext:Parameter Name="Type" Value="#{cbTipeHdr}.getValue()" Mode="Raw" />
            <ext:Parameter Name="TypeDesc" Value="#{cbTipeHdr}.getText()" Mode="Raw" />
