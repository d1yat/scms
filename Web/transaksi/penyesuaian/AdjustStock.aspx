<%@ Page Language="C#" AutoEventWireup="true" CodeFile="AdjustStock.aspx.cs" 
Inherits="transaksi_penyesuaian_AdjustStock" MasterPageFile="~/Master.master" %>

<%@ Register Src="AdjustStockBatch.ascx" TagName="AdjustStockBatch" TagPrefix="uc1" %>
<%@ Register Src="AdjustStockGoodBad.ascx" TagName="AdjustStockGoodBad" TagPrefix="uc2"%>
<%@ Register Src="AdjustStockStock.ascx" TagName="AdjustStockStock" TagPrefix="uc3"%>
            ...
            ShowAsk('Alasan ?', 'Masukkan alasan kenapa harus dibatalkan.',
              function(btnP, txt) {
                if (btnP == 'ok') {
                  ...
                  Ext.net.DirectMethods.DeleteMethod(rec.get('c_adjno'), rec.get('c_gdg'), txt);
                }
              });
          }
        });
            ...
            <Store>
              <ext:Store ID="storeGridADJ" runat="server" RemoteSort="true" SkinID="OriginalExtStore">
                ...
                <BaseParams>
                  ...
                  <ext:Parameter Name="model" Value="0074" />
              ...
              <Columns>
                <ext:CommandColumn Width="50" Resizable="false">
                  <Commands>
                    ...
                    <ext:GridCommand CommandName="Delete" Icon="Decline" ToolTip-Title="" Disabled="true" ToolTip-Text="Hapus transaksi" />
                  </Commands>
                </ext:CommandColumn>
                ...
                <ext:Column ColumnID="ketType" DataIndex="ketType" Header="Type" Width="200" />
