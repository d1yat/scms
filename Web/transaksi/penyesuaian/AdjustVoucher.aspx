<%@ Page Language="C#" AutoEventWireup="true" CodeFile="AdjustVoucher.aspx.cs" 
Inherits="transaksi_penyesuaian_AdjustVoucher" MasterPageFile="~/Master.master" %>

<%@ Register Src="adjVoucherDebitCtrl.ascx" TagName="adjVoucherDebitCtrl" TagPrefix="uc1" %>
<%@ Register Src="AdjVoucherCreditCtrl.ascx" TagName="AdjVoucherCreditCtrl" TagPrefix="uc2" %>

<asp:Content ID="Content1" ContentPlaceHolderID="cphHead" runat="Server">
<script type="text/javascript">
    var voidAdjustVoucherDataFromStore = function(rec) {
      if (Ext.isEmpty(rec)) {
        return;
      }
...
<asp:Content ID="Content2" ContentPlaceHolderID="cphContent" runat="Server">
      ...
      <ext:Panel ID="pnlMainControl" runat="server" Layout="Fit">
        ...
        <Items>
          <ext:GridPanel ID="gridMain" runat="server">
            ...
            <Listeners>
              <Command Handler="if(command == 'Delete') { voidAdjustVoucherDataFromStore(record); }" />
            </Listeners>
            <DirectEvents>
            ...
            <Store>
              <ext:Store ID="storeGridADJ" runat="server" RemoteSort="true" SkinID="OriginalExtStore">
                ...
                <BaseParams>
                  ...
                  <ext:Parameter Name="model" Value="0120" />
            ...
            <ColumnModel>
              <Columns>
                ...
                <ext:Column ColumnID="v_ketTran" DataIndex="v_ketTran" Header="jenis" Width="200" />
  ...
  <uc1:adjVoucherDebitCtrl ID="adjVoucherDebitCtrl" runat="server" />
  <uc2:AdjVoucherCreditCtrl ID="AdjVoucherCreditCtrl" runat="server" />
</asp:Content>