<%@ Page Language="C#" AutoEventWireup="true" CodeFile="AdjustMemoSTT.aspx.cs" 
Inherits="transaksi_penyesuaian_AdjustMemoSTT" MasterPageFile="~/Master.master" %>

<asp:Content ID="Content1" ContentPlaceHolderID="cphHead" runat="Server">
<script type="text/javascript">
    var voidAdjustMemoDataFromStore = function(rec) {
      if (Ext.isEmpty(rec)) {
        return;
      }
        ...
        <TopBar>
          <ext:Toolbar runat="server">
            <Items>
              ...
              <ext:Button ID="btnPrintADJ" runat="server" Text="Cetak" Icon="Printer" />
              <ext:ToolbarSeparator />
              ...
              <ext:Store ID="storeGridADJ" runat="server" RemoteSort="true" SkinID="OriginalExtStore">
                ...
                <BaseParams>
                  ...
                  <ext:Parameter Name="parameters" Value="[['d_adjdate = @0', paramRawValueGetter(#{txDateFltr}) , 'System.DateTime'],
                    ...
                    ['c_beban = @0', paramValueGetter(#{cbCustomerFltr}) , 'System.Char'],
