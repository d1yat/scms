...
CodeFile="adjVoucherDebitCtrl.ascx.cs" 
Inherits="transaksi_penyesuaian_adjVoucherDebitCtrl" %>

<script type="text/javascript">

  var onChangeAdjDR = function(o, valu, hasil) {
  ...
  var storeToDetailGridDR = function(frm, grid, NoRef, Tipe, Val, KetD) {
  ...
  var resetEntryWhenChangeIntDR = function(g) {
    var Tipe = Ext.getCmp('<%= cbTipeDR.ClientID %>'),
      NoRef = Ext.getCmp('<%= cbNoRefDtlDR.ClientID %>'),
      Val = Ext.getCmp('<%= txValueDR.ClientID %>'),
      KetD = Ext.getCmp('<%= txKetDetDR.ClientID %>')
  ...
  var prepareCommandsDR = function(rec, toolbar, valX) {
  ...
  var voidInsertedDataFromStoreDR = function(rec) {
    if (Ext.isEmpty(rec)) {
      return;
    }
...
<ext:Window ID="winDetail" runat="server" Height="480" Width="750" Hidden="true"
  ...
  <Content>
    <ext:Hidden ID="hfADJDebit" runat="server" />
    ...
    <ext:BorderLayout ID="bllayout" runat="server">
     <North MinHeight="80" MaxHeight="80" Collapsible="false">
        <ext:FormPanel ID="frmHeaders" runat="server" Title="Header" Height="80" Padding="10">
          <Items>
            <ext:TextField runat="server" ID="txKeteranganHdrDR" Width="450" FieldLabel="Keterangan" />
          </Items>
       </ext:FormPanel>
     </North>
        ...
        <TopBar>
          <ext:Toolbar runat="server">
            <Items>
              <ext:FormPanel ID="frmpnlDetailEntry" runat="server" Frame="True" Layout="Table"
                ...
                <Items>
                  <ext:ComboBox ID="cbNoRefDtlDR" runat="server" FieldLabel="No Voucher" DisplayField="c_noref"
                    ...
                    <Store>
                      <ext:Store runat="server" >
                        ...
                        <BaseParams>
                          ...
                          <ext:Parameter Name="model" Value="0121" />
                          <ext:Parameter Name="parameters" Value="[['@contains.c_noref.Contains(@0)', paramTextGetter(#{cbNoRefDtlDR}), '']]" Mode="Raw" />
                        ...
                        <Reader>
                          <ext:JsonReader IDProperty="c_noref" Root="d.records" SuccessProperty="d.success"
                            ...
                            <Fields>
                              ...
                              <ext:RecordField Name="d_vddate" DateFormat="M$" Type="Date"/>
                            </Fields>
                          </ext:JsonReader>
                        </Reader>
                      </ext:Store>
                    ...
                    <Template ID="Template3" runat="server">
                      ...
                      <td>{c_noref}</td>
                      <td>{d_vddate:this.formatDate}</td>
                      </tr></tpl>
                      </table>
                      </Html>
                      <Functions>
                    ...
                    <Listeners>
                      ...
                      <Change Handler="onChangeAdjDR(this, newValue, #{txValueDR});" />
                    </Listeners>
                  </ext:ComboBox>
                  <ext:ComboBox ID="cbTipeDR" runat="server" FieldLabel="Tipe" DisplayField="v_ket"
                    ...
                    <ext:Store runat="server" RemotePaging="false" SkinID="OriginalExtStore">
                      ...
                      <BaseParams>
                        ...
                        <ext:Parameter Name="parameters" Value="[['c_portal = @0', '3', 'System.Char'],
                                                  ...
                                                  ['@contains.v_ket.Contains(@0)', paramTextGetter(#{cbTipeDR}), '']]" Mode="Raw" />
                  ...
                  <ext:NumberField ID="txValueDR" runat="server" FieldLabel="Value"
                  Width="150" Format="0.000,00/i" />
                  <ext:TextField runat="server" ID="txKetDetDR" Width="250" FieldLabel="Keterangan" />
                  <ext:Button ID="btnAdd" runat="server" FieldLabel="&nbsp;" LabelSeparator=" " ToolTip="Add"
                    Icon="Add">
                    <Listeners>
                      <Click Handler="storeToDetailGridDR(#{frmpnlDetailEntry}, #{gridDetail}, #{cbNoRefDtlDR}, #{cbTipeDR}, #{txValueDR}, #{txKetDetDR});" />
                    </Listeners>
                  </ext:Button>
         ...
         <Items>
          <ext:GridPanel ID="gridDetail" runat="server">
            ...
            <Store>
              <ext:Store ID="Store5" runat="server" RemotePaging="false" RemoteSort="false">
                ...
                <BaseParams>
                  ...
                  <ext:Parameter Name="allQuery" Value="true" />
                  <ext:Parameter Name="model" Value="0124" />
                  <ext:Parameter Name="sort" Value="" />
                  <ext:Parameter Name="dir" Value="" />
                  <ext:Parameter Name="parameters" Value="[['c_adjno = @0', #{hfADJDebit}.getValue(), 'System.String']]"
                    Mode="Raw" />
                </BaseParams>
                <Reader>
            ...
            <ColumnModel>
              <Columns>
                <ext:CommandColumn Width="25">
                  ...
                  <PrepareToolbar Handler="prepareCommandsDR(record, toolbar, #{hfADJDebit}.getValue());" />
                </ext:CommandColumn>
                  <ext:Column DataIndex="c_noref" Header="No Referensi" Width="80" />
                  <ext:Column DataIndex="c_type" Header="Type" Width="50" />
                  <ext:Column DataIndex="v_ketTran" Header="Tipe" Width="150" />
            ...
            <Listeners>
              <Command Handler="if(command == 'Delete') { deleteRecordOnGrid(this, record); } else if (command == 'Void') { voidInsertedDataFromStoreDR(record); }" />
            </Listeners>
          </ext:GridPanel>
         </Items>
       </ext:Panel>
    ...
    <ext:Button ID="btnPrint" runat="server" Icon="Printer" Text="Cetak">
      <DirectEvents>
        <Click >
          ...
          <ExtraParams>
            <ext:Parameter Name="NumberID" Value="#{hfADJDebit}.getValue()" Mode="Raw" />
          </ExtraParams>
        </Click>
      </DirectEvents>
    </ext:Button>
        ...
        <Click OnEvent="SaveBtn_Click" Before="return verifyHeaderAndDetail(#{frmHeaders},#{gridDetail});">
          ...
          <ExtraParams>
            <ext:Parameter Name="gridValues" Value="saveStoreToServer(#{gridDetail}.getStore())"
              Mode="Raw" />
            <ext:Parameter Name="NumberID" Value="#{hfADJDebit}.getValue()" Mode="Raw" />
            <ext:Parameter Name="Type" Value="#{cbTipeDR}.getValue()" Mode="Raw" />
            <ext:Parameter Name="TypeDesc" Value="#{cbTipeDR}.getText()" Mode="Raw" />
            <ext:Parameter Name="Keterangan" Value="#{txKeteranganHdrDR}.getValue()" Mode="Raw" />
