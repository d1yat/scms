...
CodeFile="RNClaimCtrlUlujami.ascx.cs" Inherits="transaksi_penerimaan_RNClaimCtrlUlujami" %>
                      ...
                      <Store>
                        <ext:Store runat="server">
                          ...
                          <BaseParams>
                            <ext:Parameter Name="start" Value="={0}" />
                            <ext:Parameter Name="limit" Value="={10}" />
                            <ext:Parameter Name="model" Value="1007103" />
                      ...
                      <Store>
                        <ext:Store runat="server">
                          ...
                          <BaseParams>
                            <ext:Parameter Name="start" Value="={0}" />
                            <ext:Parameter Name="limit" Value="={10}" />
                            <ext:Parameter Name="model" Value="1008103" />
                            <ext:Parameter Name="parameters" Value="[['tipe', paramValueGetter(#{cbTipeDtl}), 'System.String'],
                                                                    ['nosup', paramValueGetter(#{cbSuplierHdr}), 'System.String'],
              ...
              <Store>
                <ext:Store ID="Store6" runat="server" RemotePaging="false" RemoteSort="false">
                  ...
                  <BaseParams>
                    ...
                    <ext:Parameter Name="parameters" Value="[['gudang', '6', 'System.Char'],
