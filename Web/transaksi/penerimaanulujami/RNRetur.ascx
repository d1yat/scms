<%@ Control Language="C#" AutoEventWireup="true" CodeFile="RNRetur.ascx.cs" Inherits="transaksi_penerimaan_RNRetur" %>
...
<script type="text/javascript">
  ...
  var storeToDetailGrid = function(frm, grid, item, nomorRs, batch, tGQty, tBQty) {
    ...
    if (!isDup) {
      var gqty = tGQty.getValue();
      var bqty = tBQty.getValue();
  ...
  <Items>
    <ext:BorderLayout ID="bllayout" runat="server">
      <North MinHeight="150" MaxHeight="150" Collapsible="false">
        <ext:FormPanel runat="server" Title="Header" Height="150" Padding="10" Layout="Column">
          <Items>
                      ...
                      <Store>
                        <ext:Store runat="server">
                          ...
                          <BaseParams>
                            <ext:Parameter Name="start" Value="={0}" />
                            <ext:Parameter Name="limit" Value="={10}" />
                            <ext:Parameter Name="model" Value="10091" />
                      ...
                      <Store>
                        <ext:Store runat="server">
                          ...
                          <BaseParams>
                            <ext:Parameter Name="start" Value="={0}" />
                            <ext:Parameter Name="limit" Value="={10}" />
                            <ext:Parameter Name="model" Value="10092" />
                            <ext:Parameter Name="parameters" Value="[['nosup', paramValueGetter(#{cbSuplierHdr}), 'System.String'],
                                                                    ['gudang', '1', 'System.Char'],
                      ...
                      <Store>
                        <ext:Store runat="server">
                          ...
                          <BaseParams>
                            <ext:Parameter Name="start" Value="={0}" />
                            <ext:Parameter Name="limit" Value="={10}" />
                            <ext:Parameter Name="model" Value="10093" />
            ...
            <ext:GridPanel ID="gridDetail" runat="server" ClicksToEdit="1">
                ...
                <ext:Store ID="Store6" runat="server" RemotePaging="false" RemoteSort="false">
                  ...
                  <BaseParams>
                    ...
                    <ext:Parameter Name="parameters" Value="[['gudang', '1', 'System.Char'],
                      ...
                      ['c_typern = @0', '02', 'System.String']]" Mode="Raw" />
                  </BaseParams>
                  <Reader>
              ...
              <ColumnModel>
                <Columns>
                  ...
                  <ext:Column DataIndex="c_refno" Header="Nomor Retur" />
