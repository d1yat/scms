<%@ Control Language="C#" AutoEventWireup="true" CodeFile="RNPembelianCtrlUlujami.ascx.cs"
  Inherits="transaksi_penerimaan_RNPembelianCtrl_Ulujami" %>
                      ...
                      <Store>
                        <ext:Store runat="server">
                          ...
                          <BaseParams>
                            <ext:Parameter Name="start" Value="={0}" />
                            <ext:Parameter Name="limit" Value="={10}" />
                            <ext:Parameter Name="model" Value="10012" />
                            <ext:Parameter Name="parameters" Value="[['tipe', paramValueGetter(#{cbTipeDtl}), 'System.String'],
                                                                    ['nosup', paramValueGetter(#{cbSuplierHdr}), 'System.String'],
                ...
                <ext:Store runat="server" RemotePaging="false" RemoteSort="false">
                  ...
                  <BaseParams>
                    ...
                    <ext:Parameter Name="parameters" Value="[['gudang', '1', 'System.Char'],
                      ...
                      ['c_typern = @0', '05', 'System.String']]" Mode="Raw" />
                  </BaseParams>
                  <Reader>
