<%@ Page Title="" Language="C#" MasterPageFile="~/Master.master" AutoEventWireup="true"
    CodeFile="ReceiveNoteUlujami.aspx.cs" Inherits="transaksi_penerimaan_ReceiveNote_Ulujami" %>

<%@ Register Src="RNPembelianCtrlUlujami.ascx" TagName="RNPembelianCtrlUlujami" TagPrefix="uc1" %>
<%@ Register Src="RNKhususCtrlUlujami.ascx" TagName="RNKhususCtrlUlujami" TagPrefix="uc2" %>
<%@ Register Src="RNClaimCtrlUlujami.ascx" TagName="RNClaimCtrlUlujami" TagPrefix="uc3" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="cphContent" runat="Server">
    ...
    <ext:Hidden ID="hfKet" runat="server" />
                        ...
                        <Store>
                            <ext:Store ID="storeGridRN" runat="server" RemoteSort="true" SkinID="OriginalExtStore">
                                ...
                                <BaseParams>
                                    ...
                                    <ext:Parameter Name="model" Value="0050-a" />
