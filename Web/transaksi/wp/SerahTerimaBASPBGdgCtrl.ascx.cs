...
public partial class transaksi_wp_SerahTerimaBASPBGdgCtrl : System.Web.UI.UserControl
{
    #region Private
            ...
            case "Add":
                {
                    ...
                    string[][] paramX = new string[][]
                    {
                        ...
                        new string[] { "c_grouped", "ST_BASPBGdg", "System.String"}
                    };
    ...
    private void PopulateDetail(string pName, string pID)
    {
        ...
        try
        {
            ...
            if (dicResult.ContainsKey("records") && (dicResult.ContainsKey("totalRows") && (((long)dicResult["totalRows"]) > 0)))
            {
                ...
                wndIDUser.Title = string.Concat("Serah Terima Gudang BASPB - ", pID);
        ...
        {
            System.Diagnostics.Debug.WriteLine(
              string.Concat("transaction_wp_SerahTerima_BASPBGdg:PopulateDetail Header - ", ex.Message));
        }
        finally
        {
            if (jarr != null)
        ...
        {
            System.Diagnostics.Debug.WriteLine(
              string.Concat("transaction_wp_SerahTerima_BASPBGdg:PopulateDetail Detail - ", ex.Message));
        }
    ...
    {
        wndIDUser.Title = "Serah Terima Gudang BASPB";
        hfSTNo.Clear();
    ...
    private PostDataParser.StructureResponse SaveParser(bool isAdd, bool isConfirm, string plNumber, Dictionary<string, string>[] dics)
    {
        ...
        pair.DicAttributeValues.Add("Tipe", "07");
        ...
        {
            Scms.Web.Common.Logger.WriteLine("transaksi_wp_SerahTerimaBASPBGdgCtrl SaveParser : {0} ", ex.Message);
        }
        string result = null;
    ...
    protected void OnSelectGrid(object sender, DirectEventArgs e)
    {
        ...
        tmp = string.Format(@"var xOpts = {{
                                  params: {{
                                      ...
                                      sort: '',
                                      dir: '',
                                      parameters: [['C_BASPBNO', '{0}', 'System.String']]
                                    }}
                                  }};", pName.ToString());
        X.AddScript(tmp);
