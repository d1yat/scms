...
public partial class transaksi_wp_SerahTerimaInkJetCtrl : System.Web.UI.UserControl
{
    #region Private
    ...
    private PostDataParser.StructureResponse SaveParser(bool isAdd, bool isConfirm, string plNumber, Dictionary<string, string>[] dics)
    {
        ...
        pair.DicAttributeValues.Add("EntryName", "TEAM INKJET");
        ...
        pair.DicAttributeValues.Add("Tipe", "1A");
        ...
        {
            Scms.Web.Common.Logger.WriteLine("transaksi_wp_SerahTerimaInkJetCtrl SaveParser : {0} ", ex.Message);
        }
        string result = null;
                    ...
                    if (respon.Values != null)
                    {
                        ...
                        if (!string.IsNullOrEmpty(storeId))
                        {
                            scrpt = string.Format(@"{0}.insert(0, new Ext.data.Record({{
                                        ...
                                        hfGudangDesc.Text, dateJs, "TEAM INKJET", txNamePenyerah.Text);
