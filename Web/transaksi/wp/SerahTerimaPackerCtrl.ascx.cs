...
public partial class transaksi_wp_SerahTerimaPackerCtrl : System.Web.UI.UserControl
{
    #region Private
            ...
            case "Add":
                {
                    ...
                    string[][] paramX = new string[][]
                    {
                        ...
                        new string[] { "c_grouped", "ST_PACKER", "System.String"}
                    };
    ...
    private void PopulateDetail(string pName, string pID)
    {
        ...
        {
            System.Diagnostics.Debug.WriteLine(
              string.Concat("transaction_wp_SerahTerima_Packer:PopulateDetail Header - ", ex.Message));
        }
        finally
        {
            if (jarr != null)
        ...
        {
            System.Diagnostics.Debug.WriteLine(
              string.Concat("transaction_wp_SerahTerima_Packer:PopulateDetail Detail - ", ex.Message));
        }
    ...
    private PostDataParser.StructureResponse SaveParser(bool isAdd, bool isConfirm, string plNumber, Dictionary<string, string>[] dics)
    {
        ...
        pair.DicAttributeValues.Add("EntryName", "TEAM PACKER");
        ...
        {
            Scms.Web.Common.Logger.WriteLine("transaksi_wp_SerahTerimaPackerCtrl SaveParser : {0} ", ex.Message);
        }
        string result = null;
    ...
    protected void SaveBtn_Click(object sender, DirectEventArgs e)
    {
        ...
        if (respon.IsSet)
        {
            if (respon.Response == PostDataParser.ResponseStatus.Success)
            {
                    ...
                    if (respon.Values != null)
                    {
                        ...
                        if (!string.IsNullOrEmpty(storeId))
                        {
                            scrpt = string.Format(@"{0}.insert(0, new Ext.data.Record({{
                                        ...
                                        hfGudangDesc.Text, dateJs, "TEAM PACKER", txNamePenyerah.Text);
                ...
                if (!string.IsNullOrEmpty(sTransSalah))
                {
                    ...
                    Functional.ShowAlert("Data sebagian berhasil tersimpan, " + sTransSalah + " " + Environment.NewLine + "Mohon dicek kembali dikarenakan : " +
                        ...
                        Environment.NewLine + "2.atau PL/SJ belum sampai dibagian Checker" +
                    ...
                    //    Environment.NewLine + "2.atau DO sudah dikirim ekspedisi" +
                    //    Environment.NewLine + "3.atau SJ belum diconfirm");
                }
                else
                {
            ...
            else
            {
                ...
                {
                    e.ErrorMessage = "PL/SJ tidak ada atau PL/SJ belum sampai dibagian Checker atau PL sudah jadi DO atau SJ sudah diconfirm";
                    //e.ErrorMessage = "DO/SJ tidak ada atau DO sudah dikirim ekspedisi atau SJ belum diconfirm";
                }
                else
                {
