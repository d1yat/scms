<%@ Control Language="C#" AutoEventWireup="true" CodeFile="SerahTerimaCheckerCtrl.ascx.cs"
    Inherits="transaksi_wp_SerahTerimaCheckerCtrl" %>

<script type="text/javascript">
    var storeToDetailGridChecker = function(frm, grid, transNo) {
                                ...
                                <ext:FormPanel ID="frmpnlDetailEntry" runat="server" Frame="True" Layout="ColumnLayout"
                                    ...
                                    <Items>
                                            ...
                                            <Store>
                                                <ext:Store ID="Store7" runat="server" AutoLoad="false">
                                                    ...
                                                    <BaseParams>
                                                        ...
                                                        <ext:Parameter Name="model" Value="0306a" />
                                        ...
                                        <ext:Button ID="btnAdd" runat="server" FieldLabel="&nbsp;" LabelSeparator=" " ToolTip="Add"
                                            Icon="Add">
                                            <Listeners>
                                                <Click Handler="storeToDetailGridChecker(#{frmpnlDetailEntry}, #{gridDetail}, #{cbNoDtl});" />
                                            </Listeners>
                                        </ext:Button>
