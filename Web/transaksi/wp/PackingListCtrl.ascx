...
<script type="text/javascript">
    ...
    //Indra 20171120 Ulujami
    var selectedItemBatchPL = function(combo, rec, target, cbItm, cbSp, grid, hfExpire) {
    //var selectedItemBatchPL = function(combo, rec, target, target2, cbItm, cbSp, grid, hfExpire) {
        //End 20171120 Ulujami
  ...
  //var storeToDetailGridMulti = function(frm, grid, item, sp, tipe, batch, lokasiitem, quantity, cbItm, cbSp, hfExpire, hfSPDate) {
  //End 20171120 Ulujami
      ...
      if (Ext.isEmpty(grid) ||
          ...
          Ext.isEmpty(tipe) ||
          Ext.isEmpty(batch) ||
          //Ext.isEmpty(lokasiitem) || //Indra 20171120 Ulujami
      ...
      if (Ext.isEmpty(recSp)) {
                  ...
                  if (!isDup) {
                      ...
                      if (validasiTotalPermintaan(grid.getStore(), 'c_iteno', 'c_sp', itemNo, spNo, qty, reqQty, totalQty)) {
                          store.insert(0, new Ext.data.Record({
                              ...
                              //'v_typedesc': 'Beli',
                              'c_batch': bat,
                              //'c_locno': lokasiitem.getValue().toUpperCase(), //Indra 20171120 Ulujami
                              'n_booked': reqQty,
                              'n_QtyRequest': reqQty,
                              'd_spdate': spdate,
                              'd_expired': expdate,
          ...
          sp.reset();
          batch.reset();
          lokasiitem.reset(); //Indra 20171120 Ulujami
          quantity.reset();
          hfExpire.clear();
          hfSPDate.clear();
...
<ext:Window ID="winDetail" runat="server" Height="480" Width="950" Hidden="true"
  ...
  <Content>
    ...
    <ext:Hidden ID="ItemItem" runat="server" /> 
                ...
                <ext:Panel ID="Panel2" runat="server" Border="false" Header="false" ColumnWidth=".5"
                  ...
                  <Items>
                    ...
                    <ext:ComboBox ID="cbKategori" runat="server" FieldLabel="Kategori" DisplayField="v_ket"
                      ...
                      <Listeners>
                        <TriggerClick Handler="if(index == 0) { reloadData(this); }" />
                        <Change Handler="onChangeKategoriItem(#{gridDetail},this,#{cbViaHdr});clearRelatedComboRecursive(true, #{cbItemDtl});" />
                      </Listeners>
                    </ext:ComboBox>
              ...
              <Items>
                <ext:FormPanel ID="frmpnlDetailEntry" runat="server" Frame="True" Layout="Table"
                  ...
                  <Items>
                    ...
                    <ext:ComboBox ID="cbBatDtl" runat="server" FieldLabel="Batch" ItemSelector="tr.search-item"
                          ...
                          <Reader>
                            <ext:JsonReader IDProperty="c_batch" Root="d.records" SuccessProperty="d.success"
                              ...
                              <Fields>
                                ...
                                <%--<ext:RecordField Name="c_locno" />--%><%--Indra 20171120 Ulujami--%>
                      ...
                      <Template runat="server">
                        ...
                        <tr>
                          ...
                          <td class="body-panel">Lokasi Item</td><%--Indra 20171120 Ulujami--%>
                          <td class="body-panel">Kadaluarsa</td>
                          <td class="body-panel">Quantity/batch</td>
                        </tr>
                        <tpl for="."><tr class="search-item">
                            <td>{c_batch}</td>
                            <%--<td>{c_locno}</td><%--Indra 20171120 Ulujami--%>--%>
                    ...
                    <%--Indra 20171120 Ulujami--%>
                   <%-- <ext:TextField ID="txItemLocDtl" runat="server" FieldLabel="Lokasi Item" AllowBlank="false" MaxLength="10"
                      Width="100" />--%>
                      
                    <%--<ext:ComboBox ID="cbItemLocDtl" runat="server" FieldLabel="Lokasi Item" ItemSelector="tr.search-item"
                      ListWidth="450" DisplayField="c_locno" ValueField="c_locno" AllowBlank="true"
                      ForceSelection="false" MinChars="3">
                      <CustomConfig>
                        <ext:ConfigItem Name="allowBlank" Value="true" />
                      </CustomConfig>
                      <Store>
                        <ext:Store ID="Store9" runat="server">
                          ...
                          <BaseParams>
                            <ext:Parameter Name="start" Value="={0}" />
                            <ext:Parameter Name="limit" Value="-1" />
                            <ext:Parameter Name="model" Value="0260" />
                            <ext:Parameter Name="parameters" Value="[['gdg', #{hfGudang}.getValue(), 'System.Char'],
                                                          ['item', #{cbItemDtl}.getValue(), 'System.String'],
                                                          ['batch', #{cbBatDtl}.getValue(), 'System.String'],
                                                          ['@contains.c_locno.Contains(@0) || @contains.c_locno.Contains(@0)', paramTextGetter(#{cbItemLocDtl}), '']]"
                              Mode="Raw" />
                            <ext:Parameter Name="sort" Value="c_iteno" />
                            <ext:Parameter Name="dir" Value="ASC" />
                          </BaseParams>
                          <Reader>
                            <ext:JsonReader IDProperty="c_locno" Root="d.records" SuccessProperty="d.success"
                              TotalProperty="d.totalRows">
                              <Fields>
                                <ext:RecordField Name="c_gdg" />
                                <ext:RecordField Name="c_iteno" />
                                <ext:RecordField Name="c_batch" />
                                <ext:RecordField Name="n_gqty" />
                                <ext:RecordField Name="c_locno" />
                              </Fields>
                            </ext:JsonReader>
                          </Reader>
                        </ext:Store>
                      ...
                      <Template ID="Template5" runat="server">
                        ...
                        <table cellpading="0" cellspacing="0" style="width: 350px">
                        <tr>
                          <td class="body-panel">Gudang</td><td class="body-panel">Item</td><td class="body-panel">Batch</td>
                          <td class="body-panel">Qty</td><td class="body-panel">Lokasi</td>
                        </tr>
                        <tpl for="."><tr class="search-item">
                          <td>{c_gdg}</td><td>{c_iteno}</td><td>{c_batch}</td>
                          <td>{n_gqty}</td><td>{c_locno}</td>
                        </tr></tpl>
                        </table>
                        </Html>
                        <Functions>
                    ...
                    <ext:Button ID="btnAdd" runat="server" FieldLabel="&nbsp;" LabelSeparator=" " ToolTip="Add"
                      ...
                      <Listeners>
                        ...
                        <%--<Click Handler="storeToDetailGridMulti(#{frmpnlDetailEntry}, #{gridDetail}, #{cbItemDtl}, #{cbSpcDtl}, #{hfTypDtl}, #{cbBatDtl}, #{cbItemLocDtl}, #{txQtyDtl}, #{cbItemDtl}, #{cbSpcDtl}, #{hfExpire}, #{hfSPDate});" />--%>
                        <%--End 20171120--%>
                      </Listeners>
                    </ext:Button>
            ...
            <ext:GridPanel ID="gridDetail" runat="server">
              ...
              <ColumnModel>
                <Columns>
                  ...
                  <%--Indra 20171120 Ulujami--%>
                  <%--<ext:Column DataIndex="c_locno" Header="Lokasi Item" Width="150" />--%>
                  <%--End 20171120 Ulujami--%>
