...
public partial class transaksi_wp_SerahTerimaBASPBAdmCtrl : System.Web.UI.UserControl
{
    #region Private
            ...
            case "Add":
                {
                    ...
                    string[][] paramX = new string[][]
                    {
                        ...
                        new string[] { "c_grouped", "ST_BASPBAdm", "System.String"}
                    };
    ...
    private void PopulateDetail(string pName, string pID)
    {
        ...
        try
        {
            ...
            if (dicResult.ContainsKey("records") && (dicResult.ContainsKey("totalRows") && (((long)dicResult["totalRows"]) > 0)))
            {
                ...
                wndIDUser.Title = string.Concat("Serah Terima Admin BASPB - ", pID);
        ...
        {
            System.Diagnostics.Debug.WriteLine(
              string.Concat("transaction_wp_SerahTerima_BASPBAdm:PopulateDetail Header - ", ex.Message));
        }
        finally
        {
            if (jarr != null)
        ...
        {
            System.Diagnostics.Debug.WriteLine(
              string.Concat("transaction_wp_SerahTerima_BASPBAdm:PopulateDetail Detail - ", ex.Message));
        }
    ...
    {
        wndIDUser.Title = "Serah Terima Admin BASPB";
        hfSTNo.Clear();
    ...
    private PostDataParser.StructureResponse SaveParser(bool isAdd, bool isConfirm, string plNumber, Dictionary<string, string>[] dics)
    {
        ...
        pair.DicAttributeValues.Add("Tipe", "08");
        ...
        {
            Scms.Web.Common.Logger.WriteLine("transaksi_wp_SerahTerimaBASPBAdmCtrl SaveParser : {0} ", ex.Message);
        }
        string result = null;
