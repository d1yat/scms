<%@ Control Language="C#" AutoEventWireup="true" CodeFile="SerahTerimaInkJetCtrl.ascx.cs"
    Inherits="transaksi_wp_SerahTerimaInkJetCtrl" %>

<script type="text/javascript">
    var storeToDetailGridInkJet = function(frm, grid, transNo) {
                                ...
                                <ext:FormPanel ID="frmpnlDetailEntry" runat="server" Frame="True" Layout="ColumnLayout"
                                    ...
                                    <Items>
                                        ...
                                        <ext:Button ID="btnAdd" runat="server" FieldLabel="&nbsp;" LabelSeparator=" " ToolTip="Add"
                                            Icon="Add">
                                            <Listeners>
                                                <Click Handler="storeToDetailGridInkJet(#{frmpnlDetailEntry}, #{gridDetail}, #{cbNoDtl});" />
                                            </Listeners>
                                        </ext:Button>
