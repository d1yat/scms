...
public partial class transaksi_wp_SerahTerimaCPRCtrl : System.Web.UI.UserControl
{
    #region Private
    ...
    private void PopulateDetail(string pName, string pID)
    {
        ...
        try
        {
            ...
            if (dicResult.ContainsKey("records") && (dicResult.ContainsKey("totalRows") && (((long)dicResult["totalRows"]) > 0)))
            {
                ...
                wndIDUser.Title = string.Concat("Serah Terima CPR - ", pID);
        ...
        {
            System.Diagnostics.Debug.WriteLine(
              string.Concat("transaction_wp_SerahTerima_CPR:PopulateDetail Detail - ", ex.Message));
        }
    ...
    {
        wndIDUser.Title = "Serah Terima CPR";
        hfSTNo.Clear();
    ...
    private PostDataParser.StructureResponse SaveParser(bool isAdd, bool isConfirm, string plNumber, Dictionary<string, string>[] dics)
    {
        ...
        pair.DicAttributeValues.Add("EntryName", "TEAM FA");
        ...
        pair.DicAttributeValues.Add("Tipe", "09");
        ...
        {
            Scms.Web.Common.Logger.WriteLine("transaksi_wp_SerahTerimaCPRCtrl SaveParser : {0} ", ex.Message);
        }
        string result = null;
                    ...
                    if (respon.Values != null)
                    {
                        ...
                        if (!string.IsNullOrEmpty(storeId))
                        {
                            scrpt = string.Format(@"{0}.insert(0, new Ext.data.Record({{
                                        ...
                                        hfGudangDesc.Text, dateJs, "TEAM FA", txNamePenyerah.Text);
    ...
    protected void OnSelectGrid(object sender, DirectEventArgs e)
    {
        ...
        tmp = string.Format(@"var xOpts = {{
                                  params: {{
                                      ...
                                      sort: '',
                                      dir: '',
                                      parameters: [['c_rsno = @0', '{0}', 'System.String']]
                                    }}
                                  }};", pName.ToString());
        X.AddScript(tmp);
