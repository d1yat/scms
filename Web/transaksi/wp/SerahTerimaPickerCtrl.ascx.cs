...
public partial class transaksi_wp_SerahTerimaPickerCtrl : System.Web.UI.UserControl
{
    #region Private
            ...
            case "Add":
                {
                    ...
                    string[][] paramX = new string[][]
                    {
                        ...
                        //new string[] { "c_grouped", "ST_PICKER", "System.String"}
                    };
    ...
    private void PopulateDetail(string pName, string pID)
    {
        ...
        {
            System.Diagnostics.Debug.WriteLine(
              string.Concat("transaction_wp_SerahTerima:PopulateDetail Header - ", ex.Message));
        }
        finally
        {
            if (jarr != null)
        ...
        {
            System.Diagnostics.Debug.WriteLine(
              string.Concat("transaction_wp_SerahTerima:PopulateDetail Detail - ", ex.Message));
        }
    ...
    private PostDataParser.StructureResponse SaveParser(bool isAdd, bool isConfirm, string plNumber, Dictionary<string, string>[] dics)
    {
        ...
        pair.DicAttributeValues.Add("EntryName", "TEAM PICKER");        
        ...
        {
            Scms.Web.Common.Logger.WriteLine("transaksi_wp_SerahTerimaPickerCtrl SaveParser : {0} ", ex.Message);
        }
        string result = null;
    ...
    {
        bool isOk = false;
        //string sPass = GlobalCrypto.Crypt1WayMD5String(txPassword.Text.Trim());

        //if (!string.IsNullOrEmpty(txPassword.Text))
        //    isOk = sPass.Equals(passPenyerah);
        ...
        //else
        //    e.ErrorMessage = "Kata kunci salah.";
    }
    ...
    protected void SaveBtn_Click(object sender, DirectEventArgs e)
    {
        ...
        if (respon.IsSet)
        {
            if (respon.Response == PostDataParser.ResponseStatus.Success)
            {
                    ...
                    if (respon.Values != null)
                    {
                        ...
                        if (!string.IsNullOrEmpty(storeId))
                        {
                            scrpt = string.Format(@"{0}.insert(0, new Ext.data.Record({{
                                        ...
                                        hfGudangDesc.Text, dateJs, "TEAM PICKER", txNamePenyerah.Text);
                ...
                if (!string.IsNullOrEmpty(sTransSalah))
                {
                    ...
                    Functional.ShowAlert("Data sebagian berhasil tersimpan, " + sTransSalah + " " + Environment.NewLine + "Mohon dicek kembali dikarenakan : " +
                        ...
                        Environment.NewLine + "2.atau PL sudah jadi DO" +
                        Environment.NewLine + "3.atau SJ sudah diconfirm");
                }
                else
                {
            ...
            else
            {
                ...
                {
                    e.ErrorMessage = "PL/SJ tidak ada atau PL sudah jadi DO atau SJ sudah diconfirm";
                }
                else
                {
