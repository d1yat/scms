<%@ Control Language="C#" AutoEventWireup="true" CodeFile="SerahTerimaBASPBGdgCtrl.ascx.cs" Inherits="transaksi_wp_SerahTerimaBASPBGdgCtrl" %>
                        ...
                        <ext:Toolbar ID="Toolbar1" runat="server">
                            <Items>
                                <ext:FormPanel ID="frmpnlDetailEntry" runat="server" Frame="True" Layout="ColumnLayout"
                                    ...
                                    <Items>
                                        <ext:TextField ID="txPBBR" runat="server" AllowBlank="false" FieldLabel="No.BASPB">
                                            <DirectEvents>
                                              ...
                                              <Reader>
                                                <ext:JsonReader TotalProperty="d.totalRows" Root="d.records" SuccessProperty="d.success">
                                                  <Fields>    
                                                    ...
                                                    <ext:RecordField Name="N_QTYDO" />
                                                    <ext:RecordField Name="N_QTYRN" />
                                                    <ext:RecordField Name="N_QTYG" />
                                                    <ext:RecordField Name="N_QTYB" />
                                                    <ext:RecordField Name="N_DIFFDORN" />
                                                  </Fields>
                                                </ext:JsonReader>
                                              </Reader>
                                            </ext:Store>
                                          ...
                                          <ColumnModel>
                                            <Columns>
                                             <%-- <ext:CommandColumn Width="0">
                                              ...
                                              <ext:Column DataIndex="N_QTYDO" Header="Qty DO" />
                                              <ext:Column DataIndex="N_QTYRN" Header="Qty RN Cabang" />
                                              <ext:Column DataIndex="N_QTYG" Header="Qty Good" />
                                              <ext:Column DataIndex="N_QTYB" Header="Qty Bad" />
                                              <ext:Column DataIndex="N_DIFFDORN" Header="Qty Diff" />
                                            </Columns>
                                          </ColumnModel>
                                        </ext:GridPanel>
                                    </Items>
