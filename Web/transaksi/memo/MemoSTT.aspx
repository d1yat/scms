<%@ Page Language="C#" AutoEventWireup="true" CodeFile="MemoSTT.aspx.cs" 
Inherits="transaksi_memo_MemoSTT" MasterPageFile="~/Master.master" %>

<%@ Register Src="MemoSTTDonasiCtrl.ascx" TagName="MemoSTTDonasiCtrl" TagPrefix="uc1" %>
<%@ Register Src="MemoSTTSampleCtrl.ascx" TagName="MemoSTTSampleCtrl" TagPrefix="uc2" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="cphContent" runat="Server">
      ...
      <ext:Panel ID="pnlMainControl" runat="server" Layout="Fit">
        ...
        <Items>
          <ext:GridPanel ID="gridMain" runat="server">
            ...
            <DirectEvents>
              <Command Before="if(command != 'Select') { return false; }">
                <EventMask ShowMask="true" />
                <ExtraParams>
            ...
            <ColumnModel>
              <Columns>
                ...
                <ext:Column ColumnID="v_ket" DataIndex="v_ket" Header="Tipe" Width="100" />
                <ext:Column ColumnID="c_memo" DataIndex="c_memo" Header="Memo" Width="200" />
                <ext:Column ColumnID="Nama" DataIndex="Nama" Header="Applicant" Width="200" />
              </Columns>
            </ColumnModel>
            <View>
  ...
  <uc1:MemoSTTDonasiCtrl ID="MemoSTTDonasiCtrl" runat="server" />
  <uc2:MemoSTTSampleCtrl ID="MemoSTTSampleCtrl" runat="server" />
</asp:Content>
