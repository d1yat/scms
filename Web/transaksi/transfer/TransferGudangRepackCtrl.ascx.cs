...
public partial class transaksi_transfer_TransferGudangRepackCtrl : System.Web.UI.UserControl
{
  #region Private

  private void ClearEntrys()
  {
    winDetail.Title = "Transfer Gudang";
  ...
  private PostDataParser.StructureResponse SaveParser(bool isAdd, string gdgAsal, bool isConfirm, string doNumberID, Dictionary<string, string>[] dics)
  {
    ...
    pair.DicAttributeValues.Add("NoRN", txNoRN.Text);
    ...
    {
      Scms.Web.Common.Logger.WriteLine("transaksi_penjualan_TransferGudangRepackCtrl SaveParser : {0} ", ex.Message);
    }
  ...
  [Ext.Net.DirectMethod(ShowMask = true, Timeout = Constant.DEFAULT_DIRECTEVENT_TIMEOUT)]
  protected void ProcessRN_Click(object sender, DirectEventArgs e)
  {
      string Gudang = (e.ExtraParams["Gudang"] ?? string.Empty);
      string Principal = (e.ExtraParams["Principal"] ?? string.Empty);
      ...
      string[][] paramX = new string[][]{
        ...
        new string[] { "Principal", Principal, "System.String"},
    };

      string result = soa.GlobalQueryService(0, -1, true, string.Empty, string.Empty, "0128-a", paramX);
