<%@ Page Language="C#" AutoEventWireup="true" CodeFile="TransferGudangRepack.aspx.cs"
  Inherits="transaksi_transfer_TransferGudangRepack" MasterPageFile="~/Master.master" %>

<%@ Register Src="TransferGudangRepackCtrl.ascx" TagName="TransferGudangRepackCtrl"
  TagPrefix="uc" %>
<%@ Register Src="TransferGudangRepackCtrlPrint.ascx" TagName="TransferGudangRepackCtrlPrint"
  TagPrefix="uc" %>
  <%@ Register Src="TransferGudangRepackConfirmCtrl.ascx" TagName="TransferGudangRepackConfirmCtrl"
   TagPrefix="uc" %>
<asp:Content ID="Content1" ContentPlaceHolderID="cphHead" runat="Server">

  <script type="text/javascript">
    var voidSJDataFromStore = function(rec) {
      if (Ext.isEmpty(rec)) {
        return;
      }
...
<asp:Content ID="Content2" ContentPlaceHolderID="cphContent" runat="Server">
  ...
  <uc:TransferGudangRepackCtrl ID="TransferGudangRepackCtrl" runat="server" />
  <uc:TransferGudangRepackCtrlPrint ID="TransferGudangRepackCtrlPrint" runat="server" />
  <uc:TransferGudangRepackConfirmCtrl ID="TransferGudangRepackConfirmCtrl" runat="server" />
</asp:Content>
