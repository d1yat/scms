...
public partial class transaksi_transfer_TransferKarantinaGudangConfirmCtrl : System.Web.UI.UserControl
{
  private void ClearEntrys()
  {
    winDetail.Title = "Transfer Karantina-Gudang Confirm";
  ...
  private PostDataParser.StructureResponse SaveParser(bool isAdd, bool isConfirm, string gdgAsal, string doNumberID, Dictionary<string, string>[] dics)
  {
    ...
    {
      Scms.Web.Common.Logger.WriteLine("transaksi_penjualan_TransferKarantinaGudangConfirmCtrl SaveParser : {0} ", ex.Message);
    }
