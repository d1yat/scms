...
public partial class transaksi_transfer_TransferGudangKarantinaCtrl : System.Web.UI.UserControl
{
  #region Private
  ...
  private PostDataParser.StructureResponse SaveParser(bool isAdd, string gdgAsal, bool isConfirm, string doNumberID, Dictionary<string, string>[] dics)
  {
    ...
    {
        Scms.Web.Common.Logger.WriteLine("transaksi_penjualan_TransferGudangKarantinaCtrl SaveParser : {0} ", ex.Message);
    }
