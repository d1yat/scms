<%@ Control Language="C#" AutoEventWireup="true" CodeFile="TransferGudangPemusnahanConfirmCtrl.ascx.cs"
  Inherits="transaksi_transfer_TransferGudangPemusnahanConfirmCtrl" %>

<script type="text/javascript">

    var selectedItemBatchPemusnahan = function(combo, rec, txbqty, cbItm, grid) {
    ...
    var changeAsalconf = function(cb, Cbg, Cabang, Memo, Nodok, hfType) {
        ...
        if (!Ext.isEmpty(store)) {
            ...
            if (idx == 0 || idx == 1) {
                ...
                Cbg.setVisible(false);
                Cabang.setVisible(false);
                Cabang.setValue(" ")
              ...
              <Items>
                <ext:ComboBox ID="cbAsalProduk" runat="server" FieldLabel="Asal Produk" ValueField="c_type"
                  ...
                  <Listeners>
                    ...
                    <Change Handler="changeAsalconf(this, #{lbCbg}, #{txCabang}, #{cbMemoHdr}, #{txNoDok}, #{hfType});" />
                  </Listeners>
                </ext:ComboBox>
                ...
                <ext:FormPanel ID="frmpnlDetailEntry" runat="server" Frame="True" Layout="Table"
                  ...
                  <Items>
                    <ext:ComboBox ID="cbItemDtl" runat="server" FieldLabel="Item" Width="200" ItemSelector="tr.search-item"
                      ...
                      <Store>
                        <ext:Store ID="Store1conf" runat="server" AutoLoad="false">
                          <Proxy>
                            <ext:ScriptTagProxy Url="http://localhost:1234/scms/WebJsonP/GlobalQueryJson" Timeout="10000000"
                              CallbackParam="soaScmsCallback" />
                          </Proxy>
                    ...
                    <ext:ComboBox ID="cbBatDtl" runat="server" FieldLabel="Batch" ItemSelector="tr.search-item"
                      ...
                      <Listeners>
                        <TriggerClick Handler="if(index == 0) { reloadData(this); }" />
                        <Select Handler="selectedItemBatchPemusnahan(this, record, #{txBQtyDtl}, #{cbItemDtl}, #{gridDetail})" />
                      </Listeners>
                    </ext:ComboBox>
