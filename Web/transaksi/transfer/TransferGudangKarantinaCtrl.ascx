<%@ Control Language="C#" AutoEventWireup="true" CodeFile="TransferGudangKarantinaCtrl.ascx.cs"
  Inherits="transaksi_transfer_TransferGudangKarantinaCtrl" %>
              ...
              <Store>
                <ext:Store ID="Store1" runat="server" RemotePaging="false">
                  ...
                  <BaseParams>
                    ...
                    <ext:Parameter Name="parameters" Value="[['c_gdg = @0', '4', 'System.Char']]"
                      Mode="Raw" />
                    <ext:Parameter Name="sort" Value="v_gdgdesc" />
                    <ext:Parameter Name="dir" Value="ASC" />
                  </BaseParams>
