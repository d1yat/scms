<%@ Control Language="C#" AutoEventWireup="true" CodeFile="TransferGudangCtrlgd3.ascx.cs"
  Inherits="transaksi_transfer_TransferGudangCtrlGd3" %>
            ...
            <ext:Panel ID="Panel1" runat="server" Padding="5" Layout="Column">
              <Items>
                <ext:Panel ID="Panel2" runat="server" Border="false" Header="false" ColumnWidth=".5"
                  ...
                  <%--  <ext:ComboBox ID="cbGudangFrom" runat="server" FieldLabel="Asal">
                        <CustomConfig>
                            <ext:ConfigItem Name="allowBlank" Value="false"/>
                        </CustomConfig>
