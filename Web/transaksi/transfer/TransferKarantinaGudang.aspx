<%@ Page Language="C#" AutoEventWireup="true" CodeFile="TransferKarantinaGudang.aspx.cs"
  Inherits="transaksi_transfer_TransferKarantinaGudang" MasterPageFile="~/Master.master" %>

<%@ Register Src="TransferKarantinaGudangCtrl.ascx" TagName="TransferKarantinaGudangCtrl"
  TagPrefix="uc" %>
  <%@ Register Src="TransferKarantinaGudangConfirmCtrl.ascx" TagName="TransferKarantinaGudangConfirmCtrl"
   TagPrefix="uc" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="cphContent" runat="Server">
              ...
              <ext:Store ID="storeGridSJ" runat="server" RemoteSort="true" SkinID="OriginalExtStore">
                ...
                <BaseParams>
                  ...
                  <ext:Parameter Name="parameters" Value="[['c_sjno', paramValueGetter(#{txSJFltr}) + '%', ''],
                        ...
                        ['c_gdg = @0', '4' , 'System.Char'],
                        ['c_gdg2 = @0', '1' , 'System.Char'],
  ...
  <uc:TransferKarantinaGudangCtrl ID="TransferKarantinaGudangCtrl" runat="server" />
  <%--<uc:TransferGudangRepackCtrlPrint ID="TransferGudangRepackCtrlPrint" runat="server" />--%>
  <uc:TransferKarantinaGudangConfirmCtrl ID="TransferKarantinaGudangConfirmCtrl" runat="server" />
</asp:Content>
