<%@ Control Language="C#" AutoEventWireup="true" CodeFile="TransferGudangRepackCtrl.ascx.cs"
  Inherits="transaksi_transfer_TransferGudangRepackCtrl" %>

<script type="text/javascript">

  var selectedItemBatch = function(combo, rec, target1, target2) {
  ...
  var validasiTotalPermintaan = function(store, fieldItem, fieldSpg, itemCode, spCode, inpQty, totalSoh) {
    var total = inpQty;
    var idx = 0;
    var rec = '';
    var spc = '';
  ...
  var validasiTotalPermintaan = function(store, itemNo, good, bad, gsoh, bsoh) {
    var gIn = good;
    var bIn = bad;
    var idx = 0;
    var rec = '';
  ...
  var storeToDetailGrid = function(frm, grid, item, batch, Gquantity, Bquantity) {
    ...
    if (!isDup) {
      ...
      if (validasiTotalPermintaan(store, itemNo, godqty, badqty, goodSoh, badSoh)) {
  ...
  var prepareCommands = function(rec, toolbar, valX, conf) {
        ...
        <ext:FormPanel ID="frmHeaders" runat="server" Title="Header" Width="400" Height="175"
          ...
          <Items>
            ...
            <ext:TextField ID="txKeterangan" runat="server" FieldLabel="Keterangan" MaxLength="100"
              Width="400" />
            <ext:TextField ID="txNoRN" runat="server" FieldLabel="Nomor RN" MaxLength="10" Width="100" />       
              ...
              <Items>
                <ext:FormPanel ID="frmpnlDetailEntry" runat="server" Frame="True" Layout="Table"
                  ...
                  <Items>
                    ...
                    <ext:Button runat="server" ID="btnGetData" FieldLabel="&nbsp;" LabelSeparator=" " ToolTip="Get Data dari RN" Icon="Find" Hidden="false">
                        <DirectEvents>
                            <Click OnEvent="ProcessRN_Click" Before="return validasiProses(#{frmHeaders});">
                              <EventMask ShowMask="true" />
                              <ExtraParams>
                                <ext:Parameter Name="Gudang" Value="#{hfGudang}.getValue()" Mode="Raw" />
                                <ext:Parameter Name="Principal" Value="#{cbPrincipalHdr}.getValue()" Mode="Raw" />
                                <ext:Parameter Name="noRN" Value="#{txNoRN}.getValue()" Mode="Raw" />
              ...
              <ColumnModel>
                <Columns>
                  <ext:CommandColumn Width="25">
                    ...
                    <PrepareToolbar Handler="prepareCommands( record, toolbar, #{hfSJNo}.getValue(), #{hfConfMode}.getValue());" />
                  </ext:CommandColumn>
