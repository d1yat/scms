...
CodeFile="TransferGudangKarantinaConfirmCtrl.ascx.cs" 
Inherits="transaksi_transfer_TransferGudangKarantinaConfirmCtrl" %>

<script type="text/javascript">

  var selectedItemBatchConfirmKarantina = function(combo, rec, target1, target2) {
  ...
  var validasiTotalPermintaanConfirmKarantina = function(store, fieldItem, fieldSpg, itemCode, spCode, inpQty, totalSoh) {
    var total = inpQty;
    var idx = 0;
    var rec = '';
    var spc = '';
  ...
  var prepareCommandsConfirmKarantina = function(rec, toolbar, valX) {
  ...
  var voidInsertedDataFromStoreConfirmKarantina = function(rec) {
    if (Ext.isEmpty(rec)) {
      return;
    }
...
//    }
  //  }
  var beforeEditDataConfirmKarantina = function(e) {
    if (e.field == 'v_ket_type_dc') {
      if (e.record.get('l_new') || e.record.get('l_void')) {
        e.cancel = true;
      }
  ...
  var afterEditDataConfirmKarantina = function(e, cb) {
    if (e.field == 'v_ket_type_dc') {
      var stor = cb.getStore();
                ...
                <ext:Store ID="Store1" runat="server" RemotePaging="false">
                  ...
                  <BaseParams>
                    <%--<ext:Parameter Name="start" Value="={0}" />
                          <ext:Parameter Name="limit" Value="={10}" />--%>
                    <ext:Parameter Name="allQuery" Value="true" />
                    <ext:Parameter Name="model" Value="0177" />
                ...
                <ext:FormPanel ID="frmpnlDetailEntry" runat="server" Frame="True" Layout="Table"
                  ...
                  <Items>
                    ...
                    <ext:ComboBox ID="cbBatDtl" runat="server" FieldLabel="Batch" ItemSelector="tr.search-item"
                      ...
                      <Listeners>
                        <TriggerClick Handler="if(index == 0) { reloadData(this); }" />
                        <Select Handler="selectedItemBatchConfirmKarantina(this, record, #{txGQtyDtl}, #{txBQtyDtl})" />
                      </Listeners>
                    </ext:ComboBox>
          ...
          <Items>
            <ext:GridPanel ID="gridDetail" runat="server" Layout="Fit">
              ...
              <ColumnModel>
                <Columns>
                  <ext:CommandColumn Width="25">
                    ...
                    <PrepareToolbar Handler="prepareCommandsConfirmKarantina( record, toolbar, #{hfSJNoConf}.getValue());" />
                  </ext:CommandColumn>
              ...
              <Listeners>
                ...
                <AfterEdit Handler="afterEditDataConfirmKarantina(e, #{cbTypeDcGrd});" />
                <BeforeEdit Handler="beforeEditDataConfirmKarantina(e);" />
              </Listeners>
            </ext:GridPanel>
          </Items>
        </ext:Panel>
