<%@ Control Language="C#" AutoEventWireup="true" CodeFile="ReturCustomerAutoCtrl.ascx.cs" Inherits="transaksi_retur_ReturCustomerAutoCtrl" %>


<script type="text/javascript">
  var selectedItemBatchAuto = function(rec, target) {
  ...
  var storeToDetailGridAuto = function(frm, grid, item, batch, cbDO, tipe, quantity) {
  ...
  var voidInsertedDataFromStoreAuto = function(rec) {
    if (Ext.isEmpty(rec)) {
      return;
    }
        ...
        <ext:Panel ID="pnlGridDetail" runat="server" Title="Daftar Items" Height="150" Layout="Fit">
                  ...
                  <Items>
                    ...
                    <ext:ComboBox ID="cbDO" runat="server" FieldLabel="No. DO" ItemSelector="tr.search-item"
                      ...
                      <Listeners>
                        ...
                        <Select Handler="selectedItemBatchAuto(record, #{txQtyDtl});" />
                      </Listeners>
                    </ext:ComboBox>
                    ...
                    <ext:Button ID="btnAdd" runat="server" FieldLabel="&nbsp;" LabelSeparator=" " ToolTip="Add"
                      ...
                      <Listeners>
                        ...
                        <Click Handler="storeToDetailGridAuto(#{frmpnlDetailEntry}, #{gridDetail}, #{cbItemDtl}, #{cbBatDtl}, #{cbDO}, #{cbTipeDtl}, #{txQtyDtl});" />
                      </Listeners>
                    </ext:Button>
          ...
          <Items>
            <ext:GridPanel ID="gridDetail" runat="server">
              ...
              <Listeners>
                <Command Handler="if(command == 'Delete') { deleteRecordOnGrid(this, record); } else if (command == 'Void') { voidInsertedDataFromStoreAuto(record); }" />
              </Listeners>
            </ext:GridPanel>
          </Items>
        </ext:Panel>
