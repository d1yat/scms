<%@ Page Language="C#" AutoEventWireup="true" CodeFile="ReturCustomerSend.aspx.cs" 
Inherits="transaksi_retur_ReturCustomerSend" MasterPageFile="~/Master.master" %>
                      ...
                      <ext:HeaderColumn Cls="x-small-editor" AutoWidthElement="false">
                        <Component>
                          <ext:Button ID="ClearFilterButton" runat="server" Icon="Cancel" ToolTip="Clear filter">
                            <Listeners>
                              <Click Handler="clearFilterGridHeader(#{gridMain}, #{txPLFltr}, #{txDateFltr}, #{cbGudangFltr}, #{cbCustomerFltr});reloadFilterGrid(#{gridMain});"
