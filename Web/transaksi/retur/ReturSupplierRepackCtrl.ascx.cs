...
public partial class transaksi_retur_ReturSupplierRepackCtrl : System.Web.UI.UserControl
{
  #region Private
  ...
  private void ClearEntrys()
  {
    ...
    winDetail.Title = "Retur Supplier Repack";
  ...
  private void PopulateDetail(string pName, string pID)
  {
    ...
    try
    {
      ...
      if (dicRS.ContainsKey("records") && (dicRS.ContainsKey("totalRows") && (((long)dicRS["totalRows"]) > 0)))
      {
        ...
        winDetail.Title = string.Format("Retur Supplier Repack - {0}", pID);
  ...
  private PostDataParser.StructureResponse SaveParser(bool isAdd, string plNumber, Dictionary<string, string>[] dics, string Gudangid, string Prinsipal, string keterangan)
  {
    ...
    {
      Scms.Web.Common.Logger.WriteLine("transaksi_retur_ReturSupplierRepackCtrl SaveParser : {0} ", ex.Message);
    }
  ...
  protected void Report_OnGenerate(object sender, DirectEventArgs e)
  {
    ...
    {
      DataType = typeof(char).FullName,
      ParameterName = "({LG_RSH.c_type} = '02')",
    ...
    else
    {
      if (rptResult.IsSuccess)
      {
        ...
        string tmpUri = Functional.UriDownloadGenerator(pag,
          rptResult.OutputFile, "Retur Suplier Repack ", rptResult.Extension);
  ...
  protected void Report_Upload_OnGenerate(object sender, DirectEventArgs e)
  {
      ...
      else
      {
          ...
          {
              string tmpUri = Functional.UriDownloadGenerator(pag,
                rptResult.OutputFile, "Retur Suplier Repack Upload", rptResult.Extension);
