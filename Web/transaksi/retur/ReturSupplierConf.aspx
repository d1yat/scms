<%@ Page Language="C#" AutoEventWireup="true" CodeFile="ReturSupplierConf.aspx.cs"
  Inherits="transaksi_retur_ReturSupplierConf" MasterPageFile="~/Master.master" %>

<%@ Register Src="ReturSupplierConfCtrl.ascx" TagName="ReturSupplierConfCtrl" TagPrefix="uc" %>
<%@ Register Src="ReturSupplierPembelianConfirmCtrl.ascx" TagName="ReturSupplierPembelianConfirmCtrl" TagPrefix="uc" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="cphContent" runat="Server">
          ...
          <ext:GridPanel ID="gridMain" runat="server">
            ...
            <Store>
              <ext:Store ID="storeGridRS" runat="server" SkinID="OriginalExtStore" RemoteSort="true">
                ...
                <BaseParams>
                  ...
                  <ext:Parameter Name="model" Value="0052" />
                  ...
                  <%--['l_confirm = @0', true , 'System.Boolean']--%>
                </BaseParams>
                <Reader>
            ...
            <ColumnModel>
              <Columns>
                ...
                <ext:Column ColumnID="c_cprno" DataIndex="c_cprno" Header="No KPR" />
                            ...
                            <Store>
                              <ext:Store runat="server" RemotePaging="false">
                                ...
                                <BaseParams>
                                  ...
                                  <ext:Parameter Name="parameters" Value="[['@contains.c_gdg.Contains(@0) || @contains.v_gdgdesc.Contains(@0)', paramTextGetter(#{cbCustomerHdr}), '']]"
                                    Mode="Raw" />
  ...
  <uc:ReturSupplierConfCtrl ID="ReturSupplierConfCtrl1" runat="server" />
  <uc:ReturSupplierPembelianConfirmCtrl ID="ReturSupplierPembelianConfirmCtrl1" runat="server" />
