<%@ Control Language="C#" AutoEventWireup="true" CodeFile="ReturSupplierPembelianCtrl.ascx.cs"
  Inherits="transaksi_retur_ReturSupplierPembelianCtrl" %>
...
<script type="text/javascript">
  var storeToDetailGrid = function(frm, grid, item, batch, gqty, bqty, ket, kpr, cabang, outlet, reason) {
    ...
    //    var valX = [item.getValue(), batch.getValue(), gqty.getValue(), bqty.getValue(), ket.getValue(), kpr.getValue()];
    //    var fieldX = ['c_iteno', 'c_batch', 'n_gqty', 'n_bqty', 'v_ket', 'c_cprno'];
                ...
                <ext:FormPanel ID="frmpnlDetailEntry" runat="server" Frame="True" Layout="Table"
                  ...
                  <Items>
                    ...
                    <ext:ComboBox ID="cbBatDtl" runat="server" FieldLabel="Batch" ItemSelector="tr.search-item"
                      PageSize="10" Width="100" ListWidth="350" DisplayField="c_batch" ValueField="c_batch">
                      <Store>
                        <ext:Store runat="server">
                          <Proxy>
                            <ext:ScriptTagProxy Url="http://localhost:1234/scms/WebJsonP/GlobalQueryJson" Timeout="10000000"
