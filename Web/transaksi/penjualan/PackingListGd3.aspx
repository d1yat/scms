<%@ Page Title="" Language="C#" MasterPageFile="~/Master.master" AutoEventWireup="true"
  CodeFile="PackingListGd3.aspx.cs" Inherits="transaction_sales_PackingListGd3" %>

<%@ Register Src="PackingListCtrlGd3.ascx" TagName="PackingListCtrlgd3" TagPrefix="uc" %>
<%@ Register Src="PackingListConfirmCtrlgd3.ascx" TagName="PackingListConfirmCtrlgd3" TagPrefix="uc" %>
<%@ Register Src="PackingListAutoCtrlGd3.ascx" TagName="PackingListAutoCtrlgd3" TagPrefix="uc" %>
<%@ Register Src="PackingListMasterBoxGd3.ascx" TagName="PackingListMasterBoxGd3" TagPrefix="uc" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="cphContent" runat="Server">
        ...
        <TopBar>
          <ext:Toolbar runat="server">
            <Items>
              ...
              <ext:Checkbox runat="server" ID="ChkBlmPrint" BoxLabel="Sudah Di Print">
              </ext:Checkbox>
            </Items>
          </ext:Toolbar>
        </TopBar>
            ...
            <Store>
              <ext:Store ID="storeGridPL" runat="server" SkinID="OriginalExtStore" RemoteSort="true">
                ...
                <BaseParams>
                  ...
                  <ext:Parameter Name="model" Value="0001-a" />
                  <ext:Parameter Name="parameters" Value="[['c_plno', paramValueGetter(#{txPLFltr}) + '%', ''],
                    ...
                    ['l_print = @0', paramValueGetter(#{ChkBlmPrint}), 'System.Boolean']]" Mode="Raw" />
                </BaseParams>
                <Reader>
  ...
  <uc:PackingListCtrlgd3 ID="PackingListCtrlGd3" runat="server" />
  <uc:PackingListConfirmCtrlgd3 ID="PackingListConfirmCtrlgd3" runat="server" />
  <uc:PackingListAutoCtrlgd3 ID="PackingListAutoCtrlgd3" runat="server" />
  <uc:PackingListMasterBoxGd3 ID="PackingListMasterBoxgd3" runat="server" />
