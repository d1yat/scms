<%@ Control Language="C#" AutoEventWireup="true" CodeFile="PackingListCtrlGd3.ascx.cs"
  Inherits="transaksi_penjualan_PackingListCtrlGd3" %>
              ...
              <Items>
                <ext:Panel ID="Panel2" runat="server" Border="false" Header="false" ColumnWidth=".5"
                  ...
                  <Items>
                    ...
                    <ext:ComboBox ID="cbLantai" runat="server" FieldLabel="Lantai" DisplayField="v_ket" Hidden="true"
