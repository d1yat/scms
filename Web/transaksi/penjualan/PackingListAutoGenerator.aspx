<%@ Page Language="C#" AutoEventWireup="true" CodeFile="PackingListAutoGenerator.aspx.cs" 
Inherits="transaksi_penjualan_PackingListAutoGenerator" MasterPageFile="~/Master.master" %>
        ...
        <TopBar>
          <ext:Toolbar ID="Toolbar1" runat="server">
            <Items>
              ...
              <ext:ToolbarSeparator />
              <ext:Label Text="Status - " runat="server" ID="Label2"></ext:Label>
