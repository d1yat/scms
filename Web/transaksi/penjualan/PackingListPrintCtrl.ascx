<%@ Control Language="C#" AutoEventWireup="true" CodeFile="PackingListPrintCtrl.ascx.cs"
  Inherits="transaksi_penjualan_PackingListPrintCtrl" %>
  ...
  <Items>
    <ext:FormPanel runat="server" Layout="Form" Padding="5" LabelWidth="150">
      <Items>
        ...
        <ext:CompositeField runat="server" FieldLabel="Nomor Packing List">
          <Items>
      ...
      <DirectEvents>
        <Click OnEvent="Report_OnGenerate">
          ...
          <ExtraParams>
            ...
            <ext:Parameter Name="PLID1" Value="#{plNumber1}.getValue()" Mode="Raw" />
            <ext:Parameter Name="PLID2" Value="#{plNumber2}.getValue()" Mode="Raw" />
