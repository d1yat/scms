...
public partial class transaction_sales_PackingListGd3 : Scms.Web.Core.PageHandler
{
  ...
  public void ShowSavedData(string plNumber, string msg)
  {
    ...
    PackingListCtrlGd3.CommandPopulate(false, plNumber);
  ...
  protected void Page_Init(object sender, EventArgs e)
  {
    if (!this.IsPostBack)
    {
      ...
      {
        PackingListAutoCtrlgd3.Visible = false;
        PackingListPrintCtrl1.Visible = false;
        PackingListConfirmCtrlgd3.Visible = true;
      ...
      {
        PackingListConfirmCtrlgd3.Visible = false;
        PackingListAutoCtrlgd3.Visible = true;
      ...
      else
      {
        PackingListAutoCtrlgd3.Visible = false;
        PackingListConfirmCtrlgd3.Visible = false;
        PackingListCtrlGd3.Visible = true;
  ...
  protected void Page_Load(object sender, EventArgs e)
  {
    if (!this.IsPostBack)
    {
      ...
      if (hfMode.Text.Equals(CONFIRM_MODE))
      {
        ...
        PackingListCtrlGd3.Initialize(this.ActiveGudang, this.ActiveGudangDescription, storeGridPL.ClientID);
        PackingListConfirmCtrlgd3.Initialize(this.ActiveGudang, this.ActiveGudangDescription, storeGridPL.ClientID);
      }
      else if (hfMode.Text.Equals(AUTO_MODE))
      {
        PackingListCtrlGd3.Initialize(this.ActiveGudang, this.ActiveGudangDescription, storeGridPL.ClientID);
        PackingListAutoCtrlgd3.Initialize(this.ActiveGudang, this.ActiveGudangDescription, storeGridPL.ClientID);
      }
      else if (hfMode.Text.Equals(BOX_MODE))
      {
        PackingListCtrlGd3.Initialize(this.ActiveGudang, this.ActiveGudangDescription, storeGridPL.ClientID);
        PackingListMasterBoxgd3.Initialize(this.ActiveGudang, this.ActiveGudangDescription, storeGridPL.ClientID);
      }
  ...
  protected void btnAddNew_OnClick(object sender, DirectEventArgs e)
  {
    ...
    {
      PackingListAutoCtrlgd3.Initialize(this.ActiveGudang, this.ActiveGudangDescription, storeGridPL.ClientID);
      PackingListAutoCtrlgd3.CommandPopulate();
    }
    else if (hfMode.Text.Equals(BOX_MODE))
    {
      PackingListAutoCtrlgd3.Initialize(this.ActiveGudang, this.ActiveGudangDescription, storeGridPL.ClientID);
      PackingListMasterBoxgd3.CommandPopulate(true, null);
    }
    else if (hfMode.Text.Equals(AUTOGEN_MODE))
    {
    ...
    {
      PackingListCtrlGd3.CommandPopulate(true, null);
    }
  }
  ...
  protected void gridMainCommand(object sender, DirectEventArgs e)
  {
    ...
    if (cmd.Equals("Select", StringComparison.OrdinalIgnoreCase))
    {
      if (hfMode.Text.Equals(CONFIRM_MODE))
      {
        PackingListConfirmCtrlgd3.CommandPopulate(false, pID);
      }
      else
      {
        PackingListCtrlGd3.CommandPopulate(false, pID);
      }
    }
