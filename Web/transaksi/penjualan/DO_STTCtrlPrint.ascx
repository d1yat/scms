<%@ Control Language="C#" AutoEventWireup="true" CodeFile="DO_STTCtrlPrint.ascx.cs" 
Inherits="transaksi_penjualan_DO_STTCtrlPrint" %>
    ...
    <ext:FormPanel runat="server" Layout="Form" Padding="5" LabelWidth="150">
      <Items>
        <ext:ComboBox ID="cbCustomer" runat="server" DisplayField="v_cunam" ValueField="c_cusno"
          ...
          AllowBlank="false" FieldLabel="Cabang" ForceSelection="false">
          <CustomConfig>
        ...
        <ext:CompositeField runat="server" FieldLabel="Nomor DO">
          <Items>
