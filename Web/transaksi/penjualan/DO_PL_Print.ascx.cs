...
public partial class transaksi_penjualan_DO_PL_Print : System.Web.UI.UserControl
{
  ...
  {
    winPrintDetail.Title = "Cetak Delivery Order";
  ...
  protected void Report_OnGenerate(object sender, DirectEventArgs e)
  {
    ...
    else
    {
      if (rptResult.IsSuccess)
      {
        ...
        {
          string rptName = string.Concat("Delivery Order ", pag.Nip, ".", rptResult.Extension);
