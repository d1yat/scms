<%@ Control Language="C#" AutoEventWireup="true" CodeFile="PMCtrl.ascx.cs" Inherits="transaksi_pm_PMCtrl" %>
...
<ext:Window ID="winDetail" runat="server" Height="480" Width="800" Hidden="true"
  ...
  <Content>
    ...
    <ext:Hidden ID="hfPMNo" runat="server" />
      ...
      <North MinHeight="175" MaxHeight="175" Collapsible="false">
        <ext:FormPanel ID="frmHeaders" runat="server" Title="Header" Height="125" Padding="10">
          <Items>
            ...
            <ext:TextField ID="txMemo" runat="server" FieldLabel="No.Memo" MaxLength="50" Width="200" />
            <ext:TextField ID="txKeterangan" runat="server" FieldLabel="Keterangan" MaxLength="100" Width="400" />
          </Items>
        </ext:FormPanel>
      </North>
                      ...
                      <Store>
                        <ext:Store runat="server">
                          ...
                          <BaseParams>
                            ...
                            <ext:Parameter Name="model" Value="9031" />
                    ...
                    <ext:ComboBox ID="cbBatDtl" runat="server" FieldLabel="Batch" ItemSelector="tr.search-item"
                      ...
                      <Store>
                        <ext:Store runat="server">
                          ...
                          <BaseParams>
                            <ext:Parameter Name="start" Value="={0}" />
                            <ext:Parameter Name="limit" Value="10" />
                            <ext:Parameter Name="model" Value="9032" />
                            <ext:Parameter Name="parameters" Value="[['gdg', #{hfGudang}.getValue(), 'System.Char'],
                      ...
                      <Template ID="Template3" runat="server">
                        ...
                        <tpl for="."><tr class="search-item">
                            ...
                            <td>{n_bsisa:this.formatNumber}</td>
                        </tr></tpl>
                        </table>
                        </Html>
                        <Functions>
              ...
              <Store>
                <ext:Store ID="Store5" runat="server" RemotePaging="false" RemoteSort="false">
                  ...
                  <BaseParams>
                    ...
                    <ext:Parameter Name="model" Value="0321" />
                    <ext:Parameter Name="sort" Value="" />
                    <ext:Parameter Name="dir" Value="" />
                    <ext:Parameter Name="parameters" Value="[['c_pmno = @0', #{hfPMNo}.getValue(), 'System.String']]"
                      Mode="Raw" />
                  </BaseParams>
                  <Reader>
              ...
              <ColumnModel>
                <Columns>
                  <ext:CommandColumn Width="25">
                    ...
                    <PrepareToolbar Handler="prepareCommands(record, toolbar, #{hfPMNo}.getValue());" />
                  </ext:CommandColumn>
    ...
    <ext:Button ID="btnPrint" runat="server" Icon="Printer" Text="Cetak">
      <DirectEvents>
        <Click OnEvent="Report_OnGenerate" Before="return verifyHeaderAndDetail(#{frmHeaders},#{gridDetail});">
          ...
          <ExtraParams>
            <ext:Parameter Name="NumberID" Value="#{hfPMNo}.getValue()" Mode="Raw" />
          </ExtraParams>
        </Click>
      </DirectEvents>
    </ext:Button>
