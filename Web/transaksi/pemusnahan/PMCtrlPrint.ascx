<%@ Control Language="C#" AutoEventWireup="true" CodeFile="PMCtrlPrint.ascx.cs" 
Inherits="transaksi_pemusnahan_PMCtrlPrint" %>
<ext:Window ID="winPrintDetail" runat="server" Height="150" Width="390" Hidden="true"
  ...
  <Items>
    <ext:FormPanel runat="server" Layout="Form" Padding="5" LabelWidth="150">
      ...
      <ext:CompositeField runat="server" FieldLabel="Nomor Pemusnahan">
        <Items>
