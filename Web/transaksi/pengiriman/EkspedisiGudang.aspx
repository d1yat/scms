<%@ Page Language="C#" AutoEventWireup="true" CodeFile="EkspedisiGudang.aspx.cs" 
Inherits="transaksi_pengiriman_EkspedisiGudang" MasterPageFile="~/Master.master" %>

<%@ Register Src="EkspedisiGudangCtrl.ascx" TagName="EkspedisiGudangCtrl" TagPrefix="uc" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="cphContent" runat="Server">
                      ...
                      <ext:HeaderColumn Cls="x-small-editor" AutoWidthElement="false">
                        <Component>
                          <ext:Button ID="ClearFilterButton" runat="server" Icon="Cancel" ToolTip="Clear filter">
                            <Listeners>
                              <Click Handler="clearFilterGridHeader(#{GridMain}, #{txEXPFltr}, #{txDateFltr},#{cbGudang}, #{cbGudangFltr},#{cbViaFltr}, #{cbEksFltr}, #{txResiFltr});reloadFilterGrid(#{gridMain});"
  ...
  <uc:EkspedisiGudangCtrl ID="EkspedisiGudangCtrl" runat="server" />
</asp:Content>
