<%@ Page Language="C#" MasterPageFile="~/Master.master" AutoEventWireup="true" CodeFile="EkspedisiPrincipal.aspx.cs"
  Inherits="transaksi_pengiriman_EkspedisiPrincipal" %>
...
//    }
    ...
    var voidInsertedDataFromStoreEP = function(rec, grid2, totKoli, totBerat, totVol) {
      if (Ext.isEmpty(rec)) {
        return;
      }
...
//        vd.setVisible(false);
    ...
    var testingsdfg = function(gridsd)
    {
      ...
      var sdf = kd.getSelected().data.c_rsno;
      var sd = '';
    };
    
    var recalc = function(grid2, totKoli, totBerat, totVol) {
...
<asp:Content ID="Content2" ContentPlaceHolderID="cphContent" runat="Server">
          ...
          <ext:GridPanel runat="server" ID="gridMain">
            ...
            <Store>
              <ext:Store ID="strGridMain" runat="server" RemotePaging="true" RemoteSort="true"
                ...
                <BaseParams>
                  ...
                  <ext:Parameter Name="model" Value="0216" />
                  <ext:Parameter Name="parameters" Value="[['c_expno', paramValueGetter(#{txEXPFltr}) + '%', ''],
                    ...
                    ['c_cusno2 = @0', paramValueGetter(#{cbSuplierFltr}) , 'System.String'],
            ...
            <ColumnModel>
              <Columns>
                ...
                <ext:Column ColumnID="v_nama" DataIndex="v_nama" Header="Principal" Width="150" />
                      ...
                      <ext:HeaderColumn Cls="x-small-editor" AutoWidthElement="false">
                        <Component>
                          <ext:Button ID="ClearFilterButton" runat="server" Icon="Cancel" ToolTip="Clear filter">
                            <Listeners>
                              <Click Handler="clearFilterGridHeader(#{GridMain}, #{txEXPFltr}, #{txDateFltr},#{cbGudang}, #{cbSuplierFltr},#{cbViaFltr}, #{cbEksFltr}, #{txResiFltr});reloadFilterGrid(#{gridMain});"
  ...
  <ext:Window ID="winDetail" runat="server" Height="480" Width="900" Hidden="true"
    Maximizable="true" MinHeight="520" MinWidth="750" Layout="Fit">
    <Items>
      <ext:BorderLayout ID="bllayout" runat="server">
        <North MinHeight="210" Collapsible="false">
          <ext:FormPanel ID="frmHeaders" Title="Header" runat="server" Layout="Column" MinHeight="260">
            <Items>
              <ext:Panel ID="Panel1" runat="server" Border="false" Header="false" ColumnWidth=".5"
                ...
                <ext:ComboBox ID="cbPrincipalHdr" runat="server" FieldLabel="Pemasok" ValueField="c_nosup"
                  DisplayField="v_nama" Width="300" ListWidth="300" PageSize="10"
                ...
                <ext:ComboBox ID="cbCustomerHdr" runat="server" FieldLabel="Kota" DisplayField="v_cunam"
                  ...
                  <ext:ComboBox ID="cbByHdr" runat="server" FieldLabel="Oleh" DisplayField="v_ket" Width="250"
                  ...
                  <Items>
                    ...
                    <Listeners>
                      ...
                      <%--<Change Handler="clearRelatedComboRecursive(true, #{cbRSDtl});#{gridDetail}.getStore().removeAll();" />--%>                      
                    </Listeners>
                  </ext:ComboBox>
              ...
              <ext:Panel ID="Panel2" runat="server" Border="false" Layout="Form" ColumnWidth=".5"
                ...
                <Items>
                  ...
                  <ext:NumberField ID="txBerat" runat="server" FieldLabel="Berat" AllowBlank="false"
                    AllowNegative="false" />
                  <ext:NumberField ID="txVol" runat="server" FieldLabel="Volume" AllowBlank="false"
                    AllowNegative="false" />
              ...
              <ext:Toolbar ID="Toolbar2" runat="server">
                <Items>
                  <ext:FormPanel ID="frmpnlDetailEntry" runat="server" Frame="True" Layout="Table"
                    ...
                    <Items>
                      <ext:ComboBox ID="cbRSDtl" runat="server" FieldLabel="RS" ItemSelector="tr.search-item"
                        DisplayField="c_rsno" ValueField="c_rsno" MinChars="3" PageSize="10" ListWidth="300"
                        ...
                        <Store>
                          <ext:Store ID="Store7" runat="server" AutoLoad="false">
                            ...
                            <BaseParams>
                              <ext:Parameter Name="start" Value="={0}" />
                              <ext:Parameter Name="limit" Value="10" />
                              <ext:Parameter Name="model" Value="5014" />
                              <ext:Parameter Name="parameters" Value="[['@contains.c_rsno.Contains(@0)', paramTextGetter(#{cbRSDtl}), ''],
                                                  ['nosup', #{cbPrincipalHdr}.getValue(), 'System.String'],
                                                  ['gdg', #{hfGdg}.getValue(), 'System.Char']]"
                                Mode="Raw" />
                              <ext:Parameter Name="sort" Value="c_rsno" />
                              <ext:Parameter Name="dir" Value="ASC" />
                            </BaseParams>
                            <Reader>
                        ...
                        <DirectEvents>
                          <SpecialKey OnEvent="Submit_scane" Before="return e.getKey() == Ext.EventObject.ENTER;" Buffer="250" Delay="250">
                            <ExtraParams>
                              <ext:Parameter Name="DO" Value="#{cbRSDtl}.getText()" Mode="Raw" />
                    ...
                    <ext:Button ID="btnAdd" runat="server" FieldLabel="&nbsp;" LabelSeparator=" " ToolTip="Add"
                        ...
                        <Listeners>
                          <Click Handler="storeToDetailGrid(#{frmpnlDetailEntry}, #{gridDetail}, #{cbRSDtl}, #{hfNo}, #{txBeratInp}, #{txKoliInp}, #{txVolInp}, #{gridDetail2}, #{hfHitPart}, #{txKoli}, #{txBerat}, #{txVol});" />
                        </Listeners>
                      </ext:Button>
                  ...
                  <ext:Panel ID="Panel3" runat="server" ColumnWidth="0.60" Layout="FitLayout">
                      <Items>
                        <ext:GridPanel ID="gridDetail2" runat="server">
                          ...
                          <Listeners>
                            <Command Handler="if(command == 'Delete') { deleteOnGrid(this, record); } else if (command == 'Void') { voidInsertedDataFromStoreEP(record, #{gridDetail2},#{txKoli}, #{txBerat}, #{txVol}); }" />
                            <AfterEdit Handler="recalc(#{gridDetail2},#{txKoli}, #{txBerat}, #{txVol});" />
                          </Listeners>
                          <%--<DirectEvents>
