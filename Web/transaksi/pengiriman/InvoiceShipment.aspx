<%@ Page Title="" Language="C#" MasterPageFile="~/Master.master" AutoEventWireup="true"
  CodeFile="InvoiceShipment.aspx.cs" Inherits="transaksi_InvoiceShipment" %>


<%@ Register Src="InvoiceShipmentCtrl.ascx" TagName="InvoiceShipmentCtrl" TagPrefix="uc1" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="cphContent" runat="Server">
            ...
            <DirectEvents>
              <Command OnEvent="gridMainCommand" Before="if(command != 'Select') { return false; }">
                ...
                <ExtraParams>
                  ...
                  <ext:Parameter Name="Parameter" Value="c_feno" />
                  <ext:Parameter Name="PrimaryID" Value="record.data.c_feno" Mode="Raw" />
                </ExtraParams>
              </Command>
            </DirectEvents>
            <SelectionModel>
            ...
            <Store>
              <ext:Store ID="storeGridMain" runat="server" RemoteSort="true" SkinID="OriginalExtStore">
                ...
                <BaseParams>
                  ...
                  <ext:Parameter Name="parameters" Value="[['c_feno', paramRawValueGetter(#{txFakturIDFltr}) + '%', ''],
                ...
                <Reader>
                  <ext:JsonReader TotalProperty="d.totalRows" Root="d.records" SuccessProperty="d.success"
                    IDProperty="c_feno">
                    <Fields>
                      <ext:RecordField Name="c_feno" />
                      <ext:RecordField Name="c_fe" />
                      <ext:RecordField Name="d_fedate" Type="Date" DateFormat="M$" />
                ...
                <SortInfo Field="c_feno" Direction="DESC" />
              </ext:Store>
            </Store>
            <ColumnModel>
              <Columns>
                ...
                <ext:Column ColumnID="c_feno" DataIndex="c_feno" Header="Nomor" />
                <ext:Column ColumnID="c_fe" DataIndex="c_fe" Header="Faktur" />
                <ext:DateColumn ColumnID="d_fedate" DataIndex="d_fedate" Header="Tanggal" Format="dd-MM-yyyy" />
  ...
  <uc1:InvoiceShipmentCtrl ID="InvoiceShipmentCtrl1" runat="server" />
</asp:Content>
