...
public partial class transaksi_FakturEkspedisi : Scms.Web.Core.PageHandler
{
  ...
  protected void Page_Load(object sender, EventArgs e)
  {
    if (!this.IsPostBack)
    {
      FakturEkspedisiCtrl1.Initialize(storeGridMain.ClientID);
  ...
  protected void gridMainCommand(object sender, DirectEventArgs e)
  {
    ...
    {
        FakturEkspedisiCtrl1.CommandPopulate(false, pID);
    }
  ...
  protected void btnAddNew_OnClick(object sender, DirectEventArgs e)
  {
    ...
    FakturEkspedisiCtrl1.CommandPopulate(true, null);
  }
  ...
  protected void btnPrintFaktur_OnClick(object sender, DirectEventArgs e)
  {
      ...
      FakturEkspedisiPrintCtrl1.ShowPrintPage();
  }
