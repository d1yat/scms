...
public partial class transaksi_InvoiceEkspedisiEksternal : Scms.Web.Core.PageHandler
{
  ...
  protected void Page_Load(object sender, EventArgs e)
  {
    if (!this.IsPostBack)
    {
        ...
        InvoiceEkspedisiEksternalCtrl1.Initialize(storeGridMain.ClientID);
  ...
  protected void gridMainCommand(object sender, DirectEventArgs e)
  {
    ...
    {
        InvoiceEkspedisiEksternalCtrl1.CommandPopulate(false, pID);
    }
  ...
  protected void btnAddNew_OnClick(object sender, DirectEventArgs e)
  {
    ...
    InvoiceEkspedisiEksternalCtrl1.CommandPopulate(true, null);
  }
}
