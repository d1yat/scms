...
public partial class transaksi_InvoiceShipment : Scms.Web.Core.PageHandler
{
  ...
  protected void Page_Load(object sender, EventArgs e)
  {
    if (!this.IsPostBack)
    {
      InvoiceShipmentCtrl1.Initialize(storeGridMain.ClientID);
  ...
  protected void gridMainCommand(object sender, DirectEventArgs e)
  {
    ...
    {
        InvoiceShipmentCtrl1.CommandPopulate(false, pID);
    }
  ...
  protected void btnAddNew_OnClick(object sender, DirectEventArgs e)
  {
    ...
    InvoiceShipmentCtrl1.CommandPopulate(true, null);
  }
}
