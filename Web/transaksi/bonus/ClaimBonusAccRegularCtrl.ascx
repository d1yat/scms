...
CodeFile="ClaimBonusAccRegularCtrl.ascx.cs" 
Inherits="transaksi_bonus_ClaimBonusAccRegularCtrl" %>
      ...
      <North MinHeight="125" MaxHeight="125" Collapsible="false">
        <ext:FormPanel ID="frmHeaders" runat="server" Title="Header" Height="175" Padding="10">
          <Items>
            ...
            <ext:DateField Width="180" runat="server" ID="txDayClaimAcc" FieldLabel="Tanggal Prinsipal" 
              ...
              <ext:Store runat="server">
                ...
                <BaseParams>
                  ...
                  <ext:Parameter Name="parameters" Value="[['c_nosup = @0', paramValueGetter(#{cbPrincipalHdr}) , 'System.String'],
                    ...
                    ['@contains.c_claimno.Contains(@0)', paramTextGetter(#{cbNoClaim}), '']]" Mode="Raw" />
              ...
              <DirectEvents>
                <Click OnEvent="SaveBtn_Click">
                  ...
                  <ExtraParams>
                    ...
                    <ext:Parameter Name="PrincipalDesc" Value="#{cbPrincipalHdr}.getText()" Mode="Raw" />
