<%@ Page Language="C#" AutoEventWireup="true" CodeFile="ClaimBonus.aspx.cs"
MasterPageFile="~/Master.master" Inherits="transaksi_bonus_ClaimBonus" %>

<%@ Register Src="ClaimBonusRegularCtrl.ascx" TagName="ClaimBonusRegularCtrl"
 TagPrefix="uc1" %>
 <%@ Register Src="ClaimBonusSTTCtrl.ascx" TagName="ClaimBonusSTTCtrl" 
 TagPrefix="uc2" %>
  <%@ Register Src="ClaimBonusProcessCtrl.ascx" TagName="ClaimBonusProcessCtrl" 
 TagPrefix="uc3" %>

<asp:Content ID="Content1" ContentPlaceHolderID="cphHead" runat="Server">
<script type="text/javascript">
  var voidClaimDataFromStore = function(rec, dm) {
    if (Ext.isEmpty(rec)) {
      return;
    }
          ...
          ShowAsk('Alasan ?', 'Masukkan alasan kenapa harus dibatalkan.',
            function(btnP, txt) {
              if (btnP == 'ok') {
                ...
                Ext.net.DirectMethods.DeleteMethod(rec.get('c_claimno'), txt);
              }
            });
        }
      });
    ...
    <ext:Panel ID="pnlMainControl" runat="server" Layout="Fit">
      ...
      <Items>
        <ext:GridPanel ID="gridMain" runat="server">
          ...
          <Listeners>
            <Command Handler="if(command == 'Delete') { voidClaimDataFromStore(record); }" />
          </Listeners>
          <DirectEvents>
            <Command OnEvent="gridMainCommand" Before="if(command != 'Select') { return false; }">
              ...
              <ExtraParams>
                ...
                <ext:Parameter Name="Parameter" Value="c_claimno" />
                <ext:Parameter Name="PrimaryID" Value="record.data.c_claimno" Mode="Raw" />
              </ExtraParams>
            </Command>
          </DirectEvents>
          <SelectionModel>
          ...
          <Store>
            <ext:Store ID="storeGridClaim" runat="server" SkinID="OriginalExtStore" RemoteSort="true">
              ...
              <BaseParams>
                ...
                <ext:Parameter Name="model" Value="0061" />
                <ext:Parameter Name="parameters" Value="[['c_claimno', paramValueGetter(#{txClaimFltr}) + '%', ''],
                  ['d_claimdate = @0', paramRawValueGetter(#{txDateFltr}) , 'System.DateTime'],
              ...
              <Reader>
                <ext:JsonReader TotalProperty="d.totalRows" Root="d.records" SuccessProperty="d.success"
                  IDProperty="c_claimno">
                  <Fields>
                    <ext:RecordField Name="c_claimno" />
                    <ext:RecordField Name="d_claimdate" Type="Date" DateFormat="M$" />
                    <ext:RecordField Name="t_bulan" Type="Float" />
                    <ext:RecordField Name="s_tahun" Type="Float" />
                    <ext:RecordField Name="n_bruto" Type="Float"/>
              ...
              <SortInfo Field="d_claimdate" Direction="DESC" />
            </ext:Store>
          </Store>
          <ColumnModel>
            <Columns>
              ...
              <ext:Column ColumnID="c_claimno" DataIndex="c_claimno" Header="Nomor" Hideable="false" Width="250" />
              <ext:DateColumn ColumnID="d_claimdate" DataIndex="d_claimdate" Header="Tanggal" Format="dd-MM-yyyy" />
              <ext:Column ColumnID="v_nama" DataIndex="v_nama" Header="Pemasok" />
              <ext:Column ColumnID="s_tahun" DataIndex="s_tahun" Header="Tahun" />
              <ext:Column ColumnID="t_bulan" DataIndex="t_bulan" Header="Bulan" />
              <%--<ext:Column ColumnID="n_bruto" DataIndex="n_bruto" Header="Bruto" />
              <ext:Column ColumnID="n_disc" DataIndex="n_disc" Header="Disc" />
              <ext:Column ColumnID="n_bilva" DataIndex="n_bilva" Header="Total" />--%>
            </Columns>
          </ColumnModel>
          <View>
...
<uc1:ClaimBonusRegularCtrl ID="ClaimBonusRegularCtrl" runat="server" />
</asp:Content>