<%@ Control Language="C#" AutoEventWireup="true" CodeFile="ClaimBonusRegularCtrl.ascx.cs"
  Inherits="transaksi_bonus_ClaimBonusRegularCtrl" %>
            ...
            <ext:GridPanel ID="gridDetail" runat="server">
              ...
              <ColumnModel>
                <Columns>
                  ...
                  <ext:NumberColumn DataIndex="n_salpri" Header="Price" Format="0.000,00/i" Width="75" />
                  <ext:NumberColumn DataIndex="n_disc" Header="Disc" Format="0.000,00/i" Width="75" />
                  <ext:NumberColumn DataIndex="n_net" Header="Net" Format="0.000,00/i" Width="75" />
