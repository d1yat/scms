<%@ Control Language="C#" AutoEventWireup="true" CodeFile="RNKhususCtrl.ascx.cs"
  Inherits="transaksi_penerimaan_RNKhususCtrl" %>
...
<ext:Window ID="winDetail" runat="server" Height="530" Width="825" Hidden="true"
  ...
  <Items>
    ...
    ST Tiket RN Pembelian--%>
      <North MinHeight="220" MaxHeight="220" Collapsible="false">
        <ext:FormPanel ID="frmHeaders" runat="server" Title="Header" Height="220" Padding="10" Layout="Column">
          <Items>
            <ext:Panel runat="server" Border="false" Header="false" ColumnWidth=".5" Layout="Form">
              <Items>
                ...
                <ext:ComboBox ID="cbDoHdr" runat="server" FieldLabel="Nomor Delivery" DisplayField="c_dono"
