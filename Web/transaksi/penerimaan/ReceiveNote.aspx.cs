...
public partial class transaksi_penerimaan_ReceiveNote : Scms.Web.Core.PageHandler
{
  private const string RN_PEMBELIAN = "PEMBELIAN";
  private const string RN_KHUSUS = "KHUSUS";
  private const string RN_RETUR = "RETUR";
  private const string RN_CLAIM = "CLAIM";
  private const string RN_REPACK = "REPACK";
  private const string RN_TRANSFER = "TRANSFER";

  private const string TYPE_RN_PEMBELIAN = "01";
  private const string TYPE_RN_RETUR = "02";
  private const string TYPE_RN_CLAIM = "03";
  private const string TYPE_RN_REPACK = "04";
  private const string TYPE_RN_TRANSFER = "05";
  private const string TYPE_RN_KHUSUS = "01";
  ...
  private Control MyLoadControl()
  {
    ...
    switch (modeValue)
    {
      case RN_KHUSUS:
        ...
        if (c == null)
        {
          c = this.LoadControl("RNKhususCtrl.ascx");
      ...
      case RN_CLAIM:
        ...
        if (c == null)
        {
          c = this.LoadControl("RNClaimCtrl.ascx");
      ...
      default:
        ...
        if (c == null)
        {
          c = this.LoadControl("RNPembelianCtrl.ascx");
  ...
  protected void Page_Init(object sender, EventArgs e)
  {
    if (!this.IsPostBack)
    {
      ...
      if (qryString.Equals("khusus", StringComparison.OrdinalIgnoreCase))
      {
      ...
      else if (qryString.Equals("claim", StringComparison.OrdinalIgnoreCase))
      {
      ...
      case RN_KHUSUS:
        {
          ...
          transaksi_penerimaan_RNKhususCtrl opr = MyLoadControl() as transaksi_penerimaan_RNKhususCtrl;
      ...
      case RN_CLAIM:
        {
          ...
          transaksi_penerimaan_RNClaimCtrl opr = MyLoadControl() as transaksi_penerimaan_RNClaimCtrl;
      ...
      default:
        {
          ...
          transaksi_penerimaan_RNPembelianCtrl opr = MyLoadControl() as transaksi_penerimaan_RNPembelianCtrl;
