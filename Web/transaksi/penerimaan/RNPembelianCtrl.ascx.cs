...
public partial class transaksi_penerimaan_RNPembelianCtrl : System.Web.UI.UserControl
{
  #region Private

  private void ClearEntrys()
  {
    winDetail.Title = "Receive Notes Pembelian";
    ...
    txNoSerahTerimaTiket.Clear();
    txNoSerahTerimaTiket.Disabled = false;
  ...
  private PostDataParser.StructureResponse SaveParser(bool isAdd, string rnNumber, Dictionary<string, string>[] dics, string gudangID, string suplierID, string nomorDO, DateTime tglDO, float bea, bool isFloating, string keterangan, string NoSerahTerimaTiket, string strReguler)
  {
    ...
    pair.DicAttributeValues.Add("TypeRN", "01");
    ...
    try
    {
      varData = parser.ParserData("RNPembelian", (isAdd ? "Add" : "Modify"), dic);
    }
    catch (Exception ex)
    {
  ...
  protected void SaveBtn_Click(object sender, DirectEventArgs e)
  {
    ...
    PostDataParser.StructureResponse respon = SaveParser(isAdd, numberId, gridDataPL, strGdgID, strSuplID, strNumberDO, dateDO, fBea, isFloating, strKeterangan, strNoSerahTerimaTiket, strReguler);
