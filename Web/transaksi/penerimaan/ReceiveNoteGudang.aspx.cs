...
public partial class transaksi_penerimaan_ReceiveNoteGudang : Scms.Web.Core.PageHandler
{
  private PostDataParser.StructureResponse DeleteParser(string gdg, string rnNumber, string ket)
  {
    ...
    {
      Scms.Web.Common.Logger.WriteLine("transaksi_penerimaan_ReceiveNoteGudang DeleteParser : {0} ", ex.Message);
    }
  ...
  public void DeleteMethod(string gudang, string poNumber, string keterangan)
  {
    ...
    if (respon.Response == PostDataParser.ResponseStatus.Success)
    {
      X.AddScript(
        ...
        storeGridRNG.ClientID, poNumber));
  ...
  protected void Page_Load(object sender, EventArgs e)
  {
    if (!this.IsPostBack)
    {
      ReceiveNoteGudangCtrl1.Initialize(storeGridRNG.ClientID);
    }
  }
  ...
  protected void gridMainCommand(object sender, DirectEventArgs e)
  {
    ...
    {
      ReceiveNoteGudangCtrl1.CommandPopulate(false, pID, gdgID);
    }
  ...
  protected void btnAddNew_OnClick(object sender, DirectEventArgs e)
  {
    ...
    ReceiveNoteGudangCtrl1.CommandPopulate(true, null, null);
  }
}
