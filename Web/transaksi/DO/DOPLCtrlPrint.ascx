<%@ Control Language="C#" AutoEventWireup="true" CodeFile="DOPLCtrlPrint.ascx.cs" 
Inherits="transaksi_DO_DOPLCtrlPrint" %>
    ...
    <ext:FormPanel runat="server" Layout="Form" Padding="5" LabelWidth="150">
      <Items>
        <ext:ComboBox ID="cbCustomer" runat="server" DisplayField="v_cunam" ValueField="c_cusno"
          ...
          AllowBlank="true" ForceSelection="false" FieldLabel="Cabang">
          <Store>
