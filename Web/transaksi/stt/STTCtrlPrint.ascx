<%@ Control Language="C#" AutoEventWireup="true" CodeFile="STTCtrlPrint.ascx.cs" 
Inherits="transaksi_stt_STTCtrlPrint" %>
<ext:Window ID="winPrintDetail" runat="server" Height="150" Width="390" Hidden="true"
  ...
  <Items>
    <ext:FormPanel runat="server" Layout="Form" Padding="5" LabelWidth="150">
      ...
      <ext:CompositeField runat="server" FieldLabel="Nomor STT">
        <Items>
          <ext:TextField ID="sttNumber1" runat="server" MaxLength="10" Width="90" />
          <ext:Label runat="server" Text=" - " />
          <ext:TextField ID="sttNumber2" runat="server" MaxLength="10" Width="90" />
        </Items>
      </ext:CompositeField>
          ...
          <DirectEvents>
            <Click OnEvent="Report_OnGenerate">
              ...
              <ExtraParams>
                ...
                <ext:Parameter Name="STTID1" Value="#{sttNumber1}.getValue()" Mode="Raw" />
                <ext:Parameter Name="STTID2" Value="#{sttNumber2}.getValue()" Mode="Raw" />
