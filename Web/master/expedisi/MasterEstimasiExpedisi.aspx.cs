...
public partial class master_expedisi_MasterEstimasiExpedisi : Scms.Web.Core.PageHandler
{
  private PostDataParser.StructureResponse DeleteParser(string Number, string ket)
  {
    ...
    try
    {
      varData = parser.ParserData("MasterExpedisiEstimasi", "Delete", dic);
    }
    catch (Exception ex)
    {
  ...
  public void DeleteMethod(string plNumber, string keterangan)
  {
    ...
    {
      Functional.ShowMsgWarning("Nomor Expedisi tidak terbaca.");
    ...
    if (respon.Response == PostDataParser.ResponseStatus.Success)
    {
      ...
      Functional.ShowMsgInformation(string.Format("Nomor Expedisi '{0}' telah terhapus.", plNumber));
    }
    else
    {
  ...
  protected void Page_Load(object sender, EventArgs e)
  {
    if (!this.IsPostBack)
    {
      MasterEstimasiExpedisiCtrl.Initialize(storeGridExp.ClientID);
    }
  }
  ...
  protected void btnAddNew_OnClick(object sender, DirectEventArgs e)
  {
    ...
    MasterEstimasiExpedisiCtrl.CommandPopulate(true, null);
  }
  ...
  protected void gridMainCommand(object sender, DirectEventArgs e)
  {
    ...
    {
      MasterEstimasiExpedisiCtrl.CommandPopulate(false, pID);
    }
