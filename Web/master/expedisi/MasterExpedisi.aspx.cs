...
public partial class master_expedisi_MasterExpedisi : Scms.Web.Core.PageHandler
{
  private PostDataParser.StructureResponse DeleteParser(string Number, string ket)
  {
    ...
    try
    {
      varData = parser.ParserData("MasterExpedisi", "Delete", dic);
    }
    catch (Exception ex)
    {
  ...
  protected void Page_Load(object sender, EventArgs e)
  {
    if (!this.IsPostBack)
    {
      MasterExpedisiCtrl.Initialize(storeGridExp.ClientID);
    }
  }
  ...
  protected void btnAddNew_OnClick(object sender, DirectEventArgs e)
  {
    ...
    MasterExpedisiCtrl.CommandPopulate(true, null);
  }
  ...
  protected void gridMainCommand(object sender, DirectEventArgs e)
  {
    ...
    {
      MasterExpedisiCtrl.CommandPopulate(false, pID);
    }
