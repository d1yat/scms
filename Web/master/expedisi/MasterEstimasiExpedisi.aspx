<%@ Page Language="C#" AutoEventWireup="true" CodeFile="MasterEstimasiExpedisi.aspx.cs"
  Inherits="master_expedisi_MasterEstimasiExpedisi" MasterPageFile="~/Master.master" %>

<%@ Register Src="MasterEstimasiExpedisiCtrl.ascx" TagName="MasterEstimasiExpedisiCtrl"
  TagPrefix="uc" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="cphContent" runat="Server">
          ...
          <ext:GridPanel ID="gridMain" runat="server">
            ...
            <Store>
              <ext:Store ID="storeGridExp" runat="server" RemoteSort="true" SkinID="OriginalExtStore">
                ...
                <BaseParams>
                  ...
                  <ext:Parameter Name="parameters" Value="[['c_exp', paramRawValueGetter(#{txExpIDFltr}) + '%', ''],
                              ['v_ket = @0', paramRawValueGetter(#{cbEksFltr}) , 'System.String']]"
                    Mode="Raw" />
                </BaseParams>
                <Reader>
                  <ext:JsonReader TotalProperty="d.totalRows" Root="d.records" SuccessProperty="d.success"
                    ...
                    <Fields>
                      ...
                      <ext:RecordField Name="t_udara" Type="Int" />
                      <ext:RecordField Name="t_daratlaut" Type="Int" />
                      <ext:RecordField Name="t_icepack" Type="Int" />
                      <ext:RecordField Name="t_import" Type="Int" />--%>
                    </Fields>
                  </ext:JsonReader>
                </Reader>
            ...
            <ColumnModel>
              <Columns>
                ...
                <ext:Column ColumnID="c_exp" DataIndex="c_exp" Header="No Expedisi" Width="100" />
                <ext:Column ColumnID="v_ket" DataIndex="v_ket" Header="Nama Expedisi" Width="200" />
                <%--<ext:Column ColumnID="c_cusno" DataIndex="c_cusno" Header="Kode Cabang" Width="250" />
                <ext:Column ColumnID="v_cunam" DataIndex="v_cunam" Header="Nama Cabang" Width="100" />
                <ext:Column ColumnID="t_udara" DataIndex="t_udara" Header="Udara" Width="100" />
                <ext:Column ColumnID="t_daratlaut" DataIndex="t_daratlaut" Header="Darat/Laut" Width="100" />
                <ext:Column ColumnID="t_icepack" DataIndex="t_icepack" Header="Ice Pack" Width="50" />--%>
              </Columns>
            </ColumnModel>
            <View>
                      ...
                      <ext:HeaderColumn Cls="x-small-editor" AutoWidthElement="false">
                        <Component>
                          <ext:Button ID="ClearFilterButton" runat="server" Icon="Cancel" ToolTip="Clear filter">
                            <Listeners>
                              <Click Handler="clearFilterGridHeader(#{gridMain}, #{txExpIDFltr}, #{cbEksFltr});reloadFilterGrid(#{gridMain});"
                      ...
                      <ext:HeaderColumn>
                        <Component>
                          <ext:ComboBox ID="cbEksFltr" runat="server" DisplayField="v_ket" ValueField="c_exp"
                            Width="250" MinChars="3" ItemSelector="tr.search-item" PageSize="10" ListWidth="250"
                            AllowBlank="true">
                            <CustomConfig>
  ...
  <uc:MasterEstimasiExpedisiCtrl ID="MasterEstimasiExpedisiCtrl" runat="server" />
</asp:Content>
