<%@ Page Language="C#" AutoEventWireup="true" CodeFile="Gudang.aspx.cs" Inherits="master_gudang_Gudang"
  MasterPageFile="~/Master.master" %>

<%@ Register Src="GudangCtrl.ascx" TagName="GudangCtrl" TagPrefix="uc" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="cphContent" runat="Server">
      ...
      <ext:Panel ID="pnlMainControl" runat="server" Layout="Fit">
        ...
        <Items>
          <ext:GridPanel ID="gridMain" runat="server">
            ...
            <DirectEvents>
              <Command OnEvent="gridMainCommand" Before="if(command != 'Select') { return false; }">
                ...
                <ExtraParams>
                  ...
                  <ext:Parameter Name="Parameter" Value="c_gdg" />
                  <ext:Parameter Name="PrimaryID" Value="record.data.c_gdg" Mode="Raw" />
                </ExtraParams>
              </Command>
            </DirectEvents>
            <SelectionModel>
            ...
            <Store>
              <ext:Store ID="storeGridGudang" runat="server" RemoteSort="true" SkinID="OriginalExtStore">
                <Proxy>
                ...
                <SortInfo Field="c_gdg" Direction="ASC" />
              </ext:Store>
            </Store>
            <ColumnModel>
              <Columns>
                ...
                <ext:Column ColumnID="v_nama" DataIndex="v_nama" Header="Deskripsi" Width="300" />
  ...
  <uc:GudangCtrl runat="server" ID="GudangCtrl1" />
</asp:Content>
