...
public partial class master_prinsipal_MasterDivisiPrinsipal : Scms.Web.Core.PageHandler
{
  ...
  protected void Page_Load(object sender, EventArgs e)
  {
    if (!this.IsPostBack)
    {
      MasterDivisiPrinsipalCtrl.Initialize(storeGridItem.ClientID);
    }
  }
  ...
  protected void btnAddNew_OnClick(object sender, DirectEventArgs e)
  {
    ...
    MasterDivisiPrinsipalCtrl.CommandPopulate(true, null);
  }
  ...
  protected void gridMainCommand(object sender, DirectEventArgs e)
  {
    ...
    {
      MasterDivisiPrinsipalCtrl.CommandPopulate(false, pID);
    }
