<%@ Page Language="C#" AutoEventWireup="true" CodeFile="MasterDivisiPrinsipal.aspx.cs"
  Inherits="master_prinsipal_MasterDivisiPrinsipal" MasterPageFile="~/Master.master" %>

<%@ Register Src="MasterDivisiPrinsipalCtrl.ascx" TagName="MasterDivisiPrinsipalCtrl"
  TagPrefix="uc" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="cphContent" runat="Server">
          ...
          <ext:GridPanel ID="gridMain" runat="server">
            ...
            <ColumnModel>
              <Columns>
                ...
                <ext:Column ColumnID="n_idxp" DataIndex="n_idxp" Header="Pareto" Width="100" />
                <ext:Column ColumnID="n_idxnp" DataIndex="n_idxnp" Header="Non Pareto" Width="100" />
                <ext:Column ColumnID="n_het" DataIndex="n_het" Header="HET." Width="100" />
  ...
  <uc:MasterDivisiPrinsipalCtrl ID="MasterDivisiPrinsipalCtrl" runat="server" />
</asp:Content>
