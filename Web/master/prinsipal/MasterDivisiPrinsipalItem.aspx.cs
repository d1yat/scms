...
public partial class master_prinsipal_MasterDivisiPrinsipalItem : Scms.Web.Core.PageHandler
{
  ...
  public void DeleteMethod(string plNumber, string keterangan)
  {
    ...
    {
      Functional.ShowMsgWarning("Nomor Divisi Supplier tidak terbaca.");
  ...
  protected void Page_Load(object sender, EventArgs e)
  {
    if (!this.IsPostBack)
    {
      MasterDivisiPrinsipalItemCtrl.Initialize(storeGridItem.ClientID);
    }
  }
  ...
  protected void btnAddNew_OnClick(object sender, DirectEventArgs e)
  {
    ...
    MasterDivisiPrinsipalItemCtrl.CommandPopulate(true, null);
  }
  ...
  protected void gridMainCommand(object sender, DirectEventArgs e)
  {
    ...
    {
      MasterDivisiPrinsipalItemCtrl.CommandPopulate(false, pID);
    }
