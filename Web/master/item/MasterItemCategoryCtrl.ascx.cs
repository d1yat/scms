...
public partial class master_item_MasterItemCategoryCtrl : System.Web.UI.UserControl
{
  #region Private

  private void ClearEntrys()
  {
    winDetail.Title = "Master Item Category";
  ...
  private PostDataParser.StructureResponse SaveParser(bool isAdd, string numberId, Dictionary<string, string>[] dics)
  {
    ...
    try
    {
      varData = parser.ParserData("MasterItemCategory", (isAdd ? "Add" : "Modify"), dic);
    }
    catch (Exception ex)
    {
      Scms.Web.Common.Logger.WriteLine("master_item_MasterItemCategoryCtrl SaveParser : {0} ", ex.Message);
    }
