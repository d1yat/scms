<%@ Page Title="" Language="C#" MasterPageFile="~/Master.master" AutoEventWireup="true"
  CodeFile="MasterItemLantai.aspx.cs" Inherits="master_item_MasterItemLantai" %>
<%@ Register Src="MasterItemLantaiCtrl.ascx" TagName="MasterItemLantaiCtrl" TagPrefix="uc" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="cphContent" runat="Server">
            ...
            <Store>
              <ext:Store ID="storeGridMasterTrx" runat="server" RemoteSort="true" SkinID="OriginalExtStore">
                ...
                <BaseParams>
                  ...
                  <ext:Parameter Name="model" Value="0180" />
                            ...
                            <Store>
                              <ext:Store ID="Store1" runat="server">
                                ...
                                <BaseParams>
                                  ...
                                  <ext:Parameter Name="parameters" Value="[['c_notrans = @0', '003', 'System.String'],
 ...
 <uc:MasterItemLantaiCtrl ID="MasterItemLantaiCtrl" runat="server" />
</asp:Content>
