<%@ Control Language="C#" AutoEventWireup="true" CodeFile="MasterItemLantaiCtrl.ascx.cs" 
Inherits="master_item_MasterItemLantaiCtrl" %>
                      ...
                      <Store>
                        <ext:Store runat="server">
                          ...
                          <BaseParams>
                            ...
                            <ext:Parameter Name="model" Value="0174" />
                            <ext:Parameter Name="parameters" Value="[['tipe', #{cbType}.getValue(), 'System.String'],
                                ['gudang', #{cbGudang}.getValue(), 'System.Char'],
                ...
                <ext:Store runat="server" RemotePaging="false" RemoteSort="false">
                  ...
                  <BaseParams>
                    ...
                    <ext:Parameter Name="parameters" Value="[['c_type = @0', #{hfType}.getValue(), 'System.String'],
                        ['c_gdg = @0', #{cbGudang}.getValue(), 'System.Char'],                                        
