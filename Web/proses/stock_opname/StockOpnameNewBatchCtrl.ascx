<%@ Control Language="C#" AutoEventWireup="true" CodeFile="StockOpnameNewBatchCtrl.ascx.cs" Inherits="proses_stock_opname_StockOpnameNewBatchCtrl" %>
  ...
  <Items>
    <ext:FormPanel ID="FormPanel1" runat="server" Layout="Form" Title="New Batch" Padding="5" LabelWidth="150">
      <Items>
        ...
        <ext:TextField ID="txBatch" runat="server" MaxLength="100" Width="100" FieldLabel="Kd. Batch" AllowBlank="false" />
