<%@ Page Language="C#" AutoEventWireup="true" CodeFile="AvgSales.aspx.cs" 
Inherits="proses_avgsales" MasterPageFile="~/Master.master" %>
      ...
      <ext:Panel ID="pnlMainControl" runat="server" AutoScroll="true" Layout="FormLayout"
       ...
       <Buttons>
                 <%-- <ext:Button ID="btnProses" runat="server" Text="Proses" Icon="CogStart">
                    <DirectEvents>
                      <Click OnEvent="SaveBtn_Click" Before="return validasiProses(#{frmHeaders});" Success="onSuccessProcess();">
