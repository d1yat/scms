...
public partial class proses_avgsales : Scms.Web.Core.PageHandler
{
    protected void Page_Load(object sender, EventArgs e)
    {
        if (!this.IsPostBack)
        {
            if (!this.IsPostBack)
            {
                ...
                //DateTime cbBulan = date.AddMonths(-1);
                //Functional.PopulateBulan(cbBulan, date.Month ,1,0);
    ...
    protected void SaveBtn_Click(object sender, DirectEventArgs e)
    {
        ...
        //string cusmas = (e.ExtraParams["cusmas"] ?? string.Empty);
        ...
        string result = soa.GlobalQueryService(0, -1, true, string.Empty, string.Empty, "30005", paramX);
