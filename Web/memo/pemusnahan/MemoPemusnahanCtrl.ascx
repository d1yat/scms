<%@ Control Language="C#" AutoEventWireup="true" CodeFile="MemoPemusnahanCtrl.ascx.cs"
  Inherits="memo_pemusnahan_MemoPemusnahanCtrl" %>
...
<script type="text/javascript">
  ...
  var storeToDetailGridPemusnahan = function(frm, grid, item, Quantity) {
      ...
      <North MinHeight="150" MaxHeight="150" Collapsible="false">
        <ext:FormPanel ID="frmHeaders" runat="server" Title="Header" Height="150" Padding="10">
          <Items>
              ...
              <Store>
                <ext:Store runat="server" RemotePaging="false">
                  ...
                  <BaseParams>
                    ...
                    <ext:Parameter Name="parameters" Value="[['@contains.c_gdg.Contains(@0) || @contains.v_gdgdesc.Contains(@0)', paramTextGetter(#{cbGudangHdr}), '']]"
                      Mode="Raw" />
            ...
            <ext:TextField runat="server" ID="txMemoHdr" Width="300" FieldLabel="No Memorandum" MaxLength="50" />
            <ext:TextField runat="server" ID="txKeteranganHdr" Width="300" FieldLabel="Keterangan" MaxLength="50" />
          </Items>
        </ext:FormPanel>
      </North>
                ...
                <ext:FormPanel ID="frmpnlDetailEntry" runat="server" Frame="True" Layout="Table"
                  ...
                  <Items>
                    ...
                    <ext:Button ID="btnAdd" runat="server" FieldLabel="&nbsp;" LabelSeparator=" " ToolTip="Add"
                      Icon="Add">
                      <Listeners>
                        <Click Handler="storeToDetailGridPemusnahan(#{frmpnlDetailEntry}, #{gridDetail}, #{cbItemDtl}, #{txQtyDtl});" />
                      </Listeners>
                    </ext:Button>
              ...
              <Store>
                <ext:Store ID="Store5" runat="server" RemotePaging="false" RemoteSort="false">
                  ...
                  <BaseParams>
                    ...
                    <ext:Parameter Name="allQuery" Value="true" />
                    <ext:Parameter Name="model" Value="0050a" />
                    <ext:Parameter Name="sort" Value="" />
                    <ext:Parameter Name="dir" Value="" />
                    <ext:Parameter Name="parameters" Value="[['c_mpno = @0', #{hfMemo}.getValue(), 'System.String']]"
                      Mode="Raw" />
                  </BaseParams>
                  <Reader>
              ...
              <ColumnModel>
                <Columns>
                  <ext:CommandColumn Width="25">
                    ...
                    <PrepareToolbar Handler="prepareCommandsDonasi(record, toolbar, #{hfMemo}.getValue());" />
                  </ext:CommandColumn>
