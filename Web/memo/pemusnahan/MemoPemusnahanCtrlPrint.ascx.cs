...
public partial class memo_pemusnahan_MemoPemusnahanCtrlPrint : System.Web.UI.UserControl
{
  public void ShowPrintPage()
  {
    winPrintDetail.Title = "Cetak Memo Pemusnahan Barang";
  ...
  protected void Report_OnGenerate(object sender, DirectEventArgs e)
  {
    ...
    if (!string.IsNullOrEmpty(pm1))
    {
      ...
      else
      {
        ...
        else
        {
          ...
          {
            DataType = typeof(string).FullName,
            ParameterName = string.Format("({{MK_MPH.c_mpno}} IN ('{0}' TO '{1}'))", pm1, pm2),
    ...
    else
    {
      if (rptResult.IsSuccess)
      {
        ...
        {
          string rptName = null;
          rptName = string.Concat("Memo Pemusnahan ", pag.Nip, ".", rptResult.Extension);
