<%@ Page Language="C#" AutoEventWireup="true" CodeFile="MemoPemusnahan.aspx.cs" Inherits="memo_pemusnahan_MemoPemusnahan"
  MasterPageFile="~/Master.master" %>

<%@ Register Src="MemoPemusnahanCtrl.ascx" TagName="MemoPemusnahanCtrl" TagPrefix="uc" %>
<%@ Register Src="MemoPemusnahanCtrlPrint.ascx" TagName="MemoPemusnahanCtrlPrint" TagPrefix="uc" %>
            ...
            ShowAsk('Alasan ?', 'Masukkan alasan kenapa harus dibatalkan.',
              function(btnP, txt) {
                if (btnP == 'ok') {
                  ...
                  Ext.net.DirectMethods.DeleteMethod(rec.get('c_gdg'), rec.get('c_mpno'), txt);
                }
              });
          }
        });
...
<asp:Content ID="Content2" ContentPlaceHolderID="cphContent" runat="Server">
          ...
          <ext:Toolbar ID="Toolbar1" runat="server">
            <Items>
              ...
              <ext:Button ID="btnPrintPL" runat="server" Text="Cetak" Icon="Printer">
                <DirectEvents>
                  <Click OnEvent="btnPrintMP_OnClick">
                    <EventMask ShowMask="true" />
                  </Click>
                </DirectEvents>
              </ext:Button>
            ...
            <DirectEvents>
              <Command OnEvent="gridMainCommand" Before="if(command != 'Select') { return false; }">
                ...
                <ExtraParams>
                  ...
                  <ext:Parameter Name="Parameter" Value="c_mpno" />
                  <ext:Parameter Name="PrimaryID" Value="record.data.c_mpno" Mode="Raw" />
            ...
            <Store>
              <ext:Store ID="storeGridMemo" runat="server" RemoteSort="true" SkinID="OriginalExtStore">
                ...
                <BaseParams>
                  ...
                  <ext:Parameter Name="model" Value="0050" />
                  <ext:Parameter Name="parameters" Value="[['d_mpdate = @0', paramRawValueGetter(#{txDateFltr}) , 'System.DateTime'],
                    ['c_mpno', paramValueGetter(#{txMemoFltr}) + '%', ''],
                    ['c_gdg = @0', paramValueGetter(#{cbGudangFltr}) , 'System.Char']]" Mode="Raw" />
                </BaseParams>
                <Reader>
                  <ext:JsonReader IDProperty="c_mpno" TotalProperty="d.totalRows" Root="d.records" SuccessProperty="d.success">
                    <Fields>
                ...
                <SortInfo Field="c_mpno" Direction="DESC" />
              </ext:Store>
            </Store>
            <ColumnModel>
              <Columns>
                ...
                <ext:Column ColumnID="c_mpno" DataIndex="c_mpno" Header="Nomor" Hideable="false" />
                <ext:DateColumn ColumnID="d_mpdate" DataIndex="d_mpdate" Header="Tanggal" Format="dd-MM-yyyy" />
                ...
                <HeaderRows>
                  <ext:HeaderRow>
                    <Columns>
                      <ext:HeaderColumn Cls="x-small-editor" AutoWidthElement="false">
                        <Component>
                          <ext:Button ID="ClearFilterButton" runat="server" Icon="Cancel" ToolTip="Clear filter">
                            <Listeners>
                              <Click Handler="clearFilterGridHeader(#{gridMain}, #{cbGudangFltr}, #{txMemoFltr}, #{txDateFltr},#{txMemorandumFltr});reloadFilterGrid(#{gridMain});"
                      ...
                      <ext:HeaderColumn>
                        <Component>
                          <ext:TextField ID="txMemorandumFltr" runat="server" EnableKeyEvents="true" AllowBlank="true">
                            <Listeners>
                              <KeyUp Handler="reloadFilterGrid(#{gridMain})" Buffer="700" Delay="700" />
                            </Listeners>
                          </ext:TextField>
  ...
  <uc:MemoPemusnahanCtrl ID="MemoPemusnahanCtrl" runat="server" />
  <uc:MemoPemusnahanCtrlPrint ID="MemoPemusnahanCtrlPrint" runat="server" />  
</asp:Content>
