<%@ Control Language="C#" AutoEventWireup="true" CodeFile="MemoSTTDonasiCtrl.ascx.cs"
  Inherits="memo_stt_MemoSTTDonasiCtrl" %>
...
<script type="text/javascript">
  ...
  var storeToDetailGridDonasi = function(frm, grid, item, Quantity) {
                ...
                <ext:FormPanel ID="frmpnlDetailEntry" runat="server" Frame="True" Layout="Table"
                  ...
                  <Items>
                    ...
                    <ext:Button ID="btnAdd" runat="server" FieldLabel="&nbsp;" LabelSeparator=" " ToolTip="Add"
                      Icon="Add">
                      <Listeners>
                        <Click Handler="storeToDetailGridDonasi(#{frmpnlDetailEntry}, #{gridDetail}, #{cbItemDtl}, #{txQtyDtl});" />
                      </Listeners>
                    </ext:Button>
              ...
              <Store>
                <ext:Store ID="Store5" runat="server" RemotePaging="false" RemoteSort="false">
                  ...
                  <BaseParams>
                    ...
                    <ext:Parameter Name="parameters" Value="[['c_mtno = @0', #{hfMemo}.getValue(), 'System.String']]"
                      Mode="Raw" />
                  </BaseParams>
                  <Reader>
