...
<body>
  ...
  <ext:Desktop ID="MyDesktop" runat="server" BackgroundColor="Black" ShortcutTextColor="White"
    ...
    <Content>
      <ext:Panel ID="pnlSample" runat="server" Title="Sample Panel" Cls="desktopEl" Height="400"
        Width="500" Padding="5" Collapsible="true">
        <Items>
          <ext:BorderLayout ID="BorderLayout1" runat="server">
            ...
            <Center MarginsSummary="5 0 0 0">
              <ext:Panel ID="Panel2" runat="server" Title="Center" Html="<h1>Center</h1>Positioned Panel with BorderLayout"
                Padding="5">
                <BottomBar>
            ...
            <East Collapsible="true" Split="true" MarginsSummary="5 5 0 0" CMarginsSummary="5 5 0 5">
              <ext:Panel ID="Panel3" runat="server" Title="East" Width="150" Layout="Fit">
                <Items>
                  <ext:TabPanel ID="TabPanel1" runat="server" Height="300" TabPosition="Bottom" Border="false">
                    <Items>
                      <ext:Panel ID="Tab1" runat="server" Title="Tab 1" />
                      <ext:Panel ID="Tab2" runat="server" Title="Tab 2" Html="Hello!" Padding="5" />
                    </Items>
                  </ext:TabPanel>
                </Items>
              </ext:Panel>
    ...
    <Modules>
      ...
      <ext:DesktopModule ModuleID="DesktopModule3">
        <Launcher ID="Launcher4" runat="server" Text="Web Browser" Icon="World">
          <Listeners>
      ...
      <ext:DesktopModule ModuleID="DesktopModule3" >
        <Launcher ID="Launcher5" runat="server" Text="Web Browser" Icon="World">
          <Listeners>
    ...
    <Shortcuts>
      <ext:DesktopShortcut ModuleID="DesktopModule1" ShortcutID="Shortcut1" Text="Add Customer" IconCls="shortcut-icon icon-user48" />
  ...
  <ext:DesktopWindow ID="winCustomer" runat="server" Title="Add Customer" InitCenter="false"
    Icon="User" Padding="5" Width="350" Height="200" PageX="100" PageY="25" Layout="Form">
    <Items>
      ...
      <ext:TextField ID="txtLastName" runat="server" FieldLabel="Last Name" Text="Caballero"
        AnchorHorizontal="100%" />
      <ext:TextField ID="txtCompany" runat="server" FieldLabel="Company" Text="Awesome Industries"
        AnchorHorizontal="100%" />
  ...
  <ext:DesktopWindow ID="winCompany" runat="server" InitCenter="false" Title="Company Info"
    ...
    <Items>
      <ext:GridPanel ID="GridPanel1" runat="server" StoreID="Store1" StripeRows="true"
        Border="false" AutoExpandColumn="Company">
  ...
  <ext:DesktopWindow ID="winBrowser" runat="server" Title="Web Browser" Icon="World"
    InitCenter="false" Width="1000" Height="600" PageX="25" PageY="25">
