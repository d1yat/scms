<%@ Page Title="" Language="C#" MasterPageFile="~/Master.master" AutoEventWireup="true"
  CodeFile="FakturBeliRetur.aspx.cs" Inherits="keuangan_faktur_FakturBeliRetur" %>


<%@ Register Src="FakturBeliReturCtrl.ascx" TagName="FakturBeliReturCtrl" TagPrefix="uc1" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="cphContent" runat="Server">
            ...
            <Store>
              <ext:Store ID="storeGridMain" runat="server" RemoteSort="true" SkinID="OriginalExtStore">
                ...
                <BaseParams>
                  ...
                  <ext:Parameter Name="model" Value="0107" />
                  <ext:Parameter Name="parameters" Value="[['c_fbno', paramRawValueGetter(#{txFakturIDFltr}) + '%', ''],
                    ...
                    ['c_rsno', paramValueGetter(#{txRSIDFltr}) + '%', ''],
                    ['c_nosup = @0', paramValueGetter(#{cbSuplierFltr}) , 'System.String'],
                    ['c_exno', paramValueGetter(#{txRefIDFltr}) + '%', ''],
                ...
                <SortInfo Field="d_fbdate" Direction="DESC" />
              </ext:Store>
            </Store>
            <ColumnModel>
              <Columns>
                ...
                <ext:Column ColumnID="c_rsno" DataIndex="c_rsno" Header="No. Retur" />
                <ext:Column ColumnID="v_nama_supl" DataIndex="v_nama_supl" Header="Pemasok" Width="250" />
                ...
                <ext:CheckColumn ColumnID="l_import" DataIndex="l_import" Header="Import" />
              </Columns>
            </ColumnModel>
            <View>
                ...
                <HeaderRows>
                  <ext:HeaderRow>
                    <Columns>
                      <ext:HeaderColumn Cls="x-small-editor" AutoWidthElement="false">
                        <Component>
                          <ext:Button ID="ClearFilterButton" runat="server" Icon="Cancel" ToolTip="Clear filter">
                            <Listeners>
                              <%--20171017 Indra --%>
                              <%--<Click Handler="clearFilterGridHeader(#{gridMain}, #{txFakturIDFltr}, #{txDateFltr}, #{txRefIDFltr}, #{cbSuplierFltr}, #{txVcIDFltr});reloadFilterGrid(#{gridMain});" Buffer="300" Delay="300" />--%>
                              <Click Handler="clearFilterGridHeader(#{gridMain}, #{txFakturIDFltr}, #{txDateFltr}, #{txRefIDFltr}, #{txRSIDFltr}, #{cbSuplierFltr}, #{txVcIDFltr});reloadFilterGrid(#{gridMain});" Buffer="300" Delay="300" />
                            </Listeners>
                          </ext:Button>
                        </Component>
                      </ext:HeaderColumn>
                      ...
                      <ext:HeaderColumn>
                        <Component>
                          <ext:TextField ID="txRSIDFltr" runat="server" EnableKeyEvents="true" AllowBlank="true">
                            <Listeners>
                              <KeyUp Handler="reloadFilterGrid(#{gridMain})" Buffer="700" Delay="700" />
                            </Listeners>
                          </ext:TextField>
  ...
  <uc1:FakturBeliReturCtrl ID="FakturBeliReturCtrl1" runat="server" />
</asp:Content>
