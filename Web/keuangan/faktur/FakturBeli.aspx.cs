...
public partial class keuangan_faktur_FakturBeli : Scms.Web.Core.PageHandler
{
  ...
  protected void Page_Load(object sender, EventArgs e)
  {
    if (!this.IsPostBack)
    {
      FakturBeliCtrl1.Initialize(storeGridMain.ClientID);
  ...
  protected void gridMainCommand(object sender, DirectEventArgs e)
  {
    ...
    {
      FakturBeliCtrl1.CommandPopulate(false, pID);
    }
  ...
  protected void btnAddNewFloating_OnClick(object sender, DirectEventArgs e)
  {
    if (!this.IsAllowAdd)
    {
      Functional.ShowMsgError("Maaf, anda tidak mempunyai hak akses untuk menambah data.");
    ...
    FakturBeliFloatingCtrl1.CommandPopulate(true, null);
  }
}
