...
public partial class keuangan_faktur_FakturJualReturPrintCtrl : System.Web.UI.UserControl
{
  ...
  {
    winPrintDetail.Title = "Cetak Faktur Jual Retur";
    ...
    if (!string.IsNullOrEmpty(faktur1))
    {
      ...
      else
      {
        ...
        else
        {
          ...
          {
            DataType = typeof(string).FullName,
            ParameterName = string.Format("({{LG_FJRH.c_fjno}} IN ('{0}' TO '{1}'))", faktur1, faktur2),
