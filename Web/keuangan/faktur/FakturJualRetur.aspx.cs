...
public partial class keuangan_faktur_FakturJualRetur : Scms.Web.Core.PageHandler
{
  private PostDataParser.StructureResponse DeleteParser(string numberId, string ket)
  {
    ...
    try
    {
      varData = parser.ParserData("FakturJualRetur", "Delete", dic);
    }
    catch (Exception ex)
    {
      Scms.Web.Common.Logger.WriteLine("keuangan_faktur_FakturJualRetur DeleteParser : {0} ", ex.Message);
    }
  ...
  protected void Page_Load(object sender, EventArgs e)
  {
    if (!this.IsPostBack)
    {
      FakturJualReturCtrl1.Initialize(storeGridMain.ClientID);
    }
  }
  ...
  protected void gridMainCommand(object sender, DirectEventArgs e)
  {
    ...
    {
      FakturJualReturCtrl1.CommandPopulate(false, pID);
    }
  ...
  protected void btnPrintFaktur_OnClick(object sender, DirectEventArgs e)
  {
    ...
    FakturJualReturPrintCtrl1.ShowPrintPage();
  }
}
