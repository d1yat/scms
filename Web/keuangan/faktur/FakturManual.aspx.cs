...
public partial class faktur_manual : Scms.Web.Core.PageHandler
{
  protected void Page_Load(object sender, EventArgs e)
  {
    if (!this.IsPostBack)
    {
        FakturManualCtrl1.Initialize(storeGridFaktur.ClientID);
    }
  }
  ...
  protected void btnAddNew_OnClick(object sender, DirectEventArgs e)
  {
    ...
    FakturManualCtrl1.CommandPopulate(true, null);
  }
  ...
  protected void gridMainCommand(object sender, DirectEventArgs e)
  {
    ...
    {
        FakturManualCtrl1.CommandPopulate(false, pID);
    }
  ...
  private PostDataParser.StructureResponse DeleteParser(string fmNumber, string ket)
  {
      ...
      pair.DicAttributeValues.Add("fmno", fmNumber);
      pair.DicAttributeValues.Add("KeteranganDel", ket.Trim());

      try
      {
          varData = parser.ParserData("FakturManual", "Delete", dic);
      }
      catch (Exception ex)
      {
