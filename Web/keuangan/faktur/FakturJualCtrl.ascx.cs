...
public partial class keuangan_pembayaran_FakturJualCtrl : System.Web.UI.UserControl
{
  #region Private
  ...
  private void ClearEntrys()
  {
    ...
    txTanggalHdr.Clear();
    txTanggalHdr.Enabled = true;

    lbCustomer.Text = string.Empty;
  ...
  private PostDataParser.StructureResponse SaveParser(string numberID, Dictionary<string, string>[] dics)
  {
    ...
    try
    {
      varData = parser.ParserData("FakturJual", "Modify", dic);
    }
    catch (Exception ex)
    {
      Scms.Web.Common.Logger.WriteLine("keuangan_pembayaran_FakturJualCtrl SaveParser : {0} ", ex.Message);
    }
  ...
  private void PopulateDetail(string pName, string pID)
  {
    ...
    string res = soa.GlobalQueryService(0, 1, false, string.Empty, string.Empty, "0100", paramX);
    ...
    try
    {
      ...
      if (dicResult.ContainsKey("records") && (dicResult.ContainsKey("totalRows") && (((long)dicResult["totalRows"]) > 0)))
      {
        ...
        winDetail.Title = string.Format("Faktur Jual - {0}", pID);
        ...
        lbCustomer.Text = dicResultInfo.GetValueParser<string>("v_cunam", string.Empty);
    ...
    catch (Exception ex)
    {
      System.Diagnostics.Debug.WriteLine(
        string.Concat("keuangan_pembayaran_FakturJualCtrl:PopulateDetail Header - ", ex.Message));
    }
    finally
    {
      if (jarr != null)
    ...
    {
      System.Diagnostics.Debug.WriteLine(
        string.Concat("keuangan_pembayaran_FakturJualCtrl:PopulateDetail Detail - ", ex.Message));
    }
...
//                                      ketHeader);
  ...
  protected void Report_OnGenerate(object sender, DirectEventArgs e)
  {
    ...
    #endregion
    //Indra 20170904
    //rptParse.PaperID = "10.9x5.5";
    //rptParse.PaperID = "LARGE";
