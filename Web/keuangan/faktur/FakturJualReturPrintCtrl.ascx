<%@ Control Language="C#" AutoEventWireup="true" CodeFile="FakturJualReturPrintCtrl.ascx.cs" Inherits="keuangan_faktur_FakturJualReturPrintCtrl" %>
  ...
  <Items>
    <ext:FormPanel ID="FormPanel1" runat="server" Layout="Form" Padding="5" LabelWidth="150">
      <Items>
        ...
        <ext:CompositeField ID="CompositeField1" runat="server" FieldLabel="Nomor Faktur Jual">
          <Items>
