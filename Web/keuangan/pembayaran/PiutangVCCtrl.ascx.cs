...
public partial class keuangan_pembayaran_PiutangVCCtrl : System.Web.UI.UserControl
{
  #region Private
  ...
  private PostDataParser.StructureResponse SaveParser(string numberID, Dictionary<string, string>[] dics, string tanggalNote, string jenisBayar, string customerId, string tipeBayar, string bankID, string rekNo, string giroID, string giroDate, string kursID, string kursValue, string jumlahTransaksi, string sisaTransaksi, string ketHeader, out string jumlahTransaksiOut)
  {
    ...
    try
    {
      varData = parser.ParserData("VoucherCredit", "Add", dic);
    }
    catch (Exception ex)
    {
      Scms.Web.Common.Logger.WriteLine("keuangan_pembayaran_PiutangVCCtrl SaveParser : {0} ", ex.Message);
    }
  ...
  protected void SaveBtn_Click(object sender, DirectEventArgs e)
  {
    ...
    PostDataParser.StructureResponse respon = SaveParser(numberId, gridDataPL, tanggalNote, jenisBayar,
            customerId, tipeBayar, bankID, rekNo, giroID, giroDate, kursID, kursValue, jumlahTransaksi, sisaTransaksi,
            ketHeader, out jumlahTransaksiOut);
