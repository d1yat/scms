<%@ Control Language="C#" AutoEventWireup="true" CodeFile="HutangVCCtrl.ascx.cs"
  Inherits="keuangan_pembayaran_HutangVCCtrl" %>
    ...
    <ext:BorderLayout ID="bllayout" runat="server">
                        ...
                        <ext:Store runat="server">
                          ...
                          <BaseParams>
                            ...
                            <ext:Parameter Name="parameters" Value="[['c_cab1 = @0', 'X9', 'System.String'],
                              ['@contains.v_bank.Contains(@0) || @contains.v_bankcab.Contains(@0)', paramTextGetter(#{cbBankHdr}), ''],
                              ['(l_delete == null ? false : l_delete) = @0', 'false' , 'System.Boolean']]" Mode="Raw" />
                          ...
                          <Store>
                            <ext:Store runat="server">
                              ...
                              <BaseParams>
                                ...
                                <ext:Parameter Name="parameters" Value="[['@contains.v_desc.Contains(@0) || @contains.v_bankcab.Contains(@0)', paramTextGetter(#{cbItemDtl}), ''],
                                  ['(l_aktif == null ? false : l_aktif) = @0', 'true' , 'System.Boolean']]" Mode="Raw" />
      ...
      <Center MinHeight="150">
        <ext:GridPanel ID="gridDetailBayarVC" runat="server">
          ...
          <Listeners>
            <BeforeEdit Handler="beforeGridEdit(e, #{cbSuplierHdr}.getValue(), #{lbSisaHdr});" />
            <AfterEdit Handler="afterGridEdit(e, #{cbSuplierHdr}.getValue(), #{lbSisaHdr});" />
          </Listeners>
          <SelectionModel>
          ...
          <Store>
            <ext:Store runat="server" RemoteSort="true">
              ...
              <BaseParams>
                ...
                <ext:Parameter Name="model" Value="13001" />
                <ext:Parameter Name="sort" Value="FakturDate" />
                <ext:Parameter Name="dir" Value="ASC" />
                <ext:Parameter Name="parameters" Value="[['supl', paramValueGetter(#{cbSuplierHdr}), 'System.String'],
                      ['Kurs = @0', paramValueGetter(#{cbKursHdr}), 'System.String'],
                      ['Faktur', paramRawValueGetter(#{txFakturIDFltr}) + '%', ''],
                      ['FakturBeli', paramRawValueGetter(#{txFakturSuplIDFltr}) + '%', ''],
          ...
          <ColumnModel>
            <Columns>
              <ext:CheckColumn DataIndex="l_bayar" ColumnID="cekBayar" Width="25" Editable="true"
                Resizable="false" Hideable="false" Locked="true" />
              ...
              <HeaderRows>
                <ext:HeaderRow>
                  <Columns>
                    <ext:HeaderColumn Cls="x-small-editor" AutoWidthElement="false">
                      <Component>
                        <ext:Button ID="ClearFilterButton" runat="server" Icon="Cancel" ToolTip="Clear filter">
                          <Listeners>
                            <Click Handler="clearFilterGridHeader(#{gridDetailBayarVC}, #{txFakturIDFltr}, #{txFakturSuplIDFltr}, #{txDateFakturFltr}, #{txDateTempoFakturFltr});reloadFilterGrid(#{gridDetailBayarVC});"
                    ...
                    <ext:HeaderColumn>
                      <Component>
                        <ext:TextField ID="txFakturSuplIDFltr" runat="server" EnableKeyEvents="true" AllowBlank="true">
                          <Listeners>
                            <KeyUp Handler="reloadFilterGrid(#{gridDetailBayarVC})" Buffer="700" Delay="700" />
                          </Listeners>
                        </ext:TextField>
      ...
      <DirectEvents>
        <Click OnEvent="SaveBtn_Click" Before="return verifyHeaderAndCustomStore(#{frmHeaders},#{bufferStore});">
          ...
          <ExtraParams>
            ...
            <ext:Parameter Name="BiayaAdmin" Value="#{txBiayaAdminHdr}.getValue()" Mode="Raw" />
            <ext:Parameter Name="IsDP" Value="#{chkDPHdr}.getValue()" Mode="Raw" />
