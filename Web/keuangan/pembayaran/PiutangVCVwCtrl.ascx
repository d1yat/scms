<%@ Control Language="C#" AutoEventWireup="true" CodeFile="PiutangVCVwCtrl.ascx.cs"
  Inherits="keuangan_pembayaran_PiutangVCVwCtrl" %>
        ...
        <ext:GridPanel ID="gridDetailBayarVC" runat="server">
          ...
          <Store>
            <ext:Store runat="server" RemoteSort="true" SkinID="OriginalExtStore">
              ...
              <BaseParams>
                ...
                <ext:Parameter Name="model" Value="0083" />
                <ext:Parameter Name="sort" Value="FakturDate" />
                <ext:Parameter Name="dir" Value="ASC" />
                <ext:Parameter Name="parameters" Value="[['c_noteno = @0', paramValueGetter(#{hfDebit}), 'System.String']]" Mode="Raw" />
              </BaseParams>
              <Reader>
          ...
          <ColumnModel>
            <Columns>
              ...
              <ext:Column DataIndex="FakturEx" Header="Ex Faktur" Width="175" />
